...
export async function logGameAndAward(payload: {
  type: 'tap' | 'match' | 'sort' | 'emoji' | 'quiz' | 'follow-ball' | 'copy-the-clap' | 'jump-like-me' | 'dance-freeze' | 'silly-action-match' | 'follow-my-move' | 'touch-the-nose' | 'speech-body-puzzle' | 'what-helps-you-see' | 'dress-the-character' | 'simon-says-body' | 'find-the-animal' | 'fruit-basket' | 'vehicle-garage' | 'alphabet-hunt' | 'vegetable-farm' | 'same-category' | 'pick-the-different-one' | 'big-vs-small' | 'soft-or-hard' | 'color-match-train' | 'put-teddy-in-box' | 'under-the-table' | 'left-or-right' | 'near-or-far' | 'behind-the-tree' | 'who-is-running' | 'what-do-we-eat-with' | 'match-the-action' | 'what-does-a-doctor-do' | 'tool-match' | 'find-the-kitchen' | 'where-does-teacher-work' | 'family-match' | 'boy-or-girl' | 'community-helpers' | 'guess-the-object' | 'hidden-part-puzzle' | 'what-am-i-describing' | 'find-by-function' | 'mystery-bag' | 'story-order-cards' | 'what-is-missing' | 'complete-the-pattern' | 'first-middle-last' | 'find-the-hidden-toy' | 'follow-2-step-directions' | 'belongs-or-not' | 'singular-or-plural' | 'pronoun-match' | 'smart-listener-challenge' | 'magic-feather' | 'cloud-puff' | 'bubble-wakeup' | 'windmill-friend' | 'air-painter' | 'copy-happy-mouth' | 'funny-monster-mouth' | 'mirror-mouth-match' | 'open-close-dance' | 'silly-face-copy' | 'wake-feather' | 'start-stop-cloud' | 'windmill-freeze' | 'balloon-breath' | 'magic-air-switch' | 'happy-lips-mirror' | 'lip-tap-friend' | 'magic-lip-glow' | 'funny-fish-lips' | 'lip-explorer-adventure' | 'jaw-hungry-crocodile' | 'sleepy-lion-mouth' | 'mouth-elevator' | 'jaw-open-close-dance' | 'funny-jaw-adventure' | 'funny-face-mirror' | 'happy-sad-copy' | 'monster-face-match' | 'mirror-dance-faces' | 'face-adventure-copy' | 'magic-face-breeze' | 'bubble-nose-tickles' | 'funny-mouth-explorer' | 'soft-sensory-monster' | 'calm-mouth-adventure' | 'find-mouth-part' | 'magic-mouth-spotlight' | 'follow-funny-mouth' | 'where-did-it-go-mouth' | 'mouth-treasure-hunt' | 'friendly-tongue-explorer' | 'tongue-hide-seek' | 'magic-tongue-mirror' | 'hungry-tongue-monster' | 'tongue-treasure-adventure' | 'copy-my-mouth-friend' | 'funny-mouth-adventure' | 'air-mouth-play' | 'oral-mirror-party' | 'mouth-hero-adventure' | 'speech-mouth-copy' | 'talking-robot-face' | 'mouth-pattern-match' | 'mirror-speech-play' | 'speech-hero-warmup' | 'wake-sleeping-star' | 'talking-robot-start' | 'magic-voice-balloon' | 'funny-voice-echo' | 'sound-hero-starter' | 'magic-mouth-shapes' | 'talking-animal-vowels' | 'mirror-vowel-face' | 'vowel-balloon-builder' | 'speech-shape-adventure' | 'bubble-seal' | 'sleeping-fish' | 'cookie-hold' | 'lip-closure-freeze' | 'lip-lock-door' | 'hold-balloon' | 'magic-seal' | 'freeze-smile' | 'quiet-mouse' | 'lip-statue' | 'fish-mouth' | 'tunnel-air' | 'round-portal' | 'bubble-cannon' | 'moon-mouth' | 'smile-bridge' | 'cheese-camera' | 'rainbow-smile' | 'eee-train' | 'lip-mirror-match' | 'o-e-switch' | 'lip-talking-robot' | 'shape-rhythm' | 'lip-fast-mouth' | 'lip-dance' | 'hold-wall' | 'lip-push-battle' | 'wind-resistance' | 'lip-resistance-freeze' | 'strong-mouth-hero' | 'lip-pop-bubble' | 'lip-mama-drum' | 'lip-balloon-burst' | 'lip-box-push' | 'lip-beat-race' | 'lip-feather-float' | 'lip-candle-control' | 'lip-bubble-stream' | 'lip-wind-tunnel' | 'lip-breath-painter' | 'lip-rhythm-mouth' | 'lip-copy-avatar' | 'lip-mouth-memory' | 'lip-beat-builder' | 'lip-orchestra' | 'lip-talking-path' | 'lip-sound-builder' | 'lip-mouth-adventure' | 'lip-smooth-switch' | 'lip-speech-prep-master' | 'follow-my-point' | 'point-to-object-appears' | 'tap-the-pointed-object' | 'moving-arm-pointing' | 'multi-point-follow' | 'tap-what-you-like' | 'which-one-moved' | 'sound-to-choice' | 'show-me-the-toy' | 'food-vs-toy' | 'pass-the-ball' | 'tap-only-on-your-turn' | 'your-turn-to-complete' | 'wait-for-the-signal' | 'turn-timer' | 'watch-and-wait' | 'growing-flower' | 'timer-bar-tap' | 'follow-slow-movement' | 'shapes-appear-one-by-one' | 'touch-the-ball' | 'tap-the-circle' | 'find-the-sound-source' | 'tap-what-i-show-you' | 'follow-the-arrow' | 'tap-the-target-ignore-distraction' | 'sound-distraction-challenge' | 'slow-task-with-pop-up-distraction' | 'sequence-with-distraction' | 'wake-the-monster' | 'voice-rocket' | 'sound-paint' | 'echo-cave' | 'voice-match-light' | 'open-mouth-aaa' | 'happy-eee-smile' | 'round-ooo-fish' | 'long-sound-train' | 'vowel-switch' | 'mama-drum' | 'bubble-pop-puh' | 'ball-bounce-buh' | 'sound-catch' | 'lip-power-race' | 'syllable-bridge' | 'feed-the-panda' | 'baby-calls-mama' | 'syllable-balloons' | 'copy-talking-robot' | 'cow-sound-farm' | 'car-engine-race' | 'snake-hiss' | 'train-choo-choo' | 'animal-sound-match' | 'copy-one-sound' | 'copy-two-sounds' | 'rhythm-repeat' | 'sound-pattern-lights' | 'talking-robot-says' | 'say-more' | 'call-mama' | 'say-ball' | 'snack-request' | 'toy-voice-unlock' | 'hear-and-say' | 'talking-mirror' | 'match-my-mouth' | 'repeat-the-beat' | 'fast-or-slow' | 'say-then-tap' | 'open-speak' | 'two-word-combo' | 'follow-repeat' | 'speech-pathway' | 'smooth-talking-train' | 'phrase-builder' | 'talking-adventure' | 'fast-slow-talking' | 'conversation-avatar' | 'hungry-crocodile' | 'big-mouth-lion' | 'jaw-elevator' | 'freeze-mouth' | 'open-close-rhythm' | 'rainbow-curve-trace' | 'drive-car-curvy-road' | 'trace-smiling-mouth' | 'ball-roll-curved-track' | 'paint-curved-snake' | 'magic-sound-builder' | 'talking-animal-mouths' | 'robot-says-play' | 'speech-pattern-train' | 'mini-talking-hero' | 'mama-drum-beat' | 'pop-balloon-race' | 'talking-robot-beats' | 'speech-train-rhythm' | 'mini-speaker-hero' | 'talking-drum-rhythm' | 'speech-beat-robot' | 'magic-mouth-metronome' | 'talking-train-timing' | 'speech-rhythm-hero' | 'syllable-pop-party' | 'talking-animal-syllables' | 'robot-speech-steps' | 'speech-train-builder' | 'little-speaker-hero' | 'magic-sound-request' | 'talking-friend-turn-taking' | 'voice-choice-adventure' | 'help-character-speak' | 'little-communicator-hero' | 'speech-adventure-party' | 'talking-friend-challenge' | 'magic-mouth-mission' | 'little-speaker-celebration' | 'speech-hero-graduation' | 'magic-voice-river' | 'talking-balloon-hold' | 'robot-power-voice' | 'voice-train-journey' | 'speech-stability-hero' | 'funny-mouth-teamwork' | 'robot-mouth-builder' | 'magic-mouth-switch' | 'talking-face-rhythm' | 'mouth-coordination-hero' | string;
  correct: number;
  total: number;
...
export type SubscriptionStatus = {
  ok: boolean;
  hasAccess: boolean;
  status: 'none' | 'trial' | 'active' | 'expired' | 'cancelled' | 'past_due' | 'free' | 'promo';
  isTrial: boolean;
  isActive: boolean;
  ...
  isFreeAccess?: boolean; // Whitelist or user-growth promo (full unlock)
  isUserGrowthPromo?: boolean;
  userCount?: number;
