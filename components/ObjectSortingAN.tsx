/**
 * Sort the Objects — Kitchen (pan, can) vs People (man, chef). Game 4 for Grouper Session 6.
 */
...
const ITEMS: { id: string; label: string; category: Category; image: string }[] = [
  { id: 'pan', label: 'pan', category: 'kitchen', image: 'https://placehold.co/100x100/FED7AA/9A3412?text=pan' },
  { id: 'can', label: 'can', category: 'kitchen', image: 'https://placehold.co/100x100/E5E7EB/374151?text=can' },
  { id: 'man', label: 'man', category: 'people', image: 'https://placehold.co/100x100/DBEAFE/1E40AF?text=man' },
  { id: 'chef', label: 'chef', category: 'people', image: 'https://placehold.co/100x100/FEF3C7/B45309?text=chef' },
];

export function ObjectSortingAN({ onComplete }: { onComplete: () => void }) {
  ...
  const [currentItem, setCurrentItem] = useState<string | null>('pan');
