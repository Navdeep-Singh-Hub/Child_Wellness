/**
 * Rhyme Match — Find the rhyme (pet → net). Game 2 for Grouper Session 7.
 */
...
const PROMPT_WORD = 'pet';
const CHOICES = [
  { id: 'net', label: 'net', correct: true, image: 'https://placehold.co/120x120/E5E7EB/374151?text=net' },
...
export function RhymeMatchET({ onComplete }: { onComplete: () => void }) {
