/**
 * AI Task: Draw sleeping and slanting lines on paper and upload photo. POST /api/verify-line-types
 */
...
const INSTRUCTION = 'Draw sleeping and slanting lines on paper and upload a photo.';

export function LineTypesUploadTask({
  currentStep,
  totalSteps,
  onBack,
  onComplete,
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/verify-line-types`, {
        method: 'POST',
        headers,
        body: formData,
      });
      ...
      setResult({
        ...
        feedback: data.feedback || (success ? 'Great line control!' : 'Try again. Draw sleeping and slanting lines on paper.'),
      });
