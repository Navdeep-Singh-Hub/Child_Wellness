/**
 * Explorer Session 3 — Notebook Activity: Write E and F.
...
const INSTRUCTIONS = 'Write E and F.\n\nExample:\nE\nF';

export function ExplorerNotebookUploadEF({
  onComplete,
}: {
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/upload-explorer-ef-task`, {
        method: 'POST',
        headers,
        body: formData,
      });
      ...
      const feedback = data.feedback || (correct ? 'Great job! E and F!' : "Let's try again!");
      setResult({
        correct,
        feedback,
