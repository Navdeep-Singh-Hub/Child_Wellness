/**
 * Explorer Session 5 — Notebook Activity: Write I and J.
 * Upload photo → AI check (letters_detected). AAC-friendly.
 */
...
const INSTRUCTIONS = 'Write I and J.\n\nExample:\nI\nJ';

export function ExplorerNotebookUploadIJ({
  onComplete,
}: {
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/upload-explorer-ij-task`, {
        method: 'POST',
        headers,
        body: formData,
      });
      ...
      const correct = data.correct === true || lettersOk;
      const feedback = data.feedback || (correct ? 'Great job! I and J!' : "Let's try again!");
      setResult({
        correct,
        feedback,
