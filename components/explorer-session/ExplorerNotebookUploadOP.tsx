/**
 * Explorer Session 8 — Notebook Activity: Write O and P.
...
const INSTRUCTIONS = 'Write O and P.\n\nExample:\nO\nP';

export function ExplorerNotebookUploadOP({
  onComplete,
}: {
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/upload-explorer-op-task`, {
        method: 'POST',
        headers,
        body: formData,
      });
      ...
      const feedback = data.feedback || (correct ? 'Great job! O and P!' : "Let's try again!");
      setResult({
        correct,
        feedback,
