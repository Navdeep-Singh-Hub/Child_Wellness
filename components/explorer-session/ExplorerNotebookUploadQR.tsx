/**
 * Explorer Session 9 — Notebook Activity: Write Q and R.
...
const INSTRUCTIONS = 'Write Q and R.\n\nExample:\nQ\nR';

export function ExplorerNotebookUploadQR({
  onComplete,
}: {
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/upload-explorer-qr-task`, {
        method: 'POST',
        headers,
        body: formData,
      });
      ...
      const feedback = data.feedback || (correct ? 'Great job! Q and R!' : "Let's try again!");
      setResult({
        correct,
        feedback,
