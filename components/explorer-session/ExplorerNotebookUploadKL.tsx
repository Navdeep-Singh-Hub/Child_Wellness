/**
 * Explorer Session 6 — Notebook Activity: Write K and L.
...
const INSTRUCTIONS = 'Write K and L.\n\nExample:\nK\nL';

export function ExplorerNotebookUploadKL({
  onComplete,
}: {
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/upload-explorer-kl-task`, {
        method: 'POST',
        headers,
        body: formData,
      });
      ...
      const feedback = data.feedback || (correct ? 'Great job! K and L!' : "Let's try again!");
      setResult({
        correct,
        feedback,
