/**
 * Explorer Session 4 — Notebook Activity: Write G and H.
...
const INSTRUCTIONS = 'Write G and H.\n\nExample:\nG\nH';

export function ExplorerNotebookUploadGH({
  onComplete,
}: {
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/upload-explorer-gh-task`, {
        method: 'POST',
        headers,
        body: formData,
      });
      ...
      const feedback = data.feedback || (correct ? 'Great job! G and H!' : "Let's try again!");
      setResult({
        correct,
        feedback,
