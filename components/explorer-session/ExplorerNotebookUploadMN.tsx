/**
 * Explorer Session 7 — Notebook Activity: Write M and N.
...
const INSTRUCTIONS = 'Write M and N.\n\nExample:\nM\nN';

export function ExplorerNotebookUploadMN({
  onComplete,
}: {
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/api/upload-explorer-mn-task`, {
        method: 'POST',
        headers,
        body: formData,
      });
      ...
      const feedback = data.feedback || (correct ? 'Great job! M and N!' : "Let's try again!");
      setResult({
        correct,
        feedback,
