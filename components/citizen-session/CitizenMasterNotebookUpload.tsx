/**
 * Notebook Task — Draw two signs and one coin (e.g. STOP, EXIT, ₹5). Session 10: Citizen Master Challenge.
 */
...
const INSTRUCTIONS = 'Draw two signs and one coin in your notebook (e.g. STOP, EXIT, ₹5). Then upload or take a photo.';
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleText}>STOP sign, EXIT sign, ₹5 coin</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleText: { fontSize: 16, fontWeight: '700', color: '#374151', textAlign: 'center' },
