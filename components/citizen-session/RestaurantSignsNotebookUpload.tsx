/**
 * Notebook Task — Draw a MENU sign. Upload photo, AI check: menu_sign_detected, drawing_valid. Session 7: Restaurant Signs.
 */
...
const INSTRUCTIONS = 'Draw a MENU sign in your notebook. Then upload or take a photo.';
...
export function RestaurantSignsNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw a MENU sign. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleSign}>MENU</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleSign: { fontSize: 24, fontWeight: '800', color: '#1E40AF' },
