/**
 * Notebook Task — Draw a STOP sign. Upload photo, AI check: stop_sign_detected, drawing_valid.
 */
...
const INSTRUCTIONS = 'Draw a STOP sign in your notebook. Then upload or take a photo.';
...
export function SafetySignsNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw a STOP sign. Then upload or take a photo."
      icon="📓"
      ...
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <View style={styles.exampleSign}>
            <Text style={styles.exampleSignText}>STOP</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleSignText: { fontSize: 24, fontWeight: '800', color: '#DC2626' },
