/**
 * Notebook Task — Draw an emergency EXIT sign. Upload photo, AI check: exit_sign_detected, drawing_valid. Session 8: Emergency Signs.
 */
...
const INSTRUCTIONS = 'Draw an emergency EXIT sign in your notebook (green EXIT with arrow). Then upload or take a photo.';
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleSign}>EXIT →</Text>
        </View>
