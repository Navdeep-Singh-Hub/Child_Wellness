/**
 * Game 2 — Meaning Quiz: STOP → stop walking, EXIT → leave building. Session 10: Citizen Master Challenge.
 */
...
const QUESTIONS: {
  ...
  { sign: 'STOP', correctMeaning: 'stop walking', options: ['stop walking', 'go fast', 'buy food'], voice: 'What does STOP mean? Tap stop walking.' },
  { sign: 'EXIT', correctMeaning: 'leave building', options: ['leave building', 'buy ticket', 'sit down'], voice: 'What does EXIT mean? Tap leave building.' },
];
...
export function CitizenMeaningQuiz({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="You know the meanings!" />;
