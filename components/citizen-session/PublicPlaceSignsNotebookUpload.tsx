/**
 * Notebook Task — Draw a restroom sign 🚻. Upload photo, AI check: restroom_sign_detected, drawing_valid.
 */
...
const INSTRUCTIONS = 'Draw a restroom sign in your notebook. Then upload or take a photo.';
...
export function PublicPlaceSignsNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw a restroom sign. Then upload or take a photo."
      icon="📓"
