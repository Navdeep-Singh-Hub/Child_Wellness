/**
 * Game 2 — Match sign with place. 🚻 → restroom, 🚪 → exit. Session 2: Public Place Signs.
 */
...
const QUESTIONS: {
  ...
  { icon: '🚻', correctMeaning: 'restroom', options: ['restroom', 'exit', 'entrance'], voice: 'What does this sign mean? Tap restroom.' },
  { icon: '🚪', correctMeaning: 'exit', options: ['restroom', 'exit', 'entrance'], voice: 'What does this sign mean? Tap exit.' },
];
  ...
  return (
    ...
    >
      <View style={styles.content}>
        <Text style={styles.iconDisplay}>{q.icon}</Text>
...
const styles = StyleSheet.create({
  ...
  iconDisplay: { fontSize: 64, marginBottom: 16 },
