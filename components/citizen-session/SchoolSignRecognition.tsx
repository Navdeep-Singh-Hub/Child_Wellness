/**
 * Game 1 — Tap the correct school place sign. Display LIBRARY, CLASSROOM, PLAYGROUND. Instruction: "Tap the LIBRARY sign." Session 6: School Signs.
 */
...
const SIGNS = [
  { id: 'LIBRARY', label: 'LIBRARY', color: '#1E40AF', bg: '#DBEAFE' },
  { id: 'CLASSROOM', label: 'CLASSROOM', color: '#166534', bg: '#DCFCE7' },
  { id: 'PLAYGROUND', label: 'PLAYGROUND', color: '#831843', bg: '#FBCFE8' },
];
const CORRECT = 'LIBRARY';
...
export function SchoolSignRecognition({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="You found LIBRARY!" />;
  ...
  return (
    ...
    >
      <View style={styles.content}>
        <Text style={styles.prompt}>Which one is the LIBRARY sign?</Text>
