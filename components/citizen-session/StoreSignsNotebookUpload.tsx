/**
 * Notebook Task — Draw an OPEN sign. Upload photo, AI check: open_sign_detected, drawing_valid. Session 4: Store Signs.
 */
...
const INSTRUCTIONS = 'Draw an OPEN sign in your notebook. Then upload or take a photo.';
...
export function StoreSignsNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw an OPEN sign. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleSign}>OPEN</Text>
        </View>
