/**
 * Notebook Task — Draw an EXIT sign. Upload photo, AI check: exit_sign_detected, drawing_valid. Session 3: Direction Signs.
 */
...
const INSTRUCTIONS = 'Draw an EXIT sign in your notebook. Then upload or take a photo.';
...
export function DirectionSignsNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw an EXIT sign. Then upload or take a photo."
      icon="📓"
