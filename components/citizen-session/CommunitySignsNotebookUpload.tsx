/**
 * Notebook Task — Draw a BUS STOP sign. Upload photo, AI check: bus_stop_sign_detected, drawing_valid. Session 9: Community Signs.
 */
...
const INSTRUCTIONS = 'Draw a BUS STOP sign in your notebook. Then upload or take a photo.';
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleSign}>BUS STOP</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleSign: { fontSize: 24, fontWeight: '800', color: '#166534' },
