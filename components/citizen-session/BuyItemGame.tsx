/**
 * Game 4 — Shop Stop: Apple costs ₹5; choose the correct coin (₹5).
 */
...
export function BuyItemGame({ onComplete }: { onComplete: () => void }) {
  ...
  const coachLine =
    attempts === 0
      ? 'The apple tag says ₹5 — which coin matches the price?'
  ...
  return (
    ...
    >
      <View style={styles.marketFrame}>
        <LinearGradient
          colors={[`${DEPOT.accent}33`, 'transparent', `${DEPOT.amber}22`]}
          style={styles.marketGlow}
        />
        <Text style={styles.marketLabel}>CIVIC MARKET STALL</Text>
...
const styles = StyleSheet.create({
  ...
  marketGlow: { ...StyleSheet.absoluteFillObject },
  marketLabel: {
    fontSize: 9,
    fontWeight: '900',
    letterSpacing: 1.4,
  ...
  priceLabel: { fontSize: 9, fontWeight: '900', letterSpacing: 1, color: DEPOT.coinGlow },
  priceValue: { fontSize: 24, fontWeight: '900', color: DEPOT.coinGlow },
  prompt: {
    fontSize: 18,
    fontWeight: '800',
    color: CZ.textLight,
