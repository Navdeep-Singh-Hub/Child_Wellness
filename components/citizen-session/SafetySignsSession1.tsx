 ...
 * Flow: Intro → Game 1 (Sign Recognition) → Game 2 (Sign Meaning) → Game 3 (Coin Recognition) → Game 4 (Coin Counting) → Notebook → Result
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.introHeader}>
            <Text style={styles.introTitle}>Safety Signs</Text>
            <Text style={styles.introSub}>Let's learn important safety signs and money.</Text>
          </View>
          <View style={styles.cardsWrap}>
            {[
              { icon: '🛑', title: 'Tap the correct sign', desc: 'STOP, GO, EXIT' },
              { icon: '📋', title: 'Match sign to meaning', desc: 'What does it mean?' },
              { icon: '🪙', title: 'Find the coin', desc: '₹1, ₹2, ₹5' },
              { icon: '💰', title: 'Count the coins', desc: 'Add them up' },
            ].map((card, i) => {
              const gameNum = i + 1;
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.resultScroll} showsVerticalScrollIndicator={false}>
          <Text style={styles.resultTitle}>Great job learning safety signs!</Text>
          <View style={styles.resultBadge}>
            <Text style={styles.resultBadgeEmoji}>⭐</Text>
            <Text style={styles.resultBadgeText}>Safety Sign Star</Text>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={[styles.header, { borderBottomColor: CITIZEN_COLOR }]}>
        ...
        <Text style={[styles.title, { color: '#BE185D' }]}>Safety Signs</Text>
        <Text style={[styles.subtitle, { color: CITIZEN_COLOR }]}>The Citizen · Session 1</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {step === 5 && <SafetySignsNotebookUpload onComplete={handleNotebookComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
