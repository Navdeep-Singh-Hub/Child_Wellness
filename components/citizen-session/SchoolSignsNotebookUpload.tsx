/**
 * Notebook Task — Draw a LIBRARY sign. Upload photo, AI check: library_sign_detected, drawing_valid. Session 6: School Signs.
 */
...
const INSTRUCTIONS = 'Draw a LIBRARY sign in your notebook. Then upload or take a photo.';
...
export function SchoolSignsNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw a LIBRARY sign. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleSign}>LIBRARY</Text>
        </View>
