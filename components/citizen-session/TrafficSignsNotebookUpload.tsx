/**
 * Notebook Task — Draw a NO ENTRY sign. Upload photo, AI check: no_entry_sign_detected, drawing_valid. Session 5: Traffic Signs.
 */
...
const INSTRUCTIONS = 'Draw a NO ENTRY sign in your notebook (red circle with white bar). Then upload or take a photo.';
...
export function TrafficSignsNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw a NO ENTRY sign. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <View style={styles.exampleSign}>
            <Text style={styles.exampleText}>NO ENTRY</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleText: { fontSize: 18, fontWeight: '800', color: '#991B1B' },
