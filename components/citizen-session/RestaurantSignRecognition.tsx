/**
 * Game 1 — Tap the correct restaurant sign. Display MENU, ORDER, PAY. Instruction: "Tap the MENU sign." Session 7: Restaurant Signs.
 */
...
const SIGNS = [
  { id: 'MENU', label: 'MENU', color: '#1E40AF', bg: '#DBEAFE' },
  { id: 'ORDER', label: 'ORDER', color: '#166534', bg: '#DCFCE7' },
  { id: 'PAY', label: 'PAY', color: '#831843', bg: '#FBCFE8' },
];
const CORRECT = 'MENU';
...
export function RestaurantSignRecognition({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="You found MENU!" />;
  ...
  return (
    ...
    >
      <View style={styles.content}>
        <Text style={styles.prompt}>Which one is the MENU sign?</Text>
