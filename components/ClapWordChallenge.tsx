/**
 * Clap the syllables — rabbit (2), tiger (2), monkey (2). Game 3 for Grouper Session 9.
 */
...
export function ClapWordChallenge({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) {
    return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="Clap challenge complete!" />;
  }
