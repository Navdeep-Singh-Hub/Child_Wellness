/**
 * Word Family Finder — -IN words (Game 1 for Grouper Session 2). AAC-friendly.
 */
...
const CORRECT = [
  { id: 'pin', label: 'pin', image: 'https://placehold.co/140x140/FEE2E2/991B1B?text=pin' },
  { id: 'tin', label: 'tin', image: 'https://placehold.co/140x140/E5E7EB/374151?text=tin' },
  { id: 'bin', label: 'bin', image: 'https://placehold.co/140x140/D1FAE5/065F46?text=bin' },
  { id: 'win', label: 'win', image: 'https://placehold.co/140x140/DBEAFE/1E40AF?text=win' },
];
const WRONG = [
...
export function WordFamilyFinderIN({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    speak('Tap the words that belong to the -IN family.', 0.75);
  }, []);
  ...
  return (
    <GameLayout
      title="Find the -IN words"
      instruction="Tap the words that belong to the -IN family."
    >
