...
const INSTRUCTIONS = 'Write one short story sentence in your notebook. Example: "The boy plays with a ball." Then upload or take a photo.';
...
export function StoryUnderstandingNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Write one short story sentence. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleLine}>"The boy plays with a ball."</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleLine: { fontSize: 17, fontWeight: '700', color: '#5B21B6', fontStyle: 'italic' },
