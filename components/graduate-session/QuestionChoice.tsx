/**
 * Game 1 — Answer the question. "What do we drink?" Options: Water, Chair, Shoes. Correct: Water. Session 3: Question & Answer.
 */
...
export function QuestionChoice({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="You chose the right answer!" />;
...
const styles = StyleSheet.create({
  ...
  questionText: { fontSize: 22, fontWeight: '800', color: '#5B21B6' },
