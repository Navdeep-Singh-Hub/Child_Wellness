/**
 * Notebook Task — Write one question and one answer. Upload photo; AI check: writing_detected, question_detected, answer_detected. Session 3: Question & Answer.
 */
...
const INSTRUCTIONS = 'Write one question and one answer in your notebook. Example: What do we drink? Answer: Water. Then upload or take a photo.';
...
export function QuestionAnswerNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Write one question and one answer. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleLine}>Question: What do we drink?</Text>
          <Text style={styles.exampleLine}>Answer: Water.</Text>
        </View>
