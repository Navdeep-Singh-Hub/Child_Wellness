/**
 * Notebook Task — Write 3 actions in order. Upload photo; AI check: writing_detected, three_actions_detected, sequence_detected. Session 2: Story Sentences.
 */
...
const INSTRUCTIONS = 'Write 3 actions in order in your notebook. Example: I wake up, I brush teeth, I go to school. Then upload or take a photo.';
...
export function StorySentencesNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Write 3 actions in order. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleLine}>I wake up</Text>
          <Text style={styles.exampleLine}>I brush teeth</Text>
          <Text style={styles.exampleLine}>I go to school</Text>
        </View>
