/**
 * Game 4 — Complete the sequence. ☀️ 🌙 ☀️ 🌙 __. Options ☀️, 🌙, ⭐. Correct: ☀️. Session 4: Daily Stories.
 */
...
export function LogicSequenceSunMoon({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="You completed the sequence!" />;
