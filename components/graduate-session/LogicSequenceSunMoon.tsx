/**
 * Game 4 — Complete the sequence. ☀️ 🌙 ☀️ 🌙 __. Options ☀️, 🌙, ⭐. Correct: ☀️.
 */
...
export function LogicSequenceSunMoon({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <GraduateGameShell
      ...
      mascot="🔢"
      coachLine="Sun, moon, sun, moon — what comes next in the day-night loop?"
    ...
    >
      <View style={styles.sequenceFrame}>
        ...
        />
        <Text style={styles.frameLabel}>DAY & NIGHT STRIP</Text>
