/**
 * Notebook Task — Write a two-line conversation. Upload photo; AI check: writing_detected, two_lines_detected, conversation_detected. Session 1: Simple Conversations.
 */
...
const INSTRUCTIONS = 'Write a two-line conversation in your notebook. Example: Hello / How are you? Then upload or take a photo.';
...
export function GraduateConversationNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Write a two-line conversation. Then upload or take a photo."
      icon="📓"
...
const styles = StyleSheet.create({
  ...
  exampleLine: { fontSize: 20, fontWeight: '700', color: '#5B21B6', marginBottom: 4 },
