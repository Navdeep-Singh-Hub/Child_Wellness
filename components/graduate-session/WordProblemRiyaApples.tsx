/**
 * Game 3 — Word problem. Riya has 4 apples, buys 3 more. How many now? Options 6, 7, 8. Correct: 7. Session 10: Graduate Master Challenge.
 */
...
export function WordProblemRiyaApples({ onComplete }: { onComplete: () => void }) {
  ...
  const handleChoice = useCallback(
    (num: string) => {
      if (num !== CORRECT) {
        speak('Try again. Four plus three is seven.');
        triggerShake();
        return;
      }
      speak('Correct! Seven apples!');
      setShowSuccess(true);
      ...
      <View style={styles.content}>
        <View style={styles.storyBox}>
          <Text style={styles.storyLine}>
            Riya has <Text style={styles.bold}>4 apples</Text>.
          </Text>
          <Text style={styles.storyLine}>
            She buys <Text style={styles.bold}>3 more apples</Text>.
          </Text>
