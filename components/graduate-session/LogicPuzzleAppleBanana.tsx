...
const styles = StyleSheet.create({
  ...
  patternRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 24, flexWrap: 'wrap', justifyContent: 'center' },
  patternCell: {
  ...
  blankText: { fontSize: 28, fontWeight: '800', color: '#6B7280' },
