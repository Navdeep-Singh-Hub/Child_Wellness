/**
 * Game 4 — Find the missing item. Pattern 🍎 🍎 🍌 🍎 🍎 🍌 __. Options 🍎, 🍌, 🍇. Correct: 🍎. Session 9: Story Problem Solver.
 */
...
const OPTIONS = ['🍎', '🍌', '🍇'];
const CORRECT = '🍎';
const VOICE = 'Choose the item that continues the pattern.';
...
function FruitChip({
  ...
  return (
    <Animated.View style={anim}>
      <Pressable
        onPress={onPress}
        style={({ pressed }) => [styles.fruitChip, { borderColor: border }, pressed && styles.pressed]}
...
export function LogicPuzzleAppleBanana({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <GraduateGameShell
      studio="LOGIC PUZZLE · GAME 4"
      title="Find the missing item"
      instruction="Choose the item that continues the pattern."
      mascot="🔢"
      coachLine="Two apples, then a banana — what fruit comes next?"
    ...
    >
      <View style={styles.patternFrame}>
        ...
        />
        <Text style={styles.frameLabel}>FRUIT PATTERN STRIP</Text>
