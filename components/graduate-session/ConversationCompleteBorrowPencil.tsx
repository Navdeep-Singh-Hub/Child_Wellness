...
export function ConversationCompleteBorrowPencil({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <GraduateGameShell
      studio="CONVERSATION COMPLETE · GAME 2"
      title="Finish the conversation"
      instruction="Choose the best reply."
      mascot="💬"
      coachLine='When a friend asks "Can I borrow a pencil?" saying Yes is helpful!'
    ...
    >
      <View style={styles.dialogueFrame}>
        ...
        <View style={styles.contextRow}>
          ...
          <Text style={styles.contextText}>A friend needs a pencil</Text>
        </View>
