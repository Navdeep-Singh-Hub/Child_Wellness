/**
 * Game 2 — Complete the dialogue. Mom: Eat your food. Child: ______. Options: Okay, Banana, Jump. Correct: Okay.
 */
...
export function DialogueCompleteEatFood({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <GraduateGameShell
      ...
      mascot="💬"
      coachLine='When Mom says "Eat your food," a polite reply like Okay works best!'
    ...
    >
      <View style={styles.dialogueFrame}>
        ...
        />
        <Text style={styles.frameLabel}>KITCHEN SCENE</Text>

        <View style={styles.bubbleRow}>
          <View style={[styles.bubble, styles.momBubble]}>
            <Text style={styles.roleLabel}>MOM</Text>
