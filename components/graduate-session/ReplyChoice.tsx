/**
 * Game 2 — Choose the correct reply. "How are you?" → I am fine, Banana, Good night. Correct: I am fine. Session 1: Simple Conversations.
 */
...
export function ReplyChoice({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="You picked the right reply!" />;
  ...
  return (
    ...
    >
      <View style={styles.content}>
        ...
        <Text style={styles.instruction}>Which reply is correct?</Text>
...
const styles = StyleSheet.create({
  ...
  promptText: { fontSize: 22, fontWeight: '800', color: '#5B21B6' },
  instruction: { fontSize: 18, fontWeight: '700', color: '#374151', marginBottom: 20 },
