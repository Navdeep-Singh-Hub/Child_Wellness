...
export function StoryQuestionPencils({ onComplete }: { onComplete: () => void }) {
  ...
  const handleChoice = useCallback(
    (answer: string) => {
      ...
      if (answer === CORRECT) {
        ...
        speak('Correct! The child has pencils!', 0.7);
        setShowSuccess(true);
  ...
  return (
    <GraduateGameShell
      studio="STORY COMPREHENSION · GAME 1"
      title="Understand the story"
      instruction="Look at the picture and answer the question."
      mascot="📖"
      coachLine="Look at the classroom — what is the child holding in their hand?"
      ...
      <View style={styles.storyFrame}>
        ...
        <View style={styles.pictureScene}>
          <View style={styles.classBadge}>
            <Text style={styles.classText}>CLASSROOM</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  pictureEmoji: { fontSize: 52, marginBottom: 8 },
  pictureCaption: {
    fontSize: 15,
    fontWeight: '700',
    color: GR.textLight,
