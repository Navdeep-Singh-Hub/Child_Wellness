...
export function StoryQuestionBall({ onComplete }: { onComplete: () => void }) {
  ...
  const handleChoice = useCallback(
    (answer: string) => {
      ...
      if (answer === CORRECT) {
        ...
        speak('Correct! The boy has the ball!', 0.7);
        setShowSuccess(true);
  ...
  if (showSuccess) {
    return (
      <SuccessCelebration
        variant="indigo"
        title="Great Job!"
        subtitle="You answered the story question!"
        badgeEmoji="📖"
      />
    );
  }
  ...
  return (
    <GraduateGameShell
      studio="STORY QUESTION · GAME 1"
      title="Answer the question"
      instruction="Look at the story picture and choose the correct answer."
      mascot="📖"
      coachLine="Two children are playing — look closely at who is holding the ball."
      ...
      <View style={styles.storyFrame}>
        ...
        <View style={styles.pictureScene}>
          <View style={styles.playBadge}>
            <Text style={styles.playText}>PLAYTIME</Text>
          </View>
