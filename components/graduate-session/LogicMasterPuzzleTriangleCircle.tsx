/**
 * Game 4 — Logic Master Puzzle. Pattern 🔺 🔵 🔺 🔵 🔺 __. Options 🔺, 🔵, 🟩. Correct: 🔵. Session 10: Graduate Master Challenge.
 */
...
const styles = StyleSheet.create({
  ...
  blankText: { fontSize: 30, fontWeight: '800', color: '#6B7280' },
