/**
 * Game 4 — Complete the pattern. 🟦 🟩 🟦 🟩 __. Options 🟦, 🟩, 🟨. Correct: 🟦. Session 7: Real Life Problems.
 */
...
const OPTIONS = ['🟦', '🟩', '🟨'];
const CORRECT = '🟦';
const VOICE = 'Choose the symbol that continues the pattern.';
...
function ColorChip({
  ...
  return (
    <Animated.View style={anim}>
      <Pressable
        onPress={onPress}
        style={({ pressed }) => [styles.colorChip, { borderColor: border }, pressed && styles.pressed]}
...
export function PatternPuzzleBlueGreen({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <GraduateGameShell
      ...
      instruction="Choose the symbol that continues the pattern."
      mascot="🔢"
      coachLine="Blue, green, blue, green — what symbol comes next?"
    ...
    >
      <View style={styles.patternFrame}>
        ...
        />
        <Text style={styles.frameLabel}>COLOR STRIP</Text>
