/**
 * Final Notebook Task — Write a small story with numbers. Upload photo; AI check: writing_detected, sentence_present, numbers_present. Session 10: Graduate Master Challenge.
 */
...
const INSTRUCTIONS = 'Write a small story with numbers in your notebook. Example: "I had 2 apples. I got 1 more." Then upload or take a photo.';
...
export function GraduateMasterNotebookUpload({
  ...
  return (
    <GameLayout
      title="Final Notebook Activity"
      instruction="Write a small story with numbers. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleLine}>I had 2 apples.</Text>
          <Text style={styles.exampleLine}>I got 1 more.</Text>
        </View>
