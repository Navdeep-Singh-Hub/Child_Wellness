/**
 * Game 1 — Complete the dialogue. Teacher: Hello. Child: ______. Options Hello, Goodbye, Thank you. Correct: Hello. Session 1: Simple Conversations.
 */
    ...
    >
      <View style={styles.content}>
        <View style={styles.dialogueBox}>
          <Text style={styles.speaker}>Teacher: Hello</Text>
