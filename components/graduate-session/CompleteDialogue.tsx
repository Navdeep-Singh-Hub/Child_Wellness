/**
 * Game 1 — Complete the dialogue. Teacher: Hello. Child: ______. Options Hello, Goodbye, Thank you. Correct: Hello.
 */
...
const OPTIONS = ['Hello', 'Goodbye', 'Thank you'];
const CORRECT = 'Hello';
...
export function CompleteDialogue({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <GraduateGameShell
      studio="DIALOGUE COMPLETE · GAME 1"
      title="Finish the conversation"
      instruction="Choose the correct reply."
      mascot="💬"
      coachLine="When someone says Hello, we usually say Hello back!"
    ...
    >
      <View style={styles.dialogueFrame}>
        ...
        />
        <Text style={styles.frameLabel}>CONVERSATION</Text>
        ...
        <View style={[styles.bubbleRow, styles.childRow]}>
          <View style={[styles.bubble, styles.childBubble]}>
