...
const INSTRUCTIONS = 'Write 3 lines of dialogue in your notebook. Example: Hello, How are you?, I am fine. Then upload or take a photo.';
...
export function DialogueBuilderNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Write 3 lines of dialogue. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleLine}>Hello</Text>
          <Text style={styles.exampleLine}>How are you?</Text>
          <Text style={styles.exampleLine}>I am fine.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleLine: { fontSize: 18, fontWeight: '700', color: '#5B21B6', marginBottom: 4 },
