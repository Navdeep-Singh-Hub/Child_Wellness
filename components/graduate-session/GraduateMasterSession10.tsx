/**
 * Level 10 – The Graduate, Session 10: Graduate Master Challenge (final mastery session)
 * Flow: Intro → Game 1 (Story Builder) → Game 2 (Dialogue Quiz) → Game 3 (Word Problem) → Game 4 (Logic Master) → Notebook → Result
...
export function GraduateMasterSession10({ onExit }: GraduateMasterSession10Props = {}) {
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.introHeader}>
            <Text style={styles.introTitle}>Graduate Master Challenge</Text>
            <Text style={styles.introSub}>Use everything you learned to complete the final challenge!</Text>
            <Text style={styles.introSkills}>Story building · Dialogue · Word problems · Logic</Text>
          </View>
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.resultScroll} showsVerticalScrollIndicator={false}>
          <Text style={styles.resultTitle}>Congratulations! You completed the learning journey!</Text>
          <View style={styles.resultBadge}>
            <Text style={styles.resultBadgeEmoji}>🏆</Text>
            <Text style={styles.resultBadgeText}>Graduate Master</Text>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      {step === 5 && <GraduateMasterNotebookUpload onComplete={handleNotebookComplete} />}
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  introTitle: { fontSize: 26, fontWeight: '800', color: GRADUATE_COLOR, marginBottom: 8, textAlign: 'center' },
  introSub: { fontSize: 18, color: '#374151', marginBottom: 8, textAlign: 'center' },
  ...
  resultBadgeEmoji: { fontSize: 56, marginBottom: 8 },
  resultBadgeText: { fontSize: 22, fontWeight: '800', color: GRADUATE_COLOR },
