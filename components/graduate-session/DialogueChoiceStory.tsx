/**
 * Game 2 — Choose the correct response. Teacher: "Sit down." Options: Okay, Apple, Jump. Correct: Okay.
 */
...
const PROMPT = 'Sit down.';
const OPTIONS = ['Okay', 'Apple', 'Jump'];
const CORRECT = 'Okay';
const VOICE = 'Choose the best response.';
...
export function DialogueChoiceStory({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <GraduateGameShell
      studio="DIALOGUE CHOICE · GAME 2"
      title="Pick the correct reply"
      instruction="Choose the best response."
      mascot="💬"
      coachLine='When the teacher says "Sit down," a polite reply like Okay works best!'
    ...
    >
      <View style={styles.dialogueFrame}>
        ...
        />
        <Text style={styles.frameLabel}>CLASSROOM SCENE</Text>
        ...
        <Text style={styles.question}>What should you say?</Text>
...
const styles = StyleSheet.create({
  ...
  promptText: { fontSize: 20, fontWeight: '800', color: GR.textLight },
  divider: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
