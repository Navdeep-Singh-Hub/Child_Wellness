/**
 * Game 2 — Choose the correct response. Teacher: "Sit down." Options: Okay, Apple, Jump. Correct: Okay. Session 2: Story Sentences.
 */
    ...
    >
      <View style={styles.content}>
        <View style={styles.dialogueBox}>
          <Text style={styles.speaker}>Teacher: "{PROMPT}"</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  speaker: { fontSize: 20, fontWeight: '800', color: '#5B21B6' },
