...
const INSTRUCTIONS = 'Write two greetings in your notebook. Example: Good morning, Good night. Then upload or take a photo.';
...
export function SocialDialogueNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Write two greetings. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleLine}>Good morning</Text>
          <Text style={styles.exampleLine}>Good night</Text>
        </View>
