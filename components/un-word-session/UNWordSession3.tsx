/**
 * Level 4 Grouper — Session 3: The -UN Word Family
 * Hub → 4 games + mirage journal task → completion
 */
import { ConfettiEffect } from '@/components/games/Level1/ConfettiEffect';
import { SuccessCelebration } from '@/components/ui/SuccessCelebration';
import { markSessionGameComplete } from '@/components/special-education/shared/useSessionIntroProgress';
import { WordFamilyFinderGame } from '@/components/grouper-session/session3/WordFamilyFinderGame';
import { RhymeMatchGame } from '@/components/grouper-session/session3/RhymeMatchGame';
import { ClapWordGame } from '@/components/grouper-session/session3/ClapWordGame';
import { ObjectSortingGame } from '@/components/grouper-session/session3/ObjectSortingGame';
import { UNWordNotebookUpload } from '@/components/grouper-session/session3/UNWordNotebookUpload';
import {
  GROUPER_S3_HUB_THEME as H,
  GROUPER_S3_QUESTS,
  GROUPER_SESSION,
} from '@/components/grouper-session/grouperSessionTheme';
import { MirageMesaBackground } from '@/components/grouper-session/MirageMesaBackground';
...
const PLAY_STEPS = 5;
const SESSION_TITLE = 'Session 3 · The -UN Family';
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              <Text style={styles.hubEyebrow}>Grouper · Session 3 · Mirage Mesa</Text>
              <Text style={styles.hubTitle}>{H.name}</Text>
              <Text style={styles.hubSession}>The -UN Word Family</Text>

              <View style={styles.exampleChip}>
                <Text style={styles.exampleText}>sun · bun · run · fun</Text>
              </View>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    On the shimmering mesa, words ending in -un glow together — scout them, echo rhymes, clap, sort, then sketch your journal!
                  </Text>
                </View>
              </View>
            </View>

            {GROUPER_S3_QUESTS.map((quest) => {
