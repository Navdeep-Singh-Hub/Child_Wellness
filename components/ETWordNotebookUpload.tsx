/**
 * ET Word Notebook — Draw pet and jet. Grouper Session 7.
 * AI checks: pet_drawing_present, jet_drawing_present.
 */
...
const INSTRUCTIONS = 'Draw these -ET words: pet and jet.';
...
export function ETWordNotebookUpload({
  ...
  const [result, setResult] = useState<{
    correct: boolean;
    feedback: string;
    pet_drawing_present?: boolean;
    jet_drawing_present?: boolean;
  } | null>(null);
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      setResult({
        correct,
        feedback,
        pet_drawing_present: data.pet_drawing_present,
        jet_drawing_present: data.jet_drawing_present,
      });
      if (correct) {
        speak('Great job!');
  ...
  return (
    <GameLayout
      ...
      instruction="Draw pet and jet. Then upload or take a photo."
    >
      <View style={styles.content}>
        <Text style={styles.instructions}>{INSTRUCTIONS}</Text>
        <View style={styles.exampleRow}>
          <Text style={styles.exampleWords}>pet · jet</Text>
        </View>
