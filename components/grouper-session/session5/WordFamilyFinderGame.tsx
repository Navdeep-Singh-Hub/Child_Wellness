/**
 * Grouper Session 5 — Game 1: OP Word Shelf Scout
 * Tap top, hop, mop, pop (-OP family). Avoid sun and hat.
 */
...
import { OP_FINDER_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const CORRECT = [
  ...
  { id: 'hop', label: 'hop', emoji: '🐰' },
  { id: 'mop', label: 'mop', emoji: '🧹' },
...
export function WordFamilyFinderGame({
  ...
  useEffect(() => {
    speakGrouperHint('Tap the words that belong to the OP family. They all end with op.');
      ...
      if (isCorrect) {
        ...
        setFound((prev) => {
          ...
          if (next.size >= CORRECT.length) {
            speakGrouperHint('Great job! You found all the OP words!');
            try {
        ...
        speakGrouperHint('Try again. That word does not end with OP.');
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration
          title="OP Words Found!"
          subtitle="You spotted every -OP family word!"
          badgeEmoji="🔍"
          variant="sunset"
        />
      </View>
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakGrouperHint('Tap words that end with OP.')}>
                <Text style={styles.prompt}>Find the -OP words 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
        ...
        <View style={styles.targetCard}>
          <Text style={styles.targetSuffix}>-OP</Text>
          <Text style={styles.targetHint}>top · hop · mop · pop</Text>
        </View>
