/**
 * Grouper Session 5 — Game 2: Top Rhyme Ridge
 * Find the word that rhymes with top → hop
 */
...
import { OP_RHYME_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const PROMPT = 'top';
const CHOICES = [
  { id: 'hop', label: 'hop', emoji: '🐰', correct: true },
...
export function RhymeMatchGame({
  ...
  useEffect(() => {
    speakGrouperHint('Find a word that rhymes with top.');
  ...
  const handleTap = useCallback(
    (choice: (typeof CHOICES)[number]) => {
      ...
      if (choice.correct) {
        ...
        speakGrouperHint('Correct! Hop rhymes with top!');
        try {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.speechBubble}>
          ...
          <View style={styles.bubbleBody}>
            ...
            <Pressable onPress={() => speakGrouperHint('What rhymes with top?')}>
