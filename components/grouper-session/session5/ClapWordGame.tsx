/**
 * Grouper Session 5 — Game 3: Shelf Clap Echo
 * Clap once for each one-syllable -OP word: mop, hop
 */
...
import { OP_CLAP_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        ...
        <SuccessCelebration
          title="Beat Complete!"
          subtitle="You clapped for every -OP word!"
          badgeEmoji="👏"
          variant="sunset"
        />
      </View>
