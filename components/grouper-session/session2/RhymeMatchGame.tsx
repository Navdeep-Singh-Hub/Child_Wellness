/**
 * Grouper Session 2 — Game 2: Pin Rhyme Echo
 * Find the word that rhymes with pin → tin
 */
...
import { IN_RHYME_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const PROMPT = 'pin';
const CHOICES = [
  { id: 'tin', label: 'tin', emoji: '🥫', correct: true },
...
export function RhymeMatchGame({
  ...
  useEffect(() => {
    speakGrouperHint('Find a word that rhymes with pin.');
  ...
  const handleTap = useCallback(
    (choice: (typeof CHOICES)[number]) => {
      ...
      if (choice.correct) {
        ...
        speakGrouperHint('Correct! Tin rhymes with pin!');
        try {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.speechBubble}>
          ...
          <View style={styles.bubbleBody}>
            ...
            <Pressable onPress={() => speakGrouperHint('What rhymes with pin?')}>
