/**
 * Grouper Session 2 — Game 3: Canyon Clap Rhythm
 * Clap once for each one-syllable -IN word: pin, tin, bin
 */
...
import { IN_CLAP_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        ...
        <SuccessCelebration
          title="Beat Complete!"
          subtitle="You clapped for every -IN word!"
          badgeEmoji="👏"
          variant="sunset"
        />
      </View>
