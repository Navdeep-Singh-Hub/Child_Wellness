/**
 * Grouper Session 2 — Game 1: IN Word Canyon Scout
 * Tap pin, tin, bin, win (-IN family). Avoid cup and dog.
 */
...
import { IN_FINDER_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
export function WordFamilyFinderGame({
  ...
  useEffect(() => {
    speakGrouperHint('Tap the words that belong to the IN family. They all end with in.');
      ...
      if (isCorrect) {
        ...
        setFound((prev) => {
          ...
          if (next.size >= CORRECT.length) {
            speakGrouperHint('Great job! You found all the IN words!');
            try {
        ...
        speakGrouperHint('Try again. That word does not end with IN.');
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration
          title="IN Words Found!"
          subtitle="You spotted every -IN family word!"
          badgeEmoji="🔍"
          variant="sunset"
        />
      </View>
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakGrouperHint('Tap words that end with IN.')}>
                <Text style={styles.prompt}>Find the -IN words 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
        ...
        <View style={styles.targetCard}>
          <Text style={styles.targetSuffix}>-IN</Text>
          <Text style={styles.targetHint}>pin · tin · bin · win</Text>
        </View>
