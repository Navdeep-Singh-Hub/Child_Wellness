/**
 * Grouper Session 9 — Game 4: Category Sort Base
 * Sort food, animals, and objects into baskets
 */
...
import { CHALLENGE_CATEGORY_SORT_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
type Category = 'food' | 'animals' | 'objects';
...
const ITEMS: { id: string; label: string; emoji: string; category: Category }[] = [
  ...
  { id: 'chair', label: 'chair', emoji: '🪑', category: 'objects' },
  { id: 'ball', label: 'ball', emoji: '⚽', category: 'objects' },
];

export interface CategorySortingGameProps {
  onComplete: () => void;
  onBack?: () => void;
  currentStep?: number;
  totalSteps?: number;
...
export function CategorySortingGame({
  ...
  useEffect(() => {
    speakGrouperHint('Sort each item into the right basket. Food, animals, or objects.');
      ...
      <View style={styles.header}>
        ...
        <View style={styles.speechBubble}>
          ...
          <View style={styles.bubbleBody}>
            ...
            <Pressable
              onPress={() =>
                speakGrouperHint('Sort food, animals, and objects into the right baskets.')
              }
            >
