/**
 * Grouper Session 9 — Game 2: Rhyme Match Circuit
 * 5 rounds: cat→hat, pin→tin, sun→bun, top→hop, fan→man
 */
...
import { CHALLENGE_RHYME_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const ROUNDS = [
  ...
  },
  {
    prompt: 'top',
    promptEmoji: '🎩',
    correct: { id: 'hop', label: 'hop', emoji: '🦘' },
    wrong: [
      { id: 'tin', label: 'tin', emoji: '🥫' },
      { id: 'bun', label: 'bun', emoji: '🍞' },
    ],
    successHint: 'Correct! Hop rhymes with top!',
  },
  {
    prompt: 'fan',
    promptEmoji: '🌀',
    correct: { id: 'man', label: 'man', emoji: '👨' },
    wrong: [
      { id: 'hat', label: 'hat', emoji: '🎩' },
      { id: 'hop', label: 'hop', emoji: '🦘' },
    ],
    successHint: 'Correct! Man rhymes with fan!',
  },
] as const;
