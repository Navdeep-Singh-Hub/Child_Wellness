/**
 * Grouper Session 3 — Game 2: Sun Rhyme Mirage
 * Find the word that rhymes with sun → bun
 */
...
import { UN_RHYME_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const PROMPT = 'sun';
const CHOICES = [
  { id: 'bun', label: 'bun', emoji: '🍞', correct: true },
...
export function RhymeMatchGame({
  ...
  useEffect(() => {
    speakGrouperHint('Find a word that rhymes with sun.');
  ...
  const handleTap = useCallback(
    (choice: (typeof CHOICES)[number]) => {
      ...
      if (choice.correct) {
        ...
        speakGrouperHint('Correct! Bun rhymes with sun!');
        try {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.speechBubble}>
          ...
          <View style={styles.bubbleBody}>
            ...
            <Pressable onPress={() => speakGrouperHint('What rhymes with sun?')}>
