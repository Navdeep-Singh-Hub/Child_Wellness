/**
 * Grouper Session 3 — Game 3: Mirage Clap Pulse
 * Clap once for each one-syllable -UN word: sun, run, bun
 */
...
import { UN_CLAP_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        ...
        <SuccessCelebration
          title="Beat Complete!"
          subtitle="You clapped for every -UN word!"
          badgeEmoji="👏"
          variant="sunset"
        />
      </View>
