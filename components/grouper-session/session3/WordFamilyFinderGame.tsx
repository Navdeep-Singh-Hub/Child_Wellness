/**
 * Grouper Session 3 — Game 1: UN Word Mirage Scout
 * Tap sun, bun, run, fun (-UN family). Avoid cup and dog.
 */
...
import { UN_FINDER_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
export function WordFamilyFinderGame({
  ...
  useEffect(() => {
    speakGrouperHint('Tap the words that belong to the UN family. They all end with un.');
      ...
      if (isCorrect) {
        ...
        setFound((prev) => {
          ...
          if (next.size >= CORRECT.length) {
            speakGrouperHint('Great job! You found all the UN words!');
            try {
        ...
        speakGrouperHint('Try again. That word does not end with UN.');
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration
          title="UN Words Found!"
          subtitle="You spotted every -UN family word!"
          badgeEmoji="🔍"
          variant="sunset"
        />
      </View>
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakGrouperHint('Tap words that end with UN.')}>
                <Text style={styles.prompt}>Find the -UN words 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
        ...
        <View style={styles.targetCard}>
          <Text style={styles.targetSuffix}>-UN</Text>
          <Text style={styles.targetHint}>sun · bun · run · fun</Text>
        </View>
