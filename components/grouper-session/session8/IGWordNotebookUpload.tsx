/**
 * Grouper Session 8 — Golden Journal
 * Write pig, dig, wig, upload photo → AI verifies.
 */
...
import { IG_NOTEBOOK_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
import { speakGrouperHint, stopGrouperSpeech } from '../grouperSessionSpeech';
import { GoldenGulchBackground } from '../GoldenGulchBackground';
...
export function IGWordNotebookUpload({
  ...
  useEffect(() => {
    speakGrouperHint(
      'Golden journal! Write pig, dig, and wig in your notebook. Then take or upload a photo.'
    );
  ...
  const uploadImage = useCallback(async (uri: string) => {
    setUploading(true);
    setMsg('Journal is scanning for three IG words…');
    setMsgTone('info');
    setActiveStep(3);
    ...
    try {
      ...
      const feedback =
        data.feedback || (correct ? 'Great job on your journal!' : 'Try again — write pig, dig, and wig.');
      ...
      if (correct) {
        ...
        speakGrouperHint('Success! Beautiful IG words!');
        setCelebrating(true);
        ...
        setMsgTone('error');
        setActiveStep(2);
        speakGrouperHint('Try again. Write pig, dig, and wig clearly.');
        try {
  ...
  const handleReady = () => {
    setActiveStep(1);
    speakGrouperHint('Write pig, dig, and wig in your notebook. Then snap a photo.');
    try {
    ...
    return (
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle="Your -IG words look amazing!"
          badgeEmoji="📓"
          variant="sunset"
        />
      </View>
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.missionCard}>
          ...
          <View style={styles.missionBody}>
            ...
            <Text style={styles.missionText}>
              Write <Text style={styles.highlight}>pig · dig · wig</Text> in your journal, then photograph it.
            </Text>
          </View>
          <Pressable
            onPress={() => speakGrouperHint('Write pig, dig, and wig, then upload a photo.')}
        ...
        <View style={styles.exampleCard}>
          ...
          <Text style={styles.exampleTitle}>-IG examples</Text>
