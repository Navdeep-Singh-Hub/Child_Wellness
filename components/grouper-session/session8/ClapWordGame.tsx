/**
 * Grouper Session 8 — Game 3: Gulch Clap Beat
 * Clap once for each one-syllable -IG word: pig, dig
 */
...
import { IG_CLAP_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        ...
        <SuccessCelebration
          title="Beat Complete!"
          subtitle="You clapped for every -IG word!"
          badgeEmoji="👏"
          variant="sunset"
        />
      </View>
