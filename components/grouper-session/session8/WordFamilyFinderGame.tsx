/**
 * Grouper Session 8 — Game 1: IG Word Gulch Scout
 * Tap pig, dig, big, wig (-IG family). Avoid sun and hat.
 */
...
import { IG_FINDER_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const CORRECT = [
  ...
  { id: 'dig', label: 'dig', emoji: '⛏️' },
  { id: 'big', label: 'big', emoji: '📏' },
  { id: 'wig', label: 'wig', emoji: '💇' },
];
const WRONG = [
...
export function WordFamilyFinderGame({
  ...
  useEffect(() => {
    speakGrouperHint('Tap the words that belong to the IG family. They all end with ig.');
      ...
      if (isCorrect) {
        ...
        setFound((prev) => {
          ...
          if (next.size >= CORRECT.length) {
            speakGrouperHint('Great job! You found all the IG words!');
            try {
        ...
        speakGrouperHint('Try again. That word does not end with IG.');
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration
          title="IG Words Found!"
          subtitle="You spotted every -IG family word!"
          badgeEmoji="🔍"
          variant="sunset"
        />
      </View>
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakGrouperHint('Tap words that end with IG.')}>
                <Text style={styles.prompt}>Find the -IG words 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
        ...
        <View style={styles.targetCard}>
          <Text style={styles.targetSuffix}>-IG</Text>
          <Text style={styles.targetHint}>pig · dig · big · wig</Text>
        </View>
