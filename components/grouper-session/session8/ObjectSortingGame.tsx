/**
 * Grouper Session 8 — Game 4: Gulch Sort Nook
 * Sort pig/cow → Animals, dig/shovel → Tools
 */
...
import { IG_SORT_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const ITEMS: { id: string; label: string; emoji: string; category: Category }[] = [
  { id: 'pig', label: 'pig', emoji: '🐷', category: 'animals' },
  { id: 'cow', label: 'cow', emoji: '🐄', category: 'animals' },
  { id: 'dig', label: 'dig', emoji: '⛏️', category: 'tools' },
  { id: 'shovel', label: 'shovel', emoji: '🪏', category: 'tools' },
];
...
export function ObjectSortingGame({
  ...
  const [currentId, setCurrentId] = useState<string>('pig');
  ...
  useEffect(() => {
    speakGrouperHint('Sort each word into the right basket. Animals or tools.');
      ...
      <View style={styles.header}>
        ...
        <View style={styles.speechBubble}>
          ...
          <View style={styles.bubbleBody}>
            ...
            <Pressable
              onPress={() => speakGrouperHint('Sort animals and tools into the right baskets.')}
            >
