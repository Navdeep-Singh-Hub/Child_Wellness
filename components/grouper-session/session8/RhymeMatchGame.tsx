/**
 * Grouper Session 8 — Game 2: Pig Rhyme Gulch
 * Find the word that rhymes with pig → wig
 */
...
import { IG_RHYME_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const PROMPT = 'pig';
const CHOICES = [
  { id: 'wig', label: 'wig', emoji: '💇', correct: true },
...
export function RhymeMatchGame({
  ...
  useEffect(() => {
    speakGrouperHint('Find a word that rhymes with pig.');
  ...
  const handleTap = useCallback(
    (choice: (typeof CHOICES)[number]) => {
      ...
      if (choice.correct) {
        ...
        speakGrouperHint('Correct! Wig rhymes with pig!');
        try {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.speechBubble}>
          ...
          <View style={styles.bubbleBody}>
            ...
            <Pressable onPress={() => speakGrouperHint('What rhymes with pig?')}>
