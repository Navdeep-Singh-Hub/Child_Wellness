/**
 * Grouper Session 10 — Game 2: Rhyme Quiz Peak
...
import { MASTER_RHYME_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
export interface RhymeQuizGameProps {
  onComplete: () => void;
  onBack?: () => void;
  currentStep?: number;
  totalSteps?: number;
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration
          title="Rhyme Quiz Complete!"
          subtitle="You matched every rhyme!"
          badgeEmoji="🎵"
          variant="sunset"
        />
      </View>
