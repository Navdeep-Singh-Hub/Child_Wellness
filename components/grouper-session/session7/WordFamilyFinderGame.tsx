/**
 * Grouper Session 7 — Game 1: ET Word Sunset Scout
 * Tap pet, net, jet, wet (-ET family). Avoid sun and hat.
 */
...
import { ET_FINDER_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
export function WordFamilyFinderGame({
  ...
  useEffect(() => {
    speakGrouperHint('Tap the words that belong to the ET family. They all end with et.');
      ...
      if (isCorrect) {
        ...
        setFound((prev) => {
          ...
          if (next.size >= CORRECT.length) {
            speakGrouperHint('Great job! You found all the ET words!');
            try {
        ...
        speakGrouperHint('Try again. That word does not end with ET.');
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration
          title="ET Words Found!"
          subtitle="You spotted every -ET family word!"
          badgeEmoji="🔍"
          variant="sunset"
        />
      </View>
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakGrouperHint('Tap words that end with ET.')}>
                <Text style={styles.prompt}>Find the -ET words 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
        ...
        <View style={styles.targetCard}>
          <Text style={styles.targetSuffix}>-ET</Text>
          <Text style={styles.targetHint}>pet · net · jet · wet</Text>
        </View>
