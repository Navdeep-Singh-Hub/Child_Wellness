/**
 * Grouper Session 7 — Game 3: Sunset Clap Echo
 * Clap once for each one-syllable -ET word: pet, jet
 */
...
import { ET_CLAP_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        ...
        <SuccessCelebration
          title="Beat Complete!"
          subtitle="You clapped for every -ET word!"
          badgeEmoji="👏"
          variant="sunset"
        />
      </View>
