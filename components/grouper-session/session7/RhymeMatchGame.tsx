/**
 * Grouper Session 7 — Game 2: Pet Rhyme Glow
 * Find the word that rhymes with pet → net
 */
...
import { ET_RHYME_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
const PROMPT = 'pet';
const CHOICES = [
  { id: 'net', label: 'net', emoji: '🕸️', correct: true },
...
export function RhymeMatchGame({
  ...
  useEffect(() => {
    speakGrouperHint('Find a word that rhymes with pet.');
  ...
  const handleTap = useCallback(
    (choice: (typeof CHOICES)[number]) => {
      ...
      if (choice.correct) {
        ...
        speakGrouperHint('Correct! Net rhymes with pet!');
        try {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.speechBubble}>
          ...
          <View style={styles.bubbleBody}>
            ...
            <Pressable onPress={() => speakGrouperHint('What rhymes with pet?')}>
