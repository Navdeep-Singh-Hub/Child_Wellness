/**
 * Grouper Session 7 — Game 4: Sunset Sort Nook
 * Sort pet/dog → Animals, jet/car → Vehicles
 */
...
import { ET_SORT_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
type Category = 'animals' | 'vehicles';
...
const ITEMS: { id: string; label: string; emoji: string; category: Category }[] = [
  { id: 'pet', label: 'pet', emoji: '🐾', category: 'animals' },
  { id: 'dog', label: 'dog', emoji: '🐕', category: 'animals' },
  { id: 'jet', label: 'jet', emoji: '✈️', category: 'vehicles' },
  { id: 'car', label: 'car', emoji: '🚗', category: 'vehicles' },
];
...
export function ObjectSortingGame({
  ...
  const [currentId, setCurrentId] = useState<string>('pet');
  ...
  useEffect(() => {
    speakGrouperHint('Sort each word into the right basket. Animals or vehicles.');
      ...
      <View style={styles.header}>
        ...
        <View style={styles.speechBubble}>
          ...
          <View style={styles.bubbleBody}>
            ...
            <Pressable
              onPress={() => speakGrouperHint('Sort animals and vehicles into the right baskets.')}
            >
