/**
 * Grouper Session 1 — Game 1: AT Word Scout
 * Tap cat, bat, hat, rat (-AT family). Avoid dog and pen.
 */
...
import { AT_FINDER_THEME as T, GROUPER_SESSION } from '../grouperSessionTheme';
...
export function WordFamilyFinderGame({
  ...
  useEffect(() => {
    speakGrouperHint('Tap the words that belong to the AT family. They all end with at.');
      ...
      if (isCorrect) {
        ...
        setFound((prev) => {
          ...
          if (next.size >= CORRECT.length) {
            speakGrouperHint('Great job! You found all the AT words!');
            try {
        ...
        speakGrouperHint('Try again. That word does not end with AT.');
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration
          title="AT Words Found!"
          subtitle="You spotted every -AT family word!"
          badgeEmoji="🔍"
          variant="sunset"
        />
      </View>
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakGrouperHint('Tap words that end with AT.')}>
                <Text style={styles.prompt}>Find the -AT words 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
        ...
        <View style={styles.targetCard}>
          <Text style={styles.targetSuffix}>-AT</Text>
          <Text style={styles.targetHint}>cat · bat · hat · rat</Text>
        </View>
