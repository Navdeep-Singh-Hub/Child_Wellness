/**
 * SuperheroRhymeGame — Game 2: I-Spy Rhyming (hero-themed)
 * cape→ape, bat→cat, hero→zero, mask→ask.
 */
...
const ROUNDS: Round[] = [
  {
    ...
    correctId: 'ape',
    items: [
      { id: 'ape', label: 'Ape', image: 'https://placehold.co/120x120/FED7AA/9A3412?text=Ape' },
      { id: 'bat', label: 'Bat', image: 'https://placehold.co/120x120/E5E7EB/374151?text=Bat' },
      { id: 'hero', label: 'Hero', image: 'https://placehold.co/120x120/FEE2E2/991B1B?text=Hero' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'cape', label: 'Cape', image: 'https://placehold.co/120x120/DDD6FE/5B21B6?text=Cape' },
      { id: 'mask', label: 'Mask', image: 'https://placehold.co/120x120/FDE68A/92400E?text=Mask' },
      { id: 'shield', label: 'Shield', image: 'https://placehold.co/120x120/DBEAFE/1E40AF?text=Shield' },
    ],
  },
  {
    promptWord: 'hero',
    correctId: 'zero',
    items: [
      { id: 'zero', label: 'Zero', image: 'https://placehold.co/120x120/E5E7EB/374151?text=Zero' },
      { id: 'bat', label: 'Bat', image: 'https://placehold.co/120x120/E5E7EB/374151?text=Bat' },
      { id: 'cape', label: 'Cape', image: 'https://placehold.co/120x120/DDD6FE/5B21B6?text=Cape' },
      { id: 'super', label: 'Super', image: 'https://placehold.co/120x120/FEE2E2/991B1B?text=Super' },
    ],
  },
  {
    promptWord: 'mask',
    correctId: 'ask',
    items: [
      { id: 'ask', label: 'Ask', image: 'https://placehold.co/120x120/DBEAFE/1E40AF?text=Ask' },
      { id: 'hero', label: 'Hero', image: 'https://placehold.co/120x120/FEE2E2/991B1B?text=Hero' },
      { id: 'shield', label: 'Shield', image: 'https://placehold.co/120x120/DBEAFE/1E40AF?text=Shield' },
      { id: 'bat', label: 'Bat', image: 'https://placehold.co/120x120/E5E7EB/374151?text=Bat' },
    ],
...
export function SuperheroRhymeGame({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="Hero rhymes complete!" />;
...
const styles = StyleSheet.create({
  ...
  roundText: { fontSize: 16, fontWeight: '700', color: '#B91C1C' },
  ...
  labelHighlight: { color: '#1E40AF', textDecorationLine: 'underline' },
