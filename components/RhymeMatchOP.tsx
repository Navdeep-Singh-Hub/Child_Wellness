/**
 * Rhyme Match — Find the rhyme (top → hop). Game 2 for Grouper Session 5.
 */
...
const PROMPT_WORD = 'top';
const CHOICES = [
  { id: 'hop', label: 'hop', correct: true, image: 'https://placehold.co/120x120/D1FAE5/065F46?text=hop' },
  { id: 'sun', label: 'sun', correct: false, image: 'https://placehold.co/120x120/FEF9C3/854D0E?text=sun' },
  { id: 'cat', label: 'cat', correct: false, image: 'https://placehold.co/120x120/FED7AA/9A3412?text=cat' },
].sort(() => Math.random() - 0.5);

export function RhymeMatchOP({ onComplete }: { onComplete: () => void }) {
