        ...
        <View style={styles.instructionsContainer}>
          ...
          <View style={styles.instructionItem}>
            ...
            <View style={styles.instructionContent}>
              <Text style={styles.instructionText}>Write {WORD_BAT.word} five times</Text>
          ...
          <View style={styles.instructionItem}>
            <Ionicons name="checkmark-circle" size={24} color="#10B981" />
            <View style={styles.instructionContent}>
              <Text style={styles.instructionText}>Draw one square</Text>
              <View style={styles.exampleContainer}>
          ...
          <View style={styles.instructionItem}>
            <Ionicons name="checkmark-circle" size={24} color="#10B981" />
            <View style={styles.instructionContent}>
              <Text style={styles.instructionText}>Draw a bat</Text>
              <View style={styles.exampleContainer}>
                <Text style={styles.exampleEmoji}>{WORD_BAT.image}</Text>
              </View>
            </View>
          </View>
        </View>
