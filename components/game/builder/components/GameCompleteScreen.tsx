// Individual Game Completion Screen for The Builder
import { playSoundEffect, stopAllAudio } from '@/components/game/builder/utils/audio';
...
export default function BuilderGameCompleteScreen({
  correct,
  total,
  accuracy,
  gameId,
  ...
  const getPerformanceMessage = () => {
    if (accuracy >= 90) {
      return 'Awesome Builder!';
    } else if (accuracy >= 70) {
      return "You're learning so well!";
    } else {
