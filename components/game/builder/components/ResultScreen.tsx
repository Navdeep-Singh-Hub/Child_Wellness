...
export default function ResultScreen({ gamesCompleted, notebookResult, onBack }: ResultScreenProps) {
  ...
  const allNotebookTasks = notebookResult?.catWordDetected && notebookResult?.circleDetected && notebookResult?.catDrawingDetected;
  ...
  useEffect(() => {
    ...
    speakFeedback('Great job! You built the word CAT!');
  }, []);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Animated.View style={[styles.content, animatedStyle]}>
          ...
          <Text style={styles.encouragement}>Great job! You built the word CAT!</Text>
          ...
          {notebookResult && (
            <View style={styles.notebookResults}>
              ...
              <View style={styles.notebookItem}>
                ...
                />
                <Text style={styles.notebookText}>Word CAT</Text>
              </View>
              <View style={styles.notebookItem}>
                <Ionicons
                ...
                />
                <Text style={styles.notebookText}>Circle</Text>
              </View>
              <View style={styles.notebookItem}>
                <Ionicons
                ...
                />
                <Text style={styles.notebookText}>Cat Drawing</Text>
              </View>
            </View>
          )}
