...
import { WORD_OPTIONS, WORD_CAT } from '../utils/gameData';
...
export default function ChooseWordGameScreen({ onComplete, onBack }: ChooseWordGameScreenProps) {
  ...
  useEffect(() => {
    ...
    speakInstruction('Tap the word CAT.');
    return () => stopAllAudio();
  }, [round]);
  ...
  const handleSelect = (word: string) => {
    ...
    if (correct) {
      ...
      speakFeedback('Correct! That spells CAT!');
    } else {
      playSoundEffect('incorrect');
      speakFeedback('Try again! Look for the word CAT.');
    }
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.instructionContainer}>
        <Text style={styles.instructionText}>Tap the word CAT</Text>
      </View>
