        ...
        <View style={styles.instructionsContainer}>
          ...
          <View style={styles.instructionItem}>
            ...
            <View style={styles.instructionContent}>
              <Text style={styles.instructionText}>Write {WORD_SUN.word} five times</Text>
          ...
          <View style={styles.instructionItem}>
            <Ionicons name="checkmark-circle" size={24} color="#10B981" />
            <View style={styles.instructionContent}>
              <Text style={styles.instructionText}>Draw an oval</Text>
              <View style={styles.exampleContainer}>
          ...
          <View style={styles.instructionItem}>
            <Ionicons name="checkmark-circle" size={24} color="#10B981" />
            <View style={styles.instructionContent}>
              <Text style={styles.instructionText}>Draw the sun</Text>
              <View style={styles.exampleContainer}>
                <Text style={styles.exampleEmoji}>{WORD_SUN.image}</Text>
              </View>
            </View>
          </View>
        </View>
