// Audio utilities for The Counter games
...
export async function playSoundEffect(type: 'correct' | 'incorrect' | 'celebration' | 'click'): Promise<void> {
  try {
    ...
    console.warn(`[Counter Audio] Failed to play ${type} sound:`, error);
  }
}
...
export async function speakWord(word: string): Promise<void> {
  try {
    ...
    console.warn('[Counter Audio] Could not speak word:', error);
  }
}
...
export async function speakNumber(number: number): Promise<void> {
  try {
    ...
    console.warn('[Counter Audio] Could not speak number:', error);
  }
}
...
export async function countWithVoice(count: number): Promise<void> {
  try {
    ...
    console.warn('[Counter Audio] Could not count:', error);
  }
}
...
export async function speakFeedback(message: string): Promise<void> {
  try {
    ...
    console.warn('[Counter Audio] Could not speak feedback:', error);
  }
}
...
export async function stopAllAudio(): Promise<void> {
  try {
    ...
    console.warn('[Counter Audio] Error stopping audio:', error);
  }
}
