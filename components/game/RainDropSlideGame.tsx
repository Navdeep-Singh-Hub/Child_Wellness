...
const RainDropSlideGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
    ...
    .onEnd(() => {
      ...
      if (distance <= TOLERANCE && progress > 80) {
        ...
        try {
          ...
          speakTTS('Slide the drop down the line!', 0.78);
        } catch {}
      }
    });
  ...
  useEffect(() => {
    ...
    try {
      speakTTS('Slide the rain drop down the straight line!', 0.78);
    } catch {}
