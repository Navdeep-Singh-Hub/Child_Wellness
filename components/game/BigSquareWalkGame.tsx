...
const SQUARE_SIZE = 50; // Large square
...
const BigSquareWalkGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
  ...
  const objectX = useSharedValue(25);
  const objectY = useSharedValue(25);
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.resultCard}>
            ...
            <Text style={styles.resultTitle}>Square Walked!</Text>
            <Text style={styles.resultSubtitle}>
              You walked {finalStats.correct} squares out of {finalStats.total}!
            </Text>
            <ResultCard
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBlock}>
        <Text style={styles.title}>Big Square Walk</Text>
        <Text style={styles.subtitle}>
          Round {round}/{TOTAL_ROUNDS} • ⬜ Score: {score}
        </Text>
        <Text style={styles.helper}>
          Walk around the big square with your whole arm!
        </Text>
      </View>
          ...
          <Animated.View style={styles.gestureArea}>
            ...
            {isOffTrack && (
              <View style={styles.warningBox}>
                <Text style={styles.warningText}>Stay on the square! ⚠️</Text>
              </View>
            )}
          </Animated.View>
        </GestureDetector>
      ...
      <View style={styles.footerBox}>
        <Text style={styles.footerMain}>
          Skills: whole-arm movement • pre-writing • large shape tracing
        </Text>
        <Text style={styles.footerSub}>
          Use your whole arm to walk around the square!
        </Text>
      </View>
    </SafeAreaView>
  );
