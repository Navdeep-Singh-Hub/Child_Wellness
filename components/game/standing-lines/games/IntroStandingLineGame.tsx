...
interface IntroStandingLineGameProps {
...
export default function IntroStandingLineGame({ onComplete, onBack }: IntroStandingLineGameProps) {
  ...
  useEffect(() => {
    speakInstruction('Draw a standing line from top to bottom.');
    return () => stopAllAudio();
  }, []);
    ...
    if (hasStarted && !hasCompleted) {
      ...
      lineHeight.value = withTiming(
        ...
        () => {
          ...
          speakFeedback('Great! This is a standing line!');
        }
      );
    }
  }, [hasStarted]);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Intro to Standing Line</Text>
      </View>

      {/* Instruction */}
      <View style={styles.instructionContainer}>
        <Text style={styles.instructionText}>Draw a standing line from top to bottom</Text>
      </View>
