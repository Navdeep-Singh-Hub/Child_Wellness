/** OT Level 3 · Session 1 · Game 2 — Stop & Go · Theme: "Musical Jungle" */
...
const StopGoDrumGame: React.FC<{ onBack?: () => void; onComplete?: () => void }> = (props) => (
  <RhythmGame
    ...
    ttsWrong="Freeze when the drum stops!"
    congratsMessage={G.congrats}
    logType="stopGoDrum"
    skillTags={['impulse-control', 'rhythm', 'listening', 'response-inhibition']}
  />
);
