/** OT Level 3 · Session 1 · Game 5 — Sound Match · Theme: "Musical Jungle" */
...
const G = GAME_THEMES.instrument;
...
const InstrumentChoiceGame: React.FC<{ onBack?: () => void; onComplete?: () => void }> = (props) => (
  <RhythmGame
    ...
    ttsWrong="Listen again — who made that sound?"
    congratsMessage={G.congrats}
    logType="instrumentChoice"
    skillTags={['auditory-memory', 'sound-discrimination', 'attention']}
  />
);
