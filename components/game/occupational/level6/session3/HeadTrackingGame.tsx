...
import { HEAD_GAME_THEMES, SPACE_SHELL, type HeadMode } from '@/components/game/occupational/level6/session3/spaceTheme';
...
export const HeadTrackingGame: React.FC<{
  ...
  return (
    <LinearGradient colors={SPACE_SHELL.gradient} style={styles.root}>
      <SafeAreaView style={styles.safe}>
        <View style={styles.topRow}>
          ...
          <Text style={styles.academyLabel}>🛰️ COSMIC VOYAGER</Text>
          <View style={{ width: 64 }} />
        </View>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.statsRow}>
            <View style={[styles.statPill, { borderColor: SPACE_SHELL.statBorder }]}>
              <Text style={[styles.statLabel, { color: SPACE_SHELL.statLabel }]}>Round</Text>
            ...
            <View style={[styles.statPill, { borderColor: SPACE_SHELL.statBorder }]}>
              ...
              <Text style={[styles.statValue, { color: SPACE_SHELL.statValue }]}>{score}</Text>
            </View>
            <View style={[styles.statPill, { borderColor: SPACE_SHELL.statBorder }]}>
              <Text style={styles.coinEmoji}>🪙</Text>
              <Text style={[styles.statValue, { color: SPACE_SHELL.statValue }]}>{coins}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.stageWrap}>
          ...
          >
            ...
            <SparkleBurst key={sparkleKey} visible={sparkleKey > 0} color={SPACE_SHELL.sparkleColor} count={14} />
            ...
            {cameraSupported && error ? (
              ...
              <>
                <Text style={styles.introText}>
                  {cameraSupported
                    ? hasCamera
                      ? 'Sit where the camera sees your head and shoulders. Move only your head!'
                      : 'Starting camera…'
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#A5B4FC', fontSize: 14, fontWeight: '600', marginTop: 2, textAlign: 'center' },
