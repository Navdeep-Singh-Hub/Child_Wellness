...
const TRIANGLE_SIZE = 45; // Large triangle
...
const TriangleMountainTraceGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
  ...
  const [trianglePathStr, setTrianglePathStr] = useState('');
  ...
  const updatePaths = useCallback(() => {
    ...
    setTrianglePathStr(`M ${p1.x} ${p1.y} L ${p2.x} ${p2.y} L ${p3.x} ${p3.y} Z`);
    ...
    if (progress.value > 0) {
      ...
      for (let i = 0; i < totalSegments; i++) {
        ...
        const endPt = pathPoints.current[(i + 1) % 3];
  ...
  const panGesture = Gesture.Pan()
    ...
    .onUpdate((e) => {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        const p2 = pathPoints.current[(i + 1) % 3];
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.resultCard}>
            ...
            <Text style={styles.resultTitle}>Mountain Traced!</Text>
            <Text style={styles.resultSubtitle}>
              You traced {finalStats.correct} triangles out of {finalStats.total}!
            </Text>
            <ResultCard
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBlock}>
        <Text style={styles.title}>Triangle Mountain Trace</Text>
        <Text style={styles.subtitle}>
          Round {round}/{TOTAL_ROUNDS} • ⛰️ Score: {score}
        </Text>
        <Text style={styles.helper}>
          Trace the triangle mountain with your whole arm!
        </Text>
      </View>
          ...
          <Animated.View style={styles.gestureArea}>
            ...
            {isOffTrack && (
              <View style={styles.warningBox}>
                <Text style={styles.warningText}>Stay on the triangle! ⚠️</Text>
              </View>
            )}
          </Animated.View>
        </GestureDetector>
      ...
      <View style={styles.footerBox}>
        ...
        <Text style={styles.footerSub}>
          Use your whole arm to trace the triangle!
        </Text>
      </View>
    </SafeAreaView>
  );
