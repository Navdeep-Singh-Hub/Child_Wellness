...
const LINE_TOLERANCE = 25; // Very forgiving
...
const GlowBorderTraceGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.resultCard}>
            ...
            <Text style={styles.resultTitle}>Glow Traced!</Text>
            <Text style={styles.resultSubtitle}>
              You traced {finalStats.correct} glowing borders out of {finalStats.total}!
            </Text>
            <ResultCard
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBlock}>
        <Text style={styles.title}>Glow Border Trace</Text>
        <Text style={styles.subtitle}>
          Round {round}/{TOTAL_ROUNDS} • ✨ Score: {score}
        </Text>
        <Text style={styles.helper}>
          Trace the thick glowing border!
        </Text>
      </View>
          ...
          <Animated.View style={styles.gestureArea}>
            ...
            <Animated.View style={[styles.objectContainer, objectStyle]}>
              <View
                style={[
                  styles.object,
                  {
                    backgroundColor: isOffTrack ? '#EF4444' : '#A855F7',
                  },
                ]}
              >
            ...
            {isOffTrack && (
              <View style={styles.warningBox}>
                <Text style={styles.warningText}>Stay on the glow! ⚠️</Text>
              </View>
            )}
          </Animated.View>
        </GestureDetector>
      ...
      <View style={styles.footerBox}>
        ...
        <Text style={styles.footerSub}>
          Follow the thick glowing border!
        </Text>
      </View>
    </SafeAreaView>
  );
