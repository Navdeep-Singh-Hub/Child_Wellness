...
const LINE_TOLERANCE = 12; // Tighter tolerance for small shapes
const CIRCLE_RADIUS = 15; // Small circle
...
const TinyCircleCoinsGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.resultCard}>
            ...
            <Text style={styles.resultTitle}>Coins Traced!</Text>
            <Text style={styles.resultSubtitle}>
              You traced {finalStats.correct} coins out of {finalStats.total}!
            </Text>
            <ResultCard
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBlock}>
        <Text style={styles.title}>Tiny Circle Coins</Text>
        <Text style={styles.subtitle}>
          Round {round}/{TOTAL_ROUNDS} • 🪙 Score: {score}
        </Text>
        <Text style={styles.helper}>
          Trace the tiny circle coin with precision!
        </Text>
      </View>
          ...
          <Animated.View style={styles.gestureArea}>
            ...
            {isOffTrack && (
              <View style={styles.warningBox}>
                <Text style={styles.warningText}>Stay on the coin! ⚠️</Text>
              </View>
            )}
          </Animated.View>
        </GestureDetector>
      ...
      <View style={styles.footerBox}>
        ...
        <Text style={styles.footerSub}>
          Use your finger to trace the tiny circle!
        </Text>
      </View>
    </SafeAreaView>
  );
