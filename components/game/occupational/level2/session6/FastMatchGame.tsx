...
const FastMatchGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
  ...
  const shapes: ShapeType[] = ['circle', 'square', 'triangle', 'pentagon'];
  ...
  const renderShape = (type: ShapeType, x: number, y: number, isOutline: boolean = false) => {
    ...
    const fill = isOutline ? 'none' : '#EF4444';
    const stroke = isOutline ? '#DC2626' : '#F87171';
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.resultCard}>
            ...
            <Text style={styles.resultTitle}>Fast Match!</Text>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBlock}>
        <Text style={styles.title}>Fast Match</Text>
        <Text style={styles.subtitle}>
          Round {round}/{TOTAL_ROUNDS} • ⚡ Score: {score}
        </Text>
        <Text style={styles.helper}>
          Match shapes quickly! No rotation needed.
        </Text>
      </View>
      ...
      <View style={styles.footerBox}>
        <Text style={styles.footerMain}>
          Skills: visual discrimination • motor accuracy • speed matching
        </Text>
        <Text style={styles.footerSub}>
          Build speed gently - match shapes quickly!
        </Text>
      </View>
    </SafeAreaView>
  );
