        ...
        <GestureDetector gesture={pan}>
          <Animated.View style={styles.gestureArea}>
            <Svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none" style={styles.svg}>
              <Path d={pathFull} stroke={T.trackStroke} strokeWidth={P.pathStroke} fill="none" strokeLinecap="round" strokeLinejoin="round" />
              {pathProg ? <Path d={pathProg} stroke={T.progressStroke} strokeWidth={P.pathStroke + 1} fill="none" strokeLinecap="round" strokeLinejoin="round" /> : null}
            </Svg>
