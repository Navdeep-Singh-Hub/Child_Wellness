        ...
        <GestureDetector gesture={pan}>
          <Animated.View style={styles.gestureArea}>
            <Svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none" style={styles.svg}>
              <Path d={pathFull} stroke="rgba(236,72,153,0.35)" strokeWidth={P.pathStroke} fill="none" strokeLinecap="round" />
              {pathProg ? <Path d={pathProg} stroke="#EC4899" strokeWidth={P.pathStroke + 1} fill="none" strokeLinecap="round" /> : null}
            </Svg>
            <Animated.View style={[styles.objWrap, objStyle]}>
              <LinearGradient colors={isOffTrack ? ['#EF4444', '#DC2626'] : ['#FDE68A', '#F59E0B']} style={styles.obj}>
...
const styles = StyleSheet.create({
  ...
  playArea: { flex: 1, marginHorizontal: 8, marginBottom: 16, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(236,72,153,0.25)', backgroundColor: 'rgba(255,255,255,0.35)' },
