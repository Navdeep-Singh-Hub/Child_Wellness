...
import { HoldHitPlayArea } from '@/components/game/occupational/level4/session4/holdHit/HoldHitVisuals';
...
const HoldHitGame: React.FC<{ onBack?: () => void; onComplete?: () => void }> = ({
  onBack,
  onComplete,
}) => {
