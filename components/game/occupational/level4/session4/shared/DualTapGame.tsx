...
import { TwinTapPlayArea } from '@/components/game/occupational/level4/session4/twinTap/TwinTapVisuals';
import { DuoKeysPlayArea } from '@/components/game/occupational/level4/session4/duoKeys/DuoKeysVisuals';
import { BeatDuoPlayArea } from '@/components/game/occupational/level4/session4/beatDuo/BeatDuoVisuals';
import { FlashTapPlayArea } from '@/components/game/occupational/level4/session4/flashTap/FlashTapVisuals';
import { useTraceSound } from '@/components/game/occupational/level4/session4/shared/dualTapUtils';
import { SESSION4_4_PACING } from '@/components/game/occupational/level4/session4/shared/session4Pacing';
