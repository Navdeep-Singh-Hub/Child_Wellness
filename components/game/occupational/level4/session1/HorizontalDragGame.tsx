...
import { BallTransferPlayArea } from '@/components/game/occupational/level4/session1/BallTransferPlayArea';
import { ColorMatchPlayArea } from '@/components/game/occupational/level4/session1/ColorMatchPlayArea';
import { FeedMonsterPlayArea } from '@/components/game/occupational/level4/session1/FeedMonsterPlayArea';
import { RoadCrossingPlayArea } from '@/components/game/occupational/level4/session1/RoadCrossingPlayArea';
import { TimedDragPlayArea } from '@/components/game/occupational/level4/session1/TimedDragPlayArea';
import { DragColor, distPx, randomDragColor, useTraceSound } from '@/components/game/occupational/level4/session1/dragUtils';
import { LANE_CROSS_CARS, MONSTER_FOOD_ITEMS } from '@/components/game/occupational/level4/session1/session1Theme';
