 ...
 */
import type { DragColor } from '@/components/game/occupational/level4/session1/dragUtils';
import { DRAG_COLORS } from '@/components/game/occupational/level4/session1/dragUtils';
import { COLOR_SLIDE_THEME as T } from '@/components/game/occupational/level4/session1/session1Theme';
