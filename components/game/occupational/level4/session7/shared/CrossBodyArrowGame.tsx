...
import { CrossTapPlayArea } from '@/components/game/occupational/level4/session7/crossTap/CrossTapVisuals';
import { DriftTapPlayArea } from '@/components/game/occupational/level4/session7/driftTap/DriftTapVisuals';
import { FlashCrossPlayArea } from '@/components/game/occupational/level4/session7/flashCross/FlashCrossVisuals';
import {
  ArrowDirection,
  Hand,
  arrowEmoji,
