...
import { CrossReachPlayArea } from '@/components/game/occupational/level4/session2/CrossReachPlayArea';
import { ReturnPassPlayArea } from '@/components/game/occupational/level4/session2/ReturnPassPlayArea';
import { StarSweepPlayArea } from '@/components/game/occupational/level4/session2/StarSweepPlayArea';
import { distPx, useTraceSound } from '@/components/game/occupational/level4/session2/reverseDragUtils';
import { STAR_SWEEP_STARS } from '@/components/game/occupational/level4/session2/session2Theme';
