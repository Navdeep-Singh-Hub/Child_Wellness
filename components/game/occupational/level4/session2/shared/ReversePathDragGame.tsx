...
import { BackTrackPlayArea } from '@/components/game/occupational/level4/session2/backTrack/BackTrackVisuals';
import { PatternRunPlayArea } from '@/components/game/occupational/level4/session2/patternRun/PatternRunVisuals';
