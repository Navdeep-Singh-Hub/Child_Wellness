...
import { SwitchTapPlayArea } from '@/components/game/occupational/level4/session5/switchTap/SwitchTapVisuals';
import { HandWalkPlayArea } from '@/components/game/occupational/level4/session5/handWalk/HandWalkVisuals';
import { FlashPickPlayArea } from '@/components/game/occupational/level4/session5/flashPick/FlashPickVisuals';
import { RhythmSwitchPlayArea } from '@/components/game/occupational/level4/session5/rhythmSwitch/RhythmSwitchVisuals';
import { SpeedSwitchPlayArea } from '@/components/game/occupational/level4/session5/speedSwitch/SpeedSwitchVisuals';
import { Hand, otherHand, useTraceSound } from '@/components/game/occupational/level4/session5/shared/alternateUtils';
import { SESSION4_5_PACING } from '@/components/game/occupational/level4/session5/shared/session5Pacing';
