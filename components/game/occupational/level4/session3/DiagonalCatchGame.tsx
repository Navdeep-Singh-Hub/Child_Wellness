...
import { SkyCatchPlayArea } from '@/components/game/occupational/level4/session3/SkyCatchPlayArea';
...
import {
  SKY_CATCH_STARS,
  SKY_CATCH_THEME as T,
} from '@/components/game/occupational/level4/session3/session3Theme';
