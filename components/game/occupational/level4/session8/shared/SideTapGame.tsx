...
import { GlowTapPlayArea } from '@/components/game/occupational/level4/session8/glowTap/GlowTapVisuals';
import { OddEvenTapPlayArea } from '@/components/game/occupational/level4/session8/oddEvenTap/OddEvenTapVisuals';
import { QuickSwitchPlayArea } from '@/components/game/occupational/level4/session8/quickSwitch/QuickSwitchVisuals';
import { SoundTapPlayArea } from '@/components/game/occupational/level4/session8/soundTap/SoundTapVisuals';
import {
  Side,
  SoundCue,
  randomCountNumber,
  ...
  soundEmoji,
  useTraceSound,
} from '@/components/game/occupational/level4/session8/shared/sideTapUtils';
import { SESSION4_8_PACING } from '@/components/game/occupational/level4/session8/shared/session8Pacing';
