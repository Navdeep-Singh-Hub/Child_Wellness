...
export const NEAR_FAR_COPY: DepthCopy = {
  ...
  introBody: 'You stay at the center yellow point. On some rounds one object sits on your left and one on your right; on others both align on the same depth line from you!',
...
export const LAYERS_COPY: DepthCopy = {
  ...
  introBody: 'Three colorful circles overlap. Tap only the one with the glowing ring around it!',
  chips: ['📚 Layers', '✨ Glowing ring', '🎯 Pick'],
  startLabel: 'Stack Up',
