...
import { SignalButton } from '@/components/game/occupational/level5/session9/shared/ReactionFX';
import { ReactionCountdown } from '@/components/game/occupational/level5/session9/shared/ReactionUI';
import { SignalControlBackdrop } from '@/components/game/occupational/level5/session9/signalControl/SignalControlVisuals';
...
const GoStopGame: React.FC<{ onBack?: () => void; onComplete?: () => void }> = ({ onBack, onComplete }) => {
  ...
  return (
    <ReactionShell
      theme={SIGNAL_CONTROL_THEME} copy={SIGNAL_CONTROL_COPY} backdrop={<SignalControlBackdrop />}
    ...
    >
      ...
      {showCountdown && (
        <ReactionCountdown
          accent={SIGNAL_CONTROL_THEME.accent}
          onDone={() => {
