import { PopAlertBackdrop } from '@/components/game/occupational/level5/session9/popAlert/PopAlertVisuals';
...
const SurprisePopGame: React.FC<{ onBack?: () => void; onComplete?: () => void }> = ({ onBack, onComplete }) => {
  ...
  return (
    <ReactionShell
      theme={POP_ALERT_THEME} copy={POP_ALERT_COPY} backdrop={<PopAlertBackdrop />}
