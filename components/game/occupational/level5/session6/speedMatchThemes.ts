...
export const SPEED_SWITCH_COPY: SpeedMatchCopy = {
  ...
  introBody: 'Round 1: catch the ball only when it moves slow. Every round after that, catch it only when it moves fast!',
  chips: ['🐢 Round 1 slow', '⚡ Then fast', '🔄 Switch'],
...
export const MUSIC_SPEED_COPY: SpeedMatchCopy = {
  ...
  introBody: 'Listen for one drum beat, then tap the glowing note within 3 seconds. Miss it and you try the same round again!',
  chips: ['🥁 One beat', '⏱️ 3 seconds', '🔄 Retry'],
