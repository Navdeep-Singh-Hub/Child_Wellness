// Game completion screen for Numbers 1-5 module
import { playSoundEffect, stopAllAudio } from '@/components/game/numbers-1-5/utils/audio';
import { GAMES } from '@/components/game/numbers-1-5/utils/gameData';
