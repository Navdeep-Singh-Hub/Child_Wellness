// Audio utilities for Numbers 1–5 module
...
export async function playSoundEffect(type: 'correct' | 'incorrect' | 'celebration' | 'click' | 'tracing'): Promise<void> {
  try {
    ...
    console.warn('[Numbers 1-5 Audio] Error playing sound:', error);
  }
}

export async function speakNumber(number: number): Promise<void> {
  try {
    await speak(`This is number ${number}`, { rate: 0.8 });
  } catch (error) {
    console.warn('[Numbers 1-5 Audio] Error speaking number:', error);
  }
}
...
export async function speakInstruction(instruction: string): Promise<void> {
  try {
    ...
    console.warn('[Numbers 1-5 Audio] Error speaking instruction:', error);
  }
}
...
export async function speakFeedback(message: string): Promise<void> {
  try {
    ...
    console.warn('[Numbers 1-5 Audio] Error speaking feedback:', error);
  }
}
...
export async function stopAllAudio(): Promise<void> {
  try {
    ...
    console.warn('[Numbers 1-5 Audio] Error stopping audio:', error);
  }
}
