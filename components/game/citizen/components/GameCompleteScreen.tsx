// Individual Game Completion Screen for The Citizen
import { playSoundEffect, stopAllAudio } from '@/components/game/citizen/utils/audio';
...
export default function GameCompleteScreen({
  ...
  const getPerformanceMessage = () => {
    if (accuracy >= 90) {
      return "You're a Smart Citizen!";
    } else if (accuracy >= 70) {
      return 'Great Real-World Reading!';
    } else {
      return 'You Understand Money!';
    }
  };
