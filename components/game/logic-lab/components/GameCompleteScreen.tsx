// Individual Game Completion Screen for The Logic Lab
import { playSoundEffect, stopAllAudio } from '@/components/game/logic-lab/utils/audio';
...
export default function GameCompleteScreen({
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <LinearGradient colors={['#EFF6FF', '#F0F9FF', '#ECFDF5']} style={StyleSheet.absoluteFill} />
      ...
      <Animated.View style={[styles.resultCard, animatedStyle]}>
        ...
        >
          <View style={styles.resultContent}>
            <Ionicons
              name={accuracy >= 80 ? 'trophy' : accuracy >= 70 ? 'star' : 'bulb'}
              size={64}
              color="#FFFFFF"
            />
