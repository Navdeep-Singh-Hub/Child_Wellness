...
export function DescriptionsShell({
  title,
  subtitle,
  skills,
  gradient,
      ...
      <LinearGradient colors={gradient} style={styles.flex}>
        ...
        {!canPlay ? (
          <View style={styles.startWrap}>
            ...
            <Text style={styles.startTitle}>Use the clues!</Text>
            <Text style={styles.startHint}>Listen, look, and guess what it is.</Text>
...
const styles = StyleSheet.create({
  ...
  clueLine: { fontSize: 15, fontWeight: '700', color: '#0F172A', lineHeight: 22, marginBottom: 4 },
  choiceTile: {
    flex: 1,
    minWidth: '42%',
    maxWidth: '48%',
