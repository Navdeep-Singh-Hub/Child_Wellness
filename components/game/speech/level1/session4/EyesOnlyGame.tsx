...
export const EyesOnlyGame: React.FC<Props> = ({
  onBack,
  onComplete,
  requiredTaps = 5,
}) => {
  ...
  const finishGame = useCallback(async () => {
    ...
    speak('Amazing! You read my eyes perfectly!');
    ...
    try {
      ...
      const result = await logGameAndAward({
        ...
        xpAwarded,
        skillTags: ['subtle-social-cues', 'social-cognition', 'pre-language'],
        meta: {
          totalTaps: requiredTaps || 5,
          correctTaps: hits,
        },
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.title}>Eyes Only</Text>
            <Text style={styles.subtitle}>
              {isLooking ? '👀 Only my eyes move...' : 'Watch my eyes carefully!'}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.playArea}>
          ...
          {!isLooking && (
            <View style={styles.instructionBadge}>
              <Text style={styles.instructionText}>👀 Watch my eyes carefully!</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            👁️ Subtle Social Cues • 🧠 Social Cognition • 💬 Pre-Language
          </Text>
