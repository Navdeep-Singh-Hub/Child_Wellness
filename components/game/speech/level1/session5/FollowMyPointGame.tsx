...
export const FollowMyPointGame: React.FC<Props> = ({
  onBack,
  onComplete,
  requiredTaps = 5,
}) => {
  ...
  useEffect(() => {
    startRound();
    speak('Look! I\'m pointing here… tap it!');
    return () => {
      clearScheduledSpeech();
    };
  }, []);
  ...
  const finishGame = useCallback(async () => {
    ...
    speak('Amazing! You followed my pointing perfectly!');
    ...
    try {
      ...
      const result = await logGameAndAward({
        ...
        xpAwarded,
        skillTags: ['gesture-following', 'joint-attention', 'social-cues', 'pointing'],
        meta: {
          gameType: 'follow-my-point',
          totalTaps: requiredTaps,
          correctTaps: hits,
        },
      });
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.title}>Follow My Point</Text>
            <Text style={styles.subtitle}>
              {isPointing ? `👆 Pointing ${currentDirection}...` : 'Watch me point!'}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.playArea}>
          ...
          {!objectVisible && !isPointing && (
            <View style={styles.instructionBadge}>
              <Text style={styles.instructionText}>👆 Follow my pointing!</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            👆 Gesture Following • 🤝 Joint Attention • 👀 Social Cues
          </Text>
