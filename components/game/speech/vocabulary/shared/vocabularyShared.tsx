      ...
      <LinearGradient colors={gradient} style={styles.flex}>
        ...
        {!canPlay ? (
          <View style={styles.startWrap}>
            ...
            <Text style={styles.startTitle}>Word adventure!</Text>
            <Text style={styles.startHint}>Find animals, sort fruits, and match words you hear.</Text>
...
const styles = StyleSheet.create({
  ...
  tileSmall: { minHeight: 72, minWidth: '28%', maxWidth: '32%' },
  tileEmoji: { fontSize: 40 },
  tileEmojiSmall: { fontSize: 28 },
  tileLabel: { fontSize: 13, fontWeight: '800', marginTop: 4 },
});
