// Upload Screen - Camera/Gallery for Level 9 Session 1
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/clockwise/check-section9-session1`, {
        method: 'POST',
        headers: {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentence "Sam has a red ball" and a clock showing 1:00.
          </Text>
        </Animated.View>
