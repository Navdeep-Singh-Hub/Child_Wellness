// Upload Screen - Camera/Gallery for Level 9 Session 2
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/clockwise/check-section9-session2`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        ...
        clockDetected: result.clockDetected || false,
        clockTimeCorrect: result.clockTimeCorrect || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentence "The cat sleeps on the mat" and a clock showing 2:00.
          </Text>
        </Animated.View>
