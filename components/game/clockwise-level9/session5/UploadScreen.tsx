// Upload Screen - Camera/Gallery for Level 9 Session 5
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/clockwise/check-section9-session5`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        sentenceDetected: result.sentenceDetected || false,
        linesDetected: result.linesDetected || false,
        lengthDifferenceDetected: result.lengthDifferenceDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentence "{NOTEBOOK_SENTENCE_SESSION5}" and two lines (one short, one long).
          </Text>
        </Animated.View>
