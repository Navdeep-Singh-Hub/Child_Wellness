// Notebook Task Screen - Write "A" and solve 1+1, draw 2 apples
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word A five times. Solve 1 plus 1 equals 2. Then draw two apples.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word A five times:</Text>
          </View>
          <View style={styles.wordExamples}>
            <Text style={styles.wordExample}>A</Text>
            <Text style={styles.wordExample}>A</Text>
            <Text style={styles.wordExample}>A</Text>
            <Text style={styles.wordExample}>A</Text>
            <Text style={styles.wordExample}>A</Text>
          ...
          <View style={styles.additionExample}>
            <Text style={styles.additionText}>1 + 1 = 2</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw 2 apples</Text>
          </View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Make sure 1 + 1 = 2 is correct</Text>
          <Text style={styles.tipText}>• Draw two clear apples</Text>
