// Level 5 Session 1 - Introduction Screen
...
interface Level5Session1IntroScreenProps {
  onNext: () => void;
  onBack: () => void;
}

export default function Level5Session1IntroScreen({ onNext, onBack }: Level5Session1IntroScreenProps) {
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.infoContainer}>
          ...
          <Text style={styles.infoSubtitle}>Sight Word "A" + Addition 1+1</Text>
          <Text style={styles.description}>
            Learn the sight word "A" and discover how to add 1 + 1!
          </Text>
        </Animated.View>
