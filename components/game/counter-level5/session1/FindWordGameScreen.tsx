// Game 2: Find the Word - Tap the word "A"
...
import { WORD_OPTIONS } from './gameData';

interface FindWordGameScreenProps {
  onComplete: () => void;
  onBack: () => void;
}
...
export default function FindWordGameScreen({ onComplete, onBack }: FindWordGameScreenProps) {
  ...
  useEffect(() => {
    speakInstruction('Tap the word A').then(() => {
      speakWord('A');
    });
    return () => {
      stopAllAudio();
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Find the Word</Text>
        <View style={{ width: 40 }} />
      </View>

      {/* Instruction */}
      <View style={styles.instructionContainer}>
        <Text style={styles.instructionText}>Tap the word A</Text>
      </View>
