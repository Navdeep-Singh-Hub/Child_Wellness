// Game 3: Addition with Objects - Count apples
...
interface AdditionObjectsGameScreenProps {
  onComplete: () => void;
  onBack: () => void;
}
...
export default function AdditionObjectsGameScreen({ onComplete, onBack }: AdditionObjectsGameScreenProps) {
  ...
  const handleAnswerSelect = async (answer: number) => {
    ...
    if (isCorrect) {
      ...
      await speakFeedback('Perfect! 1 plus 1 equals 2!');
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Addition with Objects</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={styles.equationContainer}>
        ...
        <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(400)}>
          <View style={styles.appleBox}>
            <Text style={styles.appleEmoji}>{ADDITION_1_PLUS_1.objects[1]}</Text>
          </View>
        </Animated.View>
