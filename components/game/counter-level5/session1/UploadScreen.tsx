// Upload Screen - Camera/Gallery for Level 5 Session 1
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/counter/check-level5-session1`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        wordADetected: result.wordADetected || false,
        additionCorrect: result.additionCorrect || false,
        twoApplesDetected: result.twoApplesDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word A, addition 1+1=2, and two apples.
          </Text>
        </Animated.View>
