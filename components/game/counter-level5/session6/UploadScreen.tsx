// Upload Screen - Camera/Gallery for Level 5 Session 6
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/counter/check-level5-session6`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        weWordDetected: result.weWordDetected || false,
        additionCorrect: result.additionCorrect || false,
        fiveCirclesDetected: result.fiveCirclesDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word WE, addition 4+1=5, and five circles.
          </Text>
        </Animated.View>
