// Notebook Task Screen - Write "WE" and solve 4+1, draw 5 circles
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word WE five times. Solve 4 plus 1 equals 5. Then draw five circles.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word WE five times:</Text>
          </View>
          <View style={styles.wordExamples}>
            <Text style={styles.wordExample}>WE</Text>
            <Text style={styles.wordExample}>WE</Text>
            <Text style={styles.wordExample}>WE</Text>
            <Text style={styles.wordExample}>WE</Text>
            <Text style={styles.wordExample}>WE</Text>
          ...
          <View style={styles.additionExample}>
            <Text style={styles.additionText}>4 + 1 = 5</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw 5 circles</Text>
          </View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Make sure 4 + 1 = 5 is correct</Text>
          <Text style={styles.tipText}>• Draw five clear circles</Text>
