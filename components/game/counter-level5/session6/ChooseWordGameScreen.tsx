// Game 2: Choose the Word - Tap the word "WE"
...
export default function ChooseWordGameScreen({ onComplete, onBack }: ChooseWordGameScreenProps) {
  ...
  useEffect(() => {
    speakInstruction('Tap the word WE').then(() => {
      speakWord('WE');
    });
    return () => {
      stopAllAudio();
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.instructionContainer}>
        <Text style={styles.instructionText}>Tap the word WE</Text>
      </View>
