// Notebook Task Screen - Write "TO" and solve 3+1, draw 4 stars
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word TO five times. Solve 3 plus 1 equals 4. Then draw four stars.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word TO five times:</Text>
          </View>
          <View style={styles.wordExamples}>
            <Text style={styles.wordExample}>TO</Text>
            <Text style={styles.wordExample}>TO</Text>
            <Text style={styles.wordExample}>TO</Text>
            <Text style={styles.wordExample}>TO</Text>
            <Text style={styles.wordExample}>TO</Text>
          ...
          <View style={styles.additionExample}>
            <Text style={styles.additionText}>3 + 1 = 4</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw 4 stars</Text>
          </View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Make sure 3 + 1 = 4 is correct</Text>
          <Text style={styles.tipText}>• Draw four clear stars</Text>
