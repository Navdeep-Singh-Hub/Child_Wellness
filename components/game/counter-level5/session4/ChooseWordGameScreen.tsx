// Game 2: Choose the Word - Tap the word "TO"
...
export default function ChooseWordGameScreen({ onComplete, onBack }: ChooseWordGameScreenProps) {
  ...
  useEffect(() => {
    speakInstruction('Tap the word TO').then(() => {
      speakWord('TO');
    });
    return () => {
      stopAllAudio();
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.instructionContainer}>
        <Text style={styles.instructionText}>Tap the word TO</Text>
      </View>
