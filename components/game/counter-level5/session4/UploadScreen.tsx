// Upload Screen - Camera/Gallery for Level 5 Session 4
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/counter/check-level5-session4`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        toWordDetected: result.toWordDetected || false,
        additionCorrect: result.additionCorrect || false,
        fourStarsDetected: result.fourStarsDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word TO, addition 3+1=4, and four stars.
          </Text>
        </Animated.View>
