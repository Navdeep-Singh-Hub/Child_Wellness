// Upload Screen - Camera/Gallery for Level 5 Session 7
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/counter/check-level5-session7`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        ...
        sixStarsDetected: result.sixStarsDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word SEE, addition 4+2=6, and six stars.
          </Text>
        </Animated.View>
