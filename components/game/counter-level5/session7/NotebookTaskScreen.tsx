// Notebook Task Screen - Write "SEE" and solve 4+2, draw 6 stars
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word SEE five times. Solve 4 plus 2 equals 6. Then draw six stars.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word SEE five times:</Text>
          </View>
          ...
          <View style={styles.additionExample}>
            <Text style={styles.additionText}>4 + 2 = 6</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw 6 stars</Text>
          </View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Make sure 4 + 2 = 6 is correct</Text>
          <Text style={styles.tipText}>• Draw six clear stars</Text>
