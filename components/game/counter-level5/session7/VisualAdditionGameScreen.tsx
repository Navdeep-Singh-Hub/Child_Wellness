// Game 3: Visual Addition - Count apples (4+2)
...
import { ADDITION_4_PLUS_2 } from './gameData';
      ...
      <View style={styles.equationContainer}>
        <View style={styles.appleGroup}>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(200)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_4_PLUS_2.objects[0]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(300)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_4_PLUS_2.objects[1]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(400)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_4_PLUS_2.objects[2]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(500)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_4_PLUS_2.objects[3]}</Text>
            </View>
          </Animated.View>
        </View>
        ...
        <View style={styles.appleGroup}>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(600)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_4_PLUS_2.objects[4]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(700)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_4_PLUS_2.objects[5]}</Text>
            </View>
          </Animated.View>
        </View>
