// Notebook Task Screen - Write "GO" and solve 3+2, draw 5 apples
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word GO five times. Solve 3 plus 2 equals 5. Then draw five apples.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word GO five times:</Text>
          </View>
          <View style={styles.wordExamples}>
            <Text style={styles.wordExample}>GO</Text>
            <Text style={styles.wordExample}>GO</Text>
            <Text style={styles.wordExample}>GO</Text>
            <Text style={styles.wordExample}>GO</Text>
            <Text style={styles.wordExample}>GO</Text>
          ...
          <View style={styles.additionExample}>
            <Text style={styles.additionText}>3 + 2 = 5</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw 5 apples</Text>
          </View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Make sure 3 + 2 = 5 is correct</Text>
          <Text style={styles.tipText}>• Draw five clear apples</Text>
