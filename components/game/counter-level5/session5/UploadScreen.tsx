// Upload Screen - Camera/Gallery for Level 5 Session 5
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/counter/check-level5-session5`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        goWordDetected: result.goWordDetected || false,
        additionCorrect: result.additionCorrect || false,
        fiveApplesDetected: result.fiveApplesDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word GO, addition 3+2=5, and five apples.
          </Text>
        </Animated.View>
