// Notebook Task Screen - Write "SEE" and solve 5+2, draw 7 apples
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word SEE three times. Solve 5 plus 2 equals 7. Then draw seven apples.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word SEE three times:</Text>
          </View>
          <View style={styles.wordExamples}>
            <Text style={styles.wordExample}>SEE</Text>
            <Text style={styles.wordExample}>SEE</Text>
            <Text style={styles.wordExample}>SEE</Text>
          </View>
          <View style={styles.taskSection}>
          ...
          <View style={styles.additionExample}>
            <Text style={styles.additionText}>5 + 2 = 7</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw 7 apples</Text>
          </View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Make sure 5 + 2 = 7 is correct</Text>
          <Text style={styles.tipText}>• Draw seven clear apples</Text>
