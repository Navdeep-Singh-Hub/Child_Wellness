// Game 2: Find the Sight Word - Tap the word "SEE"
...
import { WORD_OPTIONS_SESSION9 } from './gameData';
...
export default function FindSightWordGameScreen({ onComplete, onBack }: FindSightWordGameScreenProps) {
  ...
  const buttonScales = WORD_OPTIONS_SESSION9.map(() => useSharedValue(1));
  ...
  const handleWordSelect = async (word: string) => {
    ...
    const index = WORD_OPTIONS_SESSION9.findIndex(w => w.word === word);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Find the Sight Word</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={styles.wordsContainer}>
        {WORD_OPTIONS_SESSION9.map((option, index) => {
