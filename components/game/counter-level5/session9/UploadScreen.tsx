// Upload Screen - Camera/Gallery for Level 5 Session 9
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/counter/check-level5-session9`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        seeWordDetected: result.seeWordDetected || false,
        additionCorrect: result.additionCorrect || false,
        sevenApplesDetected: result.sevenApplesDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word SEE, addition 5+2=7, and seven apples.
          </Text>
        </Animated.View>
