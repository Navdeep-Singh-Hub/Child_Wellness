// Notebook Task Screen - Write "THE" and solve 2+1, draw 3 stars
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word THE five times. Solve 2 plus 1 equals 3. Then draw three stars.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word THE five times:</Text>
          </View>
          <View style={styles.wordExamples}>
            <Text style={styles.wordExample}>THE</Text>
            <Text style={styles.wordExample}>THE</Text>
            <Text style={styles.wordExample}>THE</Text>
            <Text style={styles.wordExample}>THE</Text>
            <Text style={styles.wordExample}>THE</Text>
          ...
          <View style={styles.additionExample}>
            <Text style={styles.additionText}>2 + 1 = 3</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw 3 stars</Text>
          </View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Make sure 2 + 1 = 3 is correct</Text>
          <Text style={styles.tipText}>• Draw three clear stars</Text>
