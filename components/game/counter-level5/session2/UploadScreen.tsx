// Upload Screen - Camera/Gallery for Level 5 Session 2
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/counter/check-level5-session2`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        theWordDetected: result.theWordDetected || false,
        additionCorrect: result.additionCorrect || false,
        threeStarsDetected: result.threeStarsDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word THE, addition 2+1=3, and three stars.
          </Text>
        </Animated.View>
