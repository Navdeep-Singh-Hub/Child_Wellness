// Game 3: Object Counting - Count apples (2+2)
...
import { ADDITION_2_PLUS_2 } from './gameData';
...
export default function ObjectCountingGameScreen({ onComplete, onBack }: ObjectCountingGameScreenProps) {
  ...
  const handleAnswerSelect = async (answer: number) => {
    ...
    if (isCorrect) {
      ...
      await speakFeedback('Perfect! 2 plus 2 equals 4!');
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Count Objects</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={styles.equationContainer}>
        <View style={styles.appleGroup}>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(200)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_2_PLUS_2.objects[0]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(300)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_2_PLUS_2.objects[1]}</Text>
            </View>
          </Animated.View>
        </View>
        ...
        <View style={styles.appleGroup}>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(400)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_2_PLUS_2.objects[2]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(500)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_2_PLUS_2.objects[3]}</Text>
            </View>
          </Animated.View>
        </View>
