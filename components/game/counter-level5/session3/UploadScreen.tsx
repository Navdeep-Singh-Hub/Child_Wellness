// Upload Screen - Camera/Gallery for Level 5 Session 3
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/counter/check-level5-session3`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        isWordDetected: result.isWordDetected || false,
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word IS, addition 2+2=4, and four circles.
          </Text>
        </Animated.View>
