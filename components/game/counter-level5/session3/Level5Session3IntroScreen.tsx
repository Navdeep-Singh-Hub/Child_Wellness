// Level 5 Session 3 - Introduction Screen
...
interface Level5Session3IntroScreenProps {
  onNext: () => void;
  onBack: () => void;
}

export default function Level5Session3IntroScreen({ onNext, onBack }: Level5Session3IntroScreenProps) {
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.infoContainer}>
          ...
          <Text style={styles.infoSubtitle}>Sight Word "IS" + Addition 2+2</Text>
          <Text style={styles.description}>
            Learn the sight word "IS" and discover how to add 2 + 2!
          </Text>
        </Animated.View>
