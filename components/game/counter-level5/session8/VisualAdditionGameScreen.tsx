// Game 3: Visual Addition - Count apples (5+1)
...
import { ADDITION_5_PLUS_1 } from './gameData';
...
export default function VisualAdditionGameScreen({ onComplete, onBack }: VisualAdditionGameScreenProps) {
  ...
  const handleAnswerSelect = async (answer: number) => {
    ...
    if (isCorrect) {
      ...
      await speakFeedback('Perfect! 5 plus 1 equals 6!');
        ...
        <View style={styles.appleGroup}>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(200)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_5_PLUS_1.objects[0]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(300)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_5_PLUS_1.objects[1]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(400)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_5_PLUS_1.objects[2]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(500)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_5_PLUS_1.objects[3]}</Text>
            </View>
          </Animated.View>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(600)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_5_PLUS_1.objects[4]}</Text>
            </View>
          </Animated.View>
        </View>
        <Text style={styles.plusSign}>+</Text>
        <View style={styles.appleGroup}>
          <Animated.View style={appleAnimatedStyle} entering={FadeInDown.delay(700)}>
            <View style={styles.appleBox}>
              <Text style={styles.appleEmoji}>{ADDITION_5_PLUS_1.objects[5]}</Text>
            </View>
          </Animated.View>
        </View>
