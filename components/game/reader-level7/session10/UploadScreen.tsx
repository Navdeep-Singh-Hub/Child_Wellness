// Upload Screen - Camera/Gallery for Level 7 Session 10
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/reader/check-section7-session10`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        sentence1Detected: result.sentence1Detected || false,
        sentence2Detected: result.sentence2Detected || false,
        subtractionCorrect: result.subtractionCorrect || false,
        fourCirclesDetected: result.fourCirclesDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentences "I see a cat" and "I see a dog", subtractions 6-2=4 and 7-3=4, and four circles.
          </Text>
        </Animated.View>
