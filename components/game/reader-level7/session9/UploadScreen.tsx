// Upload Screen - Camera/Gallery for Level 7 Session 9
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/reader/check-section7-session9`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        ...
        fiveStarsDetected: result.fiveStarsDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentence "I see a bat", subtraction 9-4=5, and five stars.
          </Text>
        </Animated.View>
