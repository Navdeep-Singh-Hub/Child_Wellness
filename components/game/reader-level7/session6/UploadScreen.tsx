// Upload Screen - Camera/Gallery for Level 7 Session 6
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/reader/check-section7-session6`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        ...
        threeCirclesDetected: result.threeCirclesDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentence "I see a cup", subtraction 6-3=3, and three circles.
          </Text>
        </Animated.View>
