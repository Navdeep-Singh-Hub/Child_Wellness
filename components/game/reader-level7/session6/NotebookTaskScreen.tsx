// Notebook Task Screen - Write sentence and solve subtraction, draw circles
...
import { SENTENCE_SESSION6, SUBTRACTION_6_MINUS_3 } from './gameData';
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      `Write the sentence: ${SENTENCE_SESSION6.sentence}. Solve ${SUBTRACTION_6_MINUS_3.equation} equals ${SUBTRACTION_6_MINUS_3.answer}. Then draw ${SUBTRACTION_6_MINUS_3.answer} circles.`
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.sentenceExample}>
            <Text style={styles.sentenceText}>{SENTENCE_SESSION6.sentence}</Text>
          </View>
          <View style={styles.taskSection}>
          ...
          <View style={styles.subtractionExample}>
            <Text style={styles.subtractionText}>
              {SUBTRACTION_6_MINUS_3.equation} = {SUBTRACTION_6_MINUS_3.answer}
            </Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw {SUBTRACTION_6_MINUS_3.answer} circles</Text>
          </View>
          <View style={styles.exampleContainer}>
            <Text style={styles.exampleLabel}>Example:</Text>
            <View style={styles.circlesExample}>
              {Array.from({ length: SUBTRACTION_6_MINUS_3.answer }).map((_, index) => (
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Make sure {SUBTRACTION_6_MINUS_3.equation} = {SUBTRACTION_6_MINUS_3.answer} is correct</Text>
          <Text style={styles.tipText}>• Draw {SUBTRACTION_6_MINUS_3.answer} clear circles</Text>
