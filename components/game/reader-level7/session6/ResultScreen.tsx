// Result Screen - Show detection results for Level 7 Session 6
        ...
        <Animated.View entering={FadeInDown.delay(600)} style={styles.resultsContainer}>
          ...
          <View style={styles.resultItem}>
            ...
            <Text style={styles.resultText}>
              Sentence "I see a cup" {result.sentenceDetected ? 'found ✓' : 'not found'}
            </Text>
          </View>
          ...
          <View style={styles.resultItem}>
            ...
            />
            <Text style={styles.resultText}>
              Subtraction 6-3=3 {result.subtractionCorrect ? 'correct ✓' : 'not found or incorrect'}
            </Text>
          </View>

          <View style={styles.resultItem}>
            <Ionicons
              name={result.threeCirclesDetected ? 'checkmark-circle' : 'close-circle'}
              size={32}
              color={result.threeCirclesDetected ? '#10B981' : '#EF4444'}
            />
            <Text style={styles.resultText}>
              Three circles {result.threeCirclesDetected ? 'found ✓' : 'not found'}
            </Text>
          </View>
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(800)} style={styles.messageContainer}>
          {allDetected ? (
            ...
            <>
              ...
              <Text style={styles.messageText}>
                {!result.sentenceDetected && 'We couldn\'t find the sentence "I see a cup". '}
                {!result.subtractionCorrect && 'We couldn\'t find 6-3=3 solved correctly. '}
                {!result.threeCirclesDetected && 'We couldn\'t find three circles. '}
