// Game 2: Sentence Build - Arrange words to make the sentence
...
import { CORRECT_ORDER_SESSION3, MIXED_WORDS_SESSION3 } from './gameData';
...
export default function SentenceBuildGameScreen({ onComplete, onBack }: SentenceBuildGameScreenProps) {
  ...
  const checkOrder = () => {
    ...
    const isCorrect = JSON.stringify(currentOrder) === JSON.stringify(CORRECT_ORDER_SESSION3);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Sentence Build</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <View style={styles.wordsContainer}>
        {MIXED_WORDS_SESSION3.map((word, index) => {
