// Upload Screen - Camera/Gallery for Level 7 Session 3
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/reader/check-section7-session3`, {
        method: 'POST',
        headers: {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentence "I see a bat", subtraction 5-2=3, and three stars.
          </Text>
        </Animated.View>
