// Upload Screen - Camera/Gallery for Level 7 Session 4
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/reader/check-section7-session4`, {
        method: 'POST',
        headers: {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentence "I see the sun", subtraction 5-1=4, and four stars.
          </Text>
        </Animated.View>
