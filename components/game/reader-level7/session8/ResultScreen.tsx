// Result Screen - Show detection results for Level 7 Session 8
...
export default function ResultScreen({ result, onRetry, onComplete }: ResultScreenProps) {
  ...
  useEffect(() => {
    ...
    if (allDetected) {
      speakFeedback('Great job! You built sentences and solved subtraction!').catch(() => {});
    } else {
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInUp.delay(200)} style={styles.titleContainer}>
          ...
          <Text style={styles.subtitle}>Session 8 Complete</Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(600)} style={styles.resultsContainer}>
          ...
          <View style={styles.resultItem}>
            ...
            <Text style={styles.resultText}>
              Sentence "I see a cat" {result.sentenceDetected ? 'found ✓' : 'not found'}
            </Text>
          </View>
          ...
          <View style={styles.resultItem}>
            ...
            />
            <Text style={styles.resultText}>
              Subtraction 8-3=5 {result.subtractionCorrect ? 'correct ✓' : 'not found or incorrect'}
            </Text>
          </View>
          ...
          {allDetected ? (
            <>
              ...
              <Text style={styles.messageText}>
                You built sentences and solved subtraction! Great work!
              </Text>
            </>
          ) : (
            <>
              ...
              <Text style={styles.messageText}>
                {!result.sentenceDetected && 'We couldn\'t find the sentence "I see a cat". '}
                {!result.subtractionCorrect && 'We couldn\'t find 8-3=5 solved correctly. '}
