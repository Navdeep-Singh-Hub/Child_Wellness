// Result Screen - Show detection results for Level 7 Session 1
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(600)} style={styles.resultsContainer}>
          ...
          <View style={styles.resultItem}>
            ...
            />
            <Text style={styles.resultText}>
              Subtraction 3-1=2 {result.subtractionCorrect ? 'correct ✓' : 'not found or incorrect'}
            </Text>
          </View>
          ...
          {allDetected ? (
            ...
            <>
              ...
              <Text style={styles.messageText}>
                ...
                {!result.subtractionCorrect && 'We couldn\'t find 3-1=2 solved correctly. '}
