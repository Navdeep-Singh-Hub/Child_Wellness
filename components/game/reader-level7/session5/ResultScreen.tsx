// Result Screen - Show detection results for Level 7 Session 5
        ...
        <Animated.View entering={FadeInDown.delay(600)} style={styles.resultsContainer}>
          ...
          <View style={styles.resultItem}>
            ...
            <Text style={styles.resultText}>
              Sentence "I see a hat" {result.sentenceDetected ? 'found ✓' : 'not found'}
            </Text>
          </View>
          ...
          <View style={styles.resultItem}>
            ...
            />
            <Text style={styles.resultText}>
              Subtraction 6-2=4 {result.subtractionCorrect ? 'correct ✓' : 'not found or incorrect'}
            </Text>
          </View>

          <View style={styles.resultItem}>
            <Ionicons
              name={result.fourApplesDetected ? 'checkmark-circle' : 'close-circle'}
              size={32}
              color={result.fourApplesDetected ? '#10B981' : '#EF4444'}
            />
            <Text style={styles.resultText}>
              Four apples {result.fourApplesDetected ? 'found ✓' : 'not found'}
            </Text>
          </View>
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(800)} style={styles.messageContainer}>
          {allDetected ? (
            ...
            <>
              ...
              <Text style={styles.messageText}>
                {!result.sentenceDetected && 'We couldn\'t find the sentence "I see a hat". '}
                {!result.subtractionCorrect && 'We couldn\'t find 6-2=4 solved correctly. '}
                {!result.fourApplesDetected && 'We couldn\'t find four apples. '}
