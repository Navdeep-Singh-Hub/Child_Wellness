// Upload Screen - Camera/Gallery for Level 7 Session 5
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/reader/check-section7-session5`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        ...
        fourApplesDetected: result.fourApplesDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the sentence "I see a hat", subtraction 6-2=4, and four apples.
          </Text>
        </Animated.View>
