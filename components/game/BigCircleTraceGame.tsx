...
const LINE_TOLERANCE = 18; // More forgiving for large shapes
const CIRCLE_RADIUS = 35; // Large circle
...
const BigCircleTraceGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
  ...
  const panGesture = Gesture.Pan()
    ...
    .onUpdate((e) => {
      ...
      if (dist > LINE_TOLERANCE) {
        ...
        // If current progress is less than last progress (by more than small threshold), ignore it
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.resultCard}>
            ...
            <Text style={styles.resultTitle}>Circle Traced!</Text>
            <Text style={styles.resultSubtitle}>
              You traced {finalStats.correct} circles out of {finalStats.total}!
            </Text>
            <ResultCard
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBlock}>
        <Text style={styles.title}>Big Circle Trace</Text>
        <Text style={styles.subtitle}>
          Round {round}/{TOTAL_ROUNDS} • ⭕ Score: {score}
        </Text>
        <Text style={styles.helper}>
          Trace the big circle with your whole arm!
        </Text>
      </View>
      ...
      <View style={styles.footerBox}>
        ...
        <Text style={styles.footerSub}>
          Use your whole arm to trace the big circle!
        </Text>
      </View>
    </SafeAreaView>
  );
