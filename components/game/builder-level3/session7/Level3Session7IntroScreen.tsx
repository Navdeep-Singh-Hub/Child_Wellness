// Level 3 Session 7 - Introduction Screen
...
interface Level3Session7IntroScreenProps {
  onNext: () => void;
  onBack: () => void;
}

export default function Level3Session7IntroScreen({ onNext, onBack }: Level3Session7IntroScreenProps) {
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.infoContainer}>
          ...
          <Text style={styles.infoSubtitle}>Word CUP + Mirror Drawing</Text>
          <Text style={styles.description}>
            Learn to recognize and build the word CUP, and practice mirror drawing!
          </Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(600)} style={styles.featuresContainer}>
          ...
          <View style={styles.feature}>
            ...
            <Text style={styles.featureText}>Mirror Drawing</Text>
          </View>
          <View style={styles.feature}>
            <Ionicons name="pencil" size={32} color="#FFFFFF" />
            <Text style={styles.featureText}>Drawing Practice</Text>
          </View>
        </Animated.View>
