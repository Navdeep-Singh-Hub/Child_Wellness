// Game 2: Choose the Word - Multiple choice for CUP
...
export default function ChooseWordGameScreen({ onComplete, onBack }: ChooseWordGameScreenProps) {
  ...
  useEffect(() => {
    speakInstruction('Tap the word CUP').catch(() => {});
    return () => {
      stopAllAudio();
    };
  }, []);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.instructionContainer}>
        <Text style={styles.instructionText}>Tap the word CUP</Text>
      </View>
