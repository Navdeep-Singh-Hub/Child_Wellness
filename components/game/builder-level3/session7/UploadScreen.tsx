// Upload Screen - Camera/Gallery for Session 7
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/builder/check-session-7`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        cupWordDetected: result.cupWordDetected || false,
        heartShapeDetected: result.heartShapeDetected || false,
        mirrorSymmetryDetected: result.mirrorSymmetryDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word CUP and a symmetrical heart.
          </Text>
        </Animated.View>
