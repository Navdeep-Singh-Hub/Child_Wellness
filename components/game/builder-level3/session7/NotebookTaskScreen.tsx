// Notebook Task Screen - Write CUP and draw symmetrical heart
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word CUP five times. Then draw a symmetrical heart with both sides matching.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word CUP five times:</Text>
          </View>
          <View style={styles.wordExamples}>
            <Text style={styles.wordExample}>CUP</Text>
            <Text style={styles.wordExample}>CUP</Text>
            <Text style={styles.wordExample}>CUP</Text>
            <Text style={styles.wordExample}>CUP</Text>
            <Text style={styles.wordExample}>CUP</Text>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Draw a symmetrical heart</Text>
          </View>
          <View style={styles.exampleContainer}>
            <Text style={styles.exampleLabel}>Example:</Text>
            <View style={styles.heartExample}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Draw a heart with matching sides</Text>
          <Text style={styles.tipText}>• Make sure both sides are symmetrical</Text>
