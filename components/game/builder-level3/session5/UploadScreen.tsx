// Upload Screen - Camera/Gallery for Session 5
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/builder/check-session-5`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        sunWordDetected: result.sunWordDetected || false,
        ovalDetected: result.ovalDetected || false,
        ovalCurveDetected: result.ovalCurveDetected || false,
        sunDrawingDetected: result.sunDrawingDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word SUN, oval, and sun drawing.
          </Text>
        </Animated.View>
