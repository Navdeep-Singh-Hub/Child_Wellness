// Level 3 Session 5 - Introduction Screen
...
interface Level3Session5IntroScreenProps {
  onNext: () => void;
  onBack: () => void;
}

export default function Level3Session5IntroScreen({ onNext, onBack }: Level3Session5IntroScreenProps) {
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.infoContainer}>
          ...
          <Text style={styles.infoSubtitle}>Word SUN + Shape Oval</Text>
          <Text style={styles.description}>
            Learn to recognize and build the word SUN, and identify oval shapes!
          </Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(600)} style={styles.featuresContainer}>
          ...
          <View style={styles.feature}>
            <Ionicons name="ellipse" size={32} color="#FFFFFF" />
            <Text style={styles.featureText}>Oval Shapes</Text>
          </View>
          <View style={styles.feature}>
