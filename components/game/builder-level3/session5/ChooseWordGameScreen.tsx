// Game 2: Choose the Word - Multiple choice for SUN
...
export default function ChooseWordGameScreen({ onComplete, onBack }: ChooseWordGameScreenProps) {
  ...
  useEffect(() => {
    speakInstruction('Tap the word SUN').catch(() => {});
    return () => {
      stopAllAudio();
    };
  }, []);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.instructionContainer}>
        <Text style={styles.instructionText}>Tap the word SUN</Text>
      </View>
