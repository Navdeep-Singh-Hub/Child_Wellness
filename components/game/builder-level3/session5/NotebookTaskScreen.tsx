// Notebook Task Screen - Write SUN and draw oval + sun
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word SUN five times. Then draw an oval and the sun.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word SUN five times:</Text>
          </View>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Draw an oval shape 🥚</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw the sun ☀️</Text>
          </View>
        </Animated.View>
