// Upload Screen - Camera/Gallery for Session 6
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/builder/check-session-6`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        penWordDetected: result.penWordDetected || false,
        centerLineDetected: result.centerLineDetected || false,
        symmetricalShapesDetected: result.symmetricalShapesDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word PEN, center line, and symmetrical shapes.
          </Text>
        </Animated.View>
