// Level 3 Session 6 - Introduction Screen
...
interface Level3Session6IntroScreenProps {
  onNext: () => void;
  onBack: () => void;
}

export default function Level3Session6IntroScreen({ onNext, onBack }: Level3Session6IntroScreenProps) {
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.infoContainer}>
          ...
          <Text style={styles.infoSubtitle}>Word PEN + Symmetry</Text>
          <Text style={styles.description}>
            Learn to recognize and build the word PEN, and discover symmetry!
          </Text>
        </Animated.View>
