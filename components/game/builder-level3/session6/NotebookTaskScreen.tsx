// Notebook Task Screen - Write PEN and draw symmetrical shapes
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word PEN five times. Then draw a vertical line and the same shape on both sides.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word PEN five times:</Text>
          </View>
          <View style={styles.wordExamples}>
            <Text style={styles.wordExample}>PEN</Text>
            <Text style={styles.wordExample}>PEN</Text>
            <Text style={styles.wordExample}>PEN</Text>
            <Text style={styles.wordExample}>PEN</Text>
            <Text style={styles.wordExample}>PEN</Text>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Draw a vertical line in the middle of the page</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw the same shape on both sides of the line</Text>
          </View>
          <View style={styles.exampleContainer}>
            <Text style={styles.exampleLabel}>Example:</Text>
            <View style={styles.symmetryExample}>
            ...
            <Text style={styles.exampleHint}>Both sides should look the same!</Text>
          </View>
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Draw a straight line down the middle</Text>
          <Text style={styles.tipText}>• Draw the same shape on both sides</Text>
          <Text style={styles.tipText}>• Make sure both sides match!</Text>
        </Animated.View>
