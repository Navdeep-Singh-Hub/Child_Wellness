// Upload Screen - Camera/Gallery for Session 3
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/builder/check-session-3`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        dogWordDetected: result.dogWordDetected || false,
        triangleDetected: result.triangleDetected || false,
        triangleEdgesDetected: result.triangleEdgesDetected || false,
        dogDrawingDetected: result.dogDrawingDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word DOG, triangle, and dog drawing.
          </Text>
        </Animated.View>
