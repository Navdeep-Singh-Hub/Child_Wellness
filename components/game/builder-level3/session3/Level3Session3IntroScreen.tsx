// Level 3 Session 3 - Introduction Screen
...
interface Level3Session3IntroScreenProps {
  onNext: () => void;
  onBack: () => void;
}

export default function Level3Session3IntroScreen({ onNext, onBack }: Level3Session3IntroScreenProps) {
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.infoContainer}>
          ...
          <Text style={styles.infoSubtitle}>Word DOG + Shape Triangle</Text>
          <Text style={styles.description}>
            Learn to recognize and build the word DOG, and identify triangle shapes!
          </Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(600)} style={styles.featuresContainer}>
          ...
          <View style={styles.feature}>
            <Ionicons name="triangle" size={32} color="#FFFFFF" />
            <Text style={styles.featureText}>Triangle Shapes</Text>
          </View>
          <View style={styles.feature}>
