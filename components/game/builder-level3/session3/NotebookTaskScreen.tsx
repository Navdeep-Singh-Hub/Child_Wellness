// Notebook Task Screen - Write DOG and draw triangle + dog
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the word DOG five times. Then draw a triangle and a dog.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Write the word DOG five times:</Text>
          </View>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Draw a triangle shape 🔺</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw a dog 🐶</Text>
          </View>
        </Animated.View>
