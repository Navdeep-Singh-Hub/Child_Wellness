// Game 1: Word Introduction - Animated letters B-A-T
...
const LETTERS = ['B', 'A', 'T'];
const BAT_IMAGE = 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=400&h=400&fit=crop';
...
export default function WordIntroScreen({ onNext, onBack }: WordIntroScreenProps) {
  ...
  const displayedLetters = LETTERS.slice(0, currentLetterIndex + 1);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      {showImage && (
        <Animated.View style={[styles.imageContainer, imageAnimatedStyle]}>
          <Text style={styles.imageLabel}>This is a BAT</Text>
