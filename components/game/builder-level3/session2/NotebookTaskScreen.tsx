// Notebook Task Screen - Instructions for writing BAT and drawing square
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  React.useEffect(() => {
    speakInstruction('Please complete the notebook tasks. Write BAT five times, draw one square, and draw a bat.').catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.taskCard}>
          <View style={styles.taskHeader}>
            ...
            <Text style={styles.taskTitle}>Write BAT five times</Text>
          </View>
          <View style={styles.exampleContainer}>
            <Text style={styles.exampleText}>BAT</Text>
            <Text style={styles.exampleText}>BAT</Text>
            <Text style={styles.exampleText}>BAT</Text>
            <Text style={styles.exampleText}>BAT</Text>
            <Text style={styles.exampleText}>BAT</Text>
        ...
        <View style={styles.taskCard}>
          <View style={styles.taskHeader}>
            ...
            <Text style={styles.taskTitle}>Draw one square</Text>
          </View>
          <View style={styles.squareExample}>
        ...
        <View style={styles.taskCard}>
          <View style={styles.taskHeader}>
            ...
            <Text style={styles.taskTitle}>Draw a bat</Text>
          </View>
          <View style={styles.batExample}>
            <Text style={styles.batEmoji}>🦇</Text>
            <Text style={styles.batHint}>Draw a picture of a bat</Text>
          </View>
        </View>
