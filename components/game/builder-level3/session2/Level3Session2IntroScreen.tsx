// Level 3 Session 2 - Introduction Screen
...
interface Level3Session2IntroScreenProps {
  onNext: () => void;
  onBack: () => void;
}

export default function Level3Session2IntroScreen({ onNext, onBack }: Level3Session2IntroScreenProps) {
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.infoContainer}>
          ...
          <Text style={styles.infoSubtitle}>Word BAT + Shape Square</Text>
          <Text style={styles.description}>
            Learn to recognize and build the word BAT, and identify square shapes!
          </Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(600)} style={styles.featuresContainer}>
          ...
          <View style={styles.feature}>
            ...
            <Text style={styles.featureText}>Square Shapes</Text>
          </View>
          <View style={styles.feature}>
