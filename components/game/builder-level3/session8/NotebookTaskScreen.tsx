// Notebook Task Screen - Write CAT, DOG, BAT and draw circle and triangle
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the words CAT, DOG, and BAT. Then draw a circle and a triangle.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <View style={styles.taskSection}>
            ...
            <Text style={styles.taskText}>Draw a circle</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>3.</Text>
            <Text style={styles.taskText}>Draw a triangle</Text>
          </View>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Draw a round circle</Text>
          <Text style={styles.tipText}>• Draw a triangle with three sides</Text>
