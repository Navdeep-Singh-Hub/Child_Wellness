// Upload Screen - Camera/Gallery for Session 8
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/builder/check-session-8`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        catDetected: result.catDetected || false,
        dogDetected: result.dogDetected || false,
        batDetected: result.batDetected || false,
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the words CAT, DOG, BAT and shapes circle and triangle.
          </Text>
        </Animated.View>
