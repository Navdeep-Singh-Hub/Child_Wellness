// Level 3 Session 1 - Introduction Screen
...
interface Level3Session1IntroScreenProps {
  onNext: () => void;
  onBack: () => void;
}

export default function Level3Session1IntroScreen({ onNext, onBack }: Level3Session1IntroScreenProps) {
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.infoContainer}>
          ...
          <Text style={styles.infoSubtitle}>Word CAT + Shape Circle</Text>
          <Text style={styles.description}>
            Learn to recognize and build the word CAT, and identify circle shapes!
          </Text>
        </Animated.View>
