// Upload Screen - Camera/Gallery for Session 10
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/builder/check-session-10`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        catCorrect: result.catCorrect || false,
        dogCorrect: result.dogCorrect || false,
        sunCorrect: result.sunCorrect || false,
        circleDetected: result.circleDetected || false,
        squareDetected: result.squareDetected || false,
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the words CAT, DOG, SUN and shapes circle, square, triangle.
          </Text>
        </Animated.View>
