// Notebook Task Screen - Write CAT, DOG, SUN and draw shapes
...
export default function NotebookTaskScreen({ onNext, onBack }: NotebookTaskScreenProps) {
  useEffect(() => {
    speakInstruction(
      'Write the words CAT, DOG, and SUN. Then draw a circle, square, and triangle.'
    ).catch(() => {});
    return () => stopAllAudio();
  }, []);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          <Text style={styles.instructionTitle}>📝 Final Challenge Task</Text>
          ...
          <View style={styles.wordExamples}>
            ...
            <Text style={styles.wordExample}>SUN</Text>
          </View>
          <View style={styles.taskSection}>
            <Text style={styles.taskNumber}>2.</Text>
            <Text style={styles.taskText}>Draw these shapes:</Text>
          </View>
          <View style={styles.shapesExample}>
            <View style={styles.shapeExample}>
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.tipsCard}>
          ...
          <Text style={styles.tipText}>• Draw clear shapes</Text>
          <Text style={styles.tipText}>• Make sure all shapes are visible</Text>
          <Text style={styles.tipText}>• This is your final challenge - do your best! 🏆</Text>
        </Animated.View>
