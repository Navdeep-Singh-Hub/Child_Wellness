// Upload Screen - Camera/Gallery for Session 4
...
export default function UploadScreen({ onComplete, onBack }: UploadScreenProps) {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/builder/check-session-4`, {
        method: 'POST',
        headers: {
      ...
      onComplete({
        hatWordDetected: result.hatWordDetected || false,
        rectangleDetected: result.rectangleDetected || false,
        rectangleProportionValid: result.rectangleProportionValid || false,
        hatDrawingDetected: result.hatDrawingDetected || false,
      });
    } catch (error) {
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200)} style={styles.instructionCard}>
          ...
          <Text style={styles.instructionText}>
            Take a photo of your notebook page with the word HAT, rectangle, and hat drawing.
          </Text>
        </Animated.View>
