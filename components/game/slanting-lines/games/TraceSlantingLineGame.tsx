...
interface TraceSlantingLineGameProps {
  onComplete: (stats: { correct: number; total: number; accuracy: number; gameId: string }) => void;
  onBack: () => void;
}

export default function TraceSlantingLineGame({ onComplete, onBack }: TraceSlantingLineGameProps) {
  ...
  useEffect(() => {
    ...
    setAccuracy(0);
    speakFeedback('Trace the slanting line.');
    return () => stopAllAudio();
  }, [round]);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Trace Slanting Line</Text>
