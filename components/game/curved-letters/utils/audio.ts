// Audio utilities for Capital Letters — Curved Letters module
...
export async function playSoundEffect(type: 'correct' | 'incorrect' | 'celebration' | 'click' | 'tracing'): Promise<void> {
  try {
    ...
    console.warn('[Curved Letters Audio] Error playing sound:', error);
  }
}
...
export async function speakLetter(letter: string): Promise<void> {
  try {
    ...
    console.warn('[Curved Letters Audio] Error speaking letter:', error);
  }
}
...
export async function speakInstruction(instruction: string): Promise<void> {
  try {
    ...
    console.warn('[Curved Letters Audio] Error speaking instruction:', error);
  }
}
...
export async function speakFeedback(message: string): Promise<void> {
  try {
    ...
    console.warn('[Curved Letters Audio] Error speaking feedback:', error);
  }
}
...
export async function stopAllAudio(): Promise<void> {
  try {
    ...
    console.warn('[Curved Letters Audio] Error stopping audio:', error);
  }
}
