...
const LINE_TOLERANCE = RIVER_WIDTH / 2;
...
const RiverBoatGuideGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    points.push({ x: 40, y: 60 });
    points.push({ x: 50, y: 50 });
    points.push({ x: 60, y: 40 });
    points.push({ x: 70, y: 30 });
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.resultCard}>
            ...
            <Text style={styles.resultTitle}>River Navigated!</Text>
            <Text style={styles.resultSubtitle}>
              You guided {finalStats.correct} boats out of {finalStats.total}!
            </Text>
            <ResultCard
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBlock}>
        <Text style={styles.title}>River Boat Guide</Text>
        <Text style={styles.subtitle}>
          Round {round}/{TOTAL_ROUNDS} • 🛶 Score: {score}
        </Text>
        <Text style={styles.helper}>
          Keep the boat in the river! Follow the curvy path carefully.
        </Text>
      </View>
          ...
          <Animated.View style={styles.gestureArea}>
            ...
            {isOffTrack && (
              <View style={styles.warningBox}>
                <Text style={styles.warningText}>Stay in the river! ⚠️</Text>
              </View>
            )}
          </Animated.View>
        </GestureDetector>
      ...
      <View style={styles.footerBox}>
        ...
        <Text style={styles.footerSub}>
          Keep the boat in the river and follow the path!
        </Text>
      </View>
    </SafeAreaView>
  );
