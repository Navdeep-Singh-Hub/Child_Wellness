// Individual Game Completion Screen for The Grouper
import { playSoundEffect, stopAllAudio } from '@/components/game/grouper/utils/audio';
import { GAMES } from '@/components/game/grouper/utils/gameData';
...
export default function GrouperGameCompleteScreen({
  correct,
  total,
  accuracy,
  gameId,
  ...
  const getPerformanceMessage = () => {
    if (accuracy >= 90) {
      return 'Great Rhyming Skills!';
    } else if (accuracy >= 70) {
      return "You're becoming a Word Grouper!";
    } else {
