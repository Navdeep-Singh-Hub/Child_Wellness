...
const RobotWireFixGame: React.FC<{ onBack?: () => void }> = ({ onBack }) => {
  ...
  const [wirePathStr, setWirePathStr] = useState('');
    ...
    async (finalScore: number) => {
      ...
      try {
        ...
        const result = await logGameAndAward({
          ...
          accuracy,
          xpAwarded: xp,
          skillTags: ['direction-change', 'motor-planning', 'zig-zag-wire-tracing'],
        });
      ...
      Speech.speak('Wire fixed! Great job!', { rate: 0.78 });
    },
    [router],
  );
    ...
    .onEnd(() => {
      ...
      if (distToEnd <= LINE_TOLERANCE && progress.value >= 0.75) {
        ...
        try {
          ...
          Speech.speak('Follow the wire!', { rate: 0.78 });
        } catch {}
      }
    });
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.resultCard}>
            ...
            <Text style={styles.resultTitle}>Wire Fixed!</Text>
            <Text style={styles.resultSubtitle}>
              You fixed {finalStats.correct} wires out of {finalStats.total}!
            </Text>
            <ResultCard
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerBlock}>
        ...
        <Text style={styles.helper}>
          Follow the zig-zag wire to fix the robot! Trace the path carefully.
        </Text>
      </View>
          ...
          <Animated.View style={styles.gestureArea}>
            ...
            {isOffTrack && (
              <View style={styles.warningBox}>
                <Text style={styles.warningText}>Stay on the wire! ⚠️</Text>
              </View>
            )}
          </Animated.View>
        </GestureDetector>
      ...
      <View style={styles.footerBox}>
        <Text style={styles.footerMain}>
          Skills: direction change • motor planning • zig-zag wire tracing
        </Text>
        <Text style={styles.footerSub}>
          Fix the robot by following the zig-zag wire path!
        </Text>
      </View>
    </SafeAreaView>
  );
