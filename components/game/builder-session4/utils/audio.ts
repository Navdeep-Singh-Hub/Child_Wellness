// Audio utilities for The Builder Session 4 module
...
export async function playSoundEffect(type: 'correct' | 'incorrect' | 'celebration' | 'click' | 'letter'): Promise<void> {
  try {
    ...
    console.warn('[Builder Session4 Audio] Error playing sound:', error);
  }
}
...
export async function speakLetter(letter: string): Promise<void> {
  try {
    ...
    console.warn('[Builder Session4 Audio] Error speaking letter:', error);
  }
}
...
export async function speakWord(word: string): Promise<void> {
  try {
    ...
    console.warn('[Builder Session4 Audio] Error speaking word:', error);
  }
}
...
export async function speakInstruction(instruction: string): Promise<void> {
  try {
    ...
    console.warn('[Builder Session4 Audio] Error speaking instruction:', error);
  }
}
...
export async function speakFeedback(message: string): Promise<void> {
  try {
    ...
    console.warn('[Builder Session4 Audio] Error speaking feedback:', error);
  }
}
...
export async function stopAllAudio(): Promise<void> {
  try {
    ...
    console.warn('[Builder Session4 Audio] Error stopping audio:', error);
  }
}
