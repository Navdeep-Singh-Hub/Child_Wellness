/**
 * Word Family Finder — -AN words (Game 1 for Grouper Session 6). AAC-friendly.
 */
...
const CORRECT = [
  { id: 'fan', label: 'fan', image: 'https://placehold.co/140x140/E0E7FF/4338CA?text=fan' },
  { id: 'man', label: 'man', image: 'https://placehold.co/140x140/DBEAFE/1E40AF?text=man' },
  { id: 'pan', label: 'pan', image: 'https://placehold.co/140x140/FED7AA/9A3412?text=pan' },
  { id: 'can', label: 'can', image: 'https://placehold.co/140x140/E5E7EB/374151?text=can' },
];
const WRONG = [
...
export function WordFamilyFinderAN({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    speak('Tap the words that belong to the -AN family.', 0.75);
  }, []);
  ...
  return (
    <GameLayout
      title="Find the -AN words"
      instruction="Tap the words that belong to the -AN family."
    >
