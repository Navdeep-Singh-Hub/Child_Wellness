/**
 * Clap the Word — One syllable (sun, run, bun). Game 3 for Grouper Session 3.
 */
...
const WORDS = [{ word: 'sun' }, { word: 'run' }, { word: 'bun' }];

export function ClapWordUN({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <GameLayout
      ...
      instruction="Tap the clap button once for each sound."
    >
