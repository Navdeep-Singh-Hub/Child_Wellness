/**
 * Rhyme Match — Find the rhyme (sun → bun). Game 2 for Grouper Session 3.
 */
...
const PROMPT_WORD = 'sun';
const CHOICES = [
  { id: 'bun', label: 'bun', correct: true, image: 'https://placehold.co/120x120/FED7AA/9A3412?text=bun' },
...
export function RhymeMatchUN({ onComplete }: { onComplete: () => void }) {
