/**
 * Shared shell for Session 2 boundary games.
 */
...
export type BoundaryShellTheme = {
  bg: string;
  labelColor: string;
  titleColor: string;
  textOnDark: string;
...
interface BoundaryGameShellProps {
  theme: BoundaryShellTheme;
  gameLabel: string;
  gameTitle: string;
  currentStep: number;
  totalSteps: number;
...
export function BoundaryGameShell({
  theme,
  gameLabel,
  gameTitle,
  currentStep,
