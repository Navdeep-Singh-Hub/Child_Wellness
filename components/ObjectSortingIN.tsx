/**
 * Sort the Objects — Containers (bin, tin) vs Animals (dog, cat). Game 4 for Grouper Session 2.
 */
...
const ITEMS: { id: string; label: string; category: Category; image: string }[] = [
  { id: 'bin', label: 'bin', category: 'containers', image: 'https://placehold.co/100x100/D1FAE5/065F46?text=bin' },
  { id: 'tin', label: 'tin', category: 'containers', image: 'https://placehold.co/100x100/E5E7EB/374151?text=tin' },
...
export function ObjectSortingIN({ onComplete }: { onComplete: () => void }) {
  ...
  const [currentItem, setCurrentItem] = useState<string | null>('bin');
