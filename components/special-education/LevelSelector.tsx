...
const MATCHER_CLONE_SESSION_LABELS: Record<number, string> = {
  1: 'Small Letters: i, l',
  2: 'Small Letters: t, i',
  3: 'Curves: c, o',
  4: 'Curves: a',
...
function getMatcherCloneSessionLabel(sessionNum: number): string {
  return MATCHER_CLONE_SESSION_LABELS[sessionNum] ?? `Session ${sessionNum}`;
}
