/**
 * Level 4 Grouper — Session 1: The -AT Word Family
 * Hub → 4 games + scribe scroll task → completion
 */
import { ConfettiEffect } from '@/components/games/Level1/ConfettiEffect';
import { SuccessCelebration } from '@/components/ui/SuccessCelebration';
import { markSessionGameComplete } from '@/components/special-education/shared/useSessionIntroProgress';
import { WordFamilyFinderGame } from '@/components/grouper-session/session1/WordFamilyFinderGame';
import { RhymeMatchGame } from '@/components/grouper-session/session1/RhymeMatchGame';
import { ClapWordGame } from '@/components/grouper-session/session1/ClapWordGame';
import { ObjectSortingGame } from '@/components/grouper-session/session1/ObjectSortingGame';
import { ATWordNotebookUpload } from '@/components/grouper-session/session1/ATWordNotebookUpload';
import {
  GROUPER_HUB_THEME as H,
  GROUPER_S1_QUESTS,
  GROUPER_SESSION,
} from '@/components/grouper-session/grouperSessionTheme';
import { DesertOasisBackground } from '@/components/grouper-session/DesertOasisBackground';
...
const PLAY_STEPS = 5;
const SESSION_TITLE = 'Session 1 · The -AT Family';
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              <Text style={styles.hubEyebrow}>Grouper · Session 1 · Dune Den</Text>
              <Text style={styles.hubTitle}>{H.name}</Text>
              <Text style={styles.hubSession}>The -AT Word Family</Text>

              <View style={styles.exampleChip}>
                <Text style={styles.exampleText}>cat · bat · hat · rat</Text>
              </View>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Words that rhyme at the end belong to the same family — scout AT words, match rhymes, clap, sort, then write your scroll!
                  </Text>
                </View>
              </View>
            </View>

            {GROUPER_S1_QUESTS.map((quest) => {
