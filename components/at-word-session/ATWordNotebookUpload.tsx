/**
 * AT Word Notebook — Write and draw 3 -AT words (cat, hat, bat). Photo upload + AI check.
 * AAC-friendly: large Upload / Take Photo buttons.
 */
...
const INSTRUCTIONS = 'Write and draw 3 -AT words. Examples: cat, hat, bat.';
...
export function ATWordNotebookUpload({
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      setResult({
        correct,
        feedback,
        at_words_present: data.at_words_present,
  ...
  return (
    <GameLayout
      ...
      instruction="Write and draw 3 -AT words. Then upload or take a photo."
    >
      <View style={styles.content}>
        <Text style={styles.instructions}>{INSTRUCTIONS}</Text>
        <View style={styles.exampleRow}>
          <Text style={styles.exampleLabel}>Examples: </Text>
          <Text style={styles.exampleWords}>cat · hat · bat</Text>
        </View>
