 ...
 * Counter (Section 5) — Session 10 (Final): Counter Master

 * Hub → 4 games + tower snapshot task → completion / master celebration
...
import { MixedQuizGame } from './session10/MixedQuizGame';

import { AdvancedMemoryGame } from './session10/AdvancedMemoryGame';

import { WordBuilderHouseGame } from './session10/WordBuilderHouseGame';

import { LogicalPatternGame } from './session10/LogicalPatternGame';

import { TowerSnapshotUpload } from './session10/TowerSnapshotUpload';

import {

  COUNTER_S10_HUB_THEME as H,
...
export function CounterSession10({ onExit }: CounterSession10Props = {}) {
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.hubHeader}>
              ...
              <Text style={styles.hubEyebrow}>Counter · {config.zone} · Final</Text>
              ...
              <View style={styles.exampleChip}>
                ...
                <Text style={styles.exampleText}>quiz · memory · words · patterns · tower</Text>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    ...
                    Final challenge! Quiz shapes and colors, match 12 cards, spell HOUSE, complete the pattern, then build a 3-object tower!
  ...
  if (step === 6) {
    ...
    const isMaster = taskCorrect === true;
    ...
    return (
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          title={isMaster ? 'Counter Master!' : 'Great job!'}

          subtitle={

            isMaster

              ? 'You completed all Counter sessions!\nNext level unlocked!'

              : `${sessionTitle}\nCompleted ${doneCount}/${PLAY_STEPS} quests${

                  taskCorrect === false ? '\nTower Snapshot: try again next time!' : ''
