/**
 * Counter Session 7 — Game 3: Letter Link — match A with a
 */
...
import { LETTER_LINK_THEME as T, COUNTER_SESSION } from '../counterSessionTheme';
...
export function LetterMatchGame({
  ...
  useEffect(() => {
    speakCounterHint('Match uppercase A with the lowercase letter. Tap the small a.');
  ...
  const triggerWrong = useCallback(() => {
    ...
    speakCounterHint('Try again. Big A matches small a.');
    try {
  ...
  const handleTap = useCallback(
    (id: string) => {
      if (id === CORRECT_ID) {
        speakCounterHint('Correct! Big A and small a match!');
        try {
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration title="Letters Linked!" subtitle="A and a match!" badgeEmoji="🔤" variant="ocean" />
      </View>
    );
  }
        ...
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakCounterHint('Find the lowercase letter that matches A.')}>
                <Text style={styles.prompt}>Match the letter 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  upperBox: {
    ...
    height: 84,
    borderRadius: 16,
    backgroundColor: T.upperBox,
    borderWidth: 4,
    borderColor: T.upperBorder,
    alignItems: 'center',
  ...
  upperLetter: { fontSize: 48, fontWeight: '800', color: T.ink },
  tapLabel: { fontSize: 15, fontWeight: '700', color: T.inkMuted, marginBottom: 16 },
  optionsRow: { flexDirection: 'row', gap: 18 },
  optionBtn: {
    width: 64,
    height: 64,
    borderRadius: 16,
  ...
  optionLetter: { fontSize: 36, fontWeight: '800', color: T.ink },
});
