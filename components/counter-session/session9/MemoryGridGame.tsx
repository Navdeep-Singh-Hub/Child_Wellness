/**
 * Counter Session 9 — Game 2: Tile Match — 10 tiles, 5 pairs
 */
...
import { TILE_MATCH_THEME as T, COUNTER_SESSION } from '../counterSessionTheme';
...
export function MemoryGridGame({
  ...
  useEffect(() => {
    speakCounterHint('Match five pairs. Flip two tiles at a time to find matching pictures.');
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration title="All Matched!" subtitle="You matched all five pairs!" badgeEmoji="🎴" variant="ocean" />
      </View>
    );
  }
        ...
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakCounterHint('Flip two tiles to find matching pairs.')}>
                <Text style={styles.prompt}>Match all 5 pairs 🔊</Text>
              </Pressable>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, justifyContent: 'center', maxWidth: 300, marginTop: 16 },
  card: {
    width: 56,
    height: 56,
    borderRadius: 12,
