/**
 * Counter (Section 5) — Session 8: Emotions, Match & Shapes
 * Hub → 4 games + green hunt task → completion
 */
import { ConfettiEffect } from '@/components/games/Level1/ConfettiEffect';
import { SuccessCelebration } from '@/components/ui/SuccessCelebration';
import { markSessionGameComplete } from '@/components/special-education/shared/useSessionIntroProgress';
import { EmotionRecognitionGame } from './session8/EmotionRecognitionGame';
import { CategoryMatchGame } from './session8/CategoryMatchGame';
import { WordBuilderDogGame } from './session8/WordBuilderDogGame';
import { ShapePuzzleGame } from './session8/ShapePuzzleGame';
import { GreenSnapshotUpload } from './session8/GreenSnapshotUpload';
import {
  COUNTER_S8_HUB_THEME as H,
  COUNTER_S8_QUESTS,
  COUNTER_SESSION,
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              ...
              <View style={styles.exampleChip}>
                <Text style={styles.exampleText}>feelings · habitats · words · shapes</Text>
              </View>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Tap the sad face, match animals to their homes, spell DOG, fit shapes into holes, then hunt for something green!
                  </Text>
                </View>
              </View>
            </View>

            {COUNTER_S8_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${sessionTitle}\nCompleted ${doneCount}/${PLAY_STEPS} quests${
            taskCorrect === false ? '\nGreen Hunt: try again next time!' : ''
          }`}
          badgeEmoji="⭐"
          variant="ocean"
        />
