/**
 * Counter Session 5 — Game 2: Vane Memory Deck (8 cards, 4 pairs)
 */
...
import { VANE_MEMORY_THEME as T, COUNTER_SESSION } from '../counterSessionTheme';
...
export function MemoryAdvancedGame({
  ...
  useEffect(() => {
    speakCounterHint('Match four pairs. Flip two cards at a time to find matching pictures.');
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration title="Memory Master!" subtitle="You matched all 4 pairs!" badgeEmoji="🎴" variant="ocean" />
      </View>
    );
  }
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakCounterHint('Flip two cards to find matching pairs.')}>
                <Text style={styles.prompt}>Match the deck 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  cardBack: { backgroundColor: T.cardBack, borderColor: T.cardBorder },
  cardFace: { backgroundColor: T.cardFace, borderColor: T.cardBorder },
  cardMatched: { borderColor: T.cardMatch, backgroundColor: '#DCFCE7' },
  cardEmoji: { fontSize: 34 },
  cardBackText: { fontSize: 28, fontWeight: '800', color: '#FFFFFF' },
});
