/**
 * Counter Session 3 — Game 3: Sky Memory Grid (8 cards, 4 pairs)
 */
...
import { SKY_MEMORY_THEME as T, COUNTER_SESSION } from '../counterSessionTheme';
...
export function Memory8CardsGame({
  onComplete,
  onBack,
  currentStep = 3,
  totalSteps = 5,
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        ...
        <SuccessCelebration
          title="Grid Cleared!"
          subtitle="You matched all four pairs!"
          badgeEmoji="🎴"
          variant="ocean"
        />
      </View>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakCounterHint('Flip two cards to find a match.')}>
                <Text style={styles.prompt}>Match four pairs 🔊</Text>
              </Pressable>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  cardBackText: { fontSize: 26, fontWeight: '900', color: '#fff' },
