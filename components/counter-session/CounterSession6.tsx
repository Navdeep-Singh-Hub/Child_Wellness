/**
 * Counter (Section 5) — Session 6: Spot, Count & Shapes
 * Hub → 4 games + four fingers task → completion
 */
import { ConfettiEffect } from '@/components/games/Level1/ConfettiEffect';
import { SuccessCelebration } from '@/components/ui/SuccessCelebration';
import { markSessionGameComplete } from '@/components/special-education/shared/useSessionIntroProgress';
import { SpotTheDifferenceGame } from './session6/SpotTheDifferenceGame';
import { CountingObjectsGame } from './session6/CountingObjectsGame';
import { DragPuzzleGame } from './session6/DragPuzzleGame';
import { ShapeIdentificationGame } from './session6/ShapeIdentificationGame';
import { FourFingersSnapshotUpload } from './session6/FourFingersSnapshotUpload';
import {
  COUNTER_S6_HUB_THEME as H,
  COUNTER_S6_QUESTS,
  COUNTER_SESSION,
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              ...
              <View style={styles.exampleChip}>
                <Text style={styles.exampleText}>spot · count · puzzle · shapes</Text>
              </View>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Spot 3 differences, count 9 apples, build the dog puzzle, find the rectangle, then signal four fingers!
                  </Text>
                </View>
              </View>
            </View>

            {COUNTER_S6_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${sessionTitle}\nCompleted ${doneCount}/${PLAY_STEPS} quests${
            taskCorrect === false ? '\nFour Fingers: try again next time!' : ''
          }`}
          badgeEmoji="⭐"
          variant="ocean"
        />
