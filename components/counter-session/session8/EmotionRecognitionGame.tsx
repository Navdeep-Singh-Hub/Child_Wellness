/**
 * Counter Session 8 — Game 1: Feeling Faces — tap the sad face
 */
...
import { FEELING_FACES_THEME as T, COUNTER_SESSION } from '../counterSessionTheme';
...
export function EmotionRecognitionGame({
  ...
  useEffect(() => {
    speakCounterHint('Tap the SAD face.');
  ...
  const triggerWrong = useCallback(() => {
    ...
    speakCounterHint('Try again. Tap the sad face.');
    try {
  ...
  const handleTap = useCallback(
    (id: string) => {
      if (id === CORRECT_ID) {
        speakCounterHint('Correct! You found the sad face!');
        try {
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration title="Sad Face Found!" subtitle="You found the sad face!" badgeEmoji="😢" variant="ocean" />
      </View>
    );
  }
        ...
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakCounterHint('Find and tap the sad face.')}>
...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', flexWrap: 'wrap', gap: 16, justifyContent: 'center', marginTop: 24 },
  faceBtn: {
    minWidth: 90,
    paddingVertical: 20,
    paddingHorizontal: 16,
    borderRadius: 20,
    backgroundColor: T.faceBtn,
    borderWidth: 4,
    borderColor: T.faceBorder,
    alignItems: 'center',
    ...COUNTER_SESSION.shadow.soft,
  },
  emoji: { fontSize: 48, marginBottom: 8 },
  label: { fontSize: 16, fontWeight: '700', color: T.ink },
});
