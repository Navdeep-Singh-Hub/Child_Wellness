/**
 * Counter (Section 5) — Session 7: Pattern, Match & Build
 * Hub → 4 games + far apart photo task → completion
 */
import { ConfettiEffect } from '@/components/games/Level1/ConfettiEffect';
import { SuccessCelebration } from '@/components/ui/SuccessCelebration';
import { markSessionGameComplete } from '@/components/special-education/shared/useSessionIntroProgress';
import { PatternMemoryGame } from './session7/PatternMemoryGame';
import { BiggerOrSmallerGame } from './session7/BiggerOrSmallerGame';
import { LetterMatchGame } from './session7/LetterMatchGame';
import { BuildCarGame } from './session7/BuildCarGame';
import { TwoFarApartSnapshotUpload } from './session7/TwoFarApartSnapshotUpload';
import {
  COUNTER_S7_HUB_THEME as H,
  COUNTER_S7_QUESTS,
  COUNTER_SESSION,
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              ...
              <View style={styles.exampleChip}>
                <Text style={styles.exampleText}>pattern · size · letters · build</Text>
              </View>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Echo the color pattern, find the smaller circle, link A with a, build the car, then place two objects far apart!
                  </Text>
                </View>
              </View>
            </View>

            {COUNTER_S7_QUESTS.map((quest) => {
