/**
 * Counter Session 6 — Game 4: Rectangle Ridge — tap the rectangle
 */
...
import { RECTANGLE_RIDGE_THEME as T, COUNTER_SESSION } from '../counterSessionTheme';
...
export function ShapeIdentificationGame({
  ...
  useEffect(() => {
    speakCounterHint('Tap the rectangle. Find the shape that is a rectangle.');
  ...
  const triggerWrong = useCallback(() => {
    ...
    speakCounterHint('Try again. A rectangle is longer than it is wide.');
    try {
  ...
  const handleTap = useCallback(
    (id: string) => {
      if (id === CORRECT_ID) {
        speakCounterHint('Correct! That is the rectangle!');
        try {
  ...
  if (celebrating) {
    return (
      <View style={styles.root}>
        <ConfettiEffect />
        <SuccessCelebration title="Rectangle Found!" subtitle="You found the rectangle!" badgeEmoji="▭" variant="ocean" />
      </View>
    );
  }
        ...
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            ...
            <View style={styles.bubbleBody}>
              ...
              <Pressable onPress={() => speakCounterHint('Find and tap the rectangle.')}>
...
const styles = StyleSheet.create({
  ...
  shapesRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 14, justifyContent: 'center', marginTop: 20 },
  shapeBtn: {
    minWidth: 90,
    paddingVertical: 20,
