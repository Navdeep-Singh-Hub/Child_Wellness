/**
 * Counter (Section 5) — Session 5: Directions & Round
 * Hub → 4 games + round hunt task → completion
 */
import { ConfettiEffect } from '@/components/games/Level1/ConfettiEffect';
import { SuccessCelebration } from '@/components/ui/SuccessCelebration';
import { markSessionGameComplete } from '@/components/special-education/shared/useSessionIntroProgress';
import { DirectionGame } from './session5/DirectionGame';
import { MemoryAdvancedGame } from './session5/MemoryAdvancedGame';
import { WordBuilderSunGame } from './session5/WordBuilderSunGame';
import { ObjectClassificationGame } from './session5/ObjectClassificationGame';
import { RoundSnapshotUpload } from './session5/RoundSnapshotUpload';
import {
  COUNTER_S5_HUB_THEME as H,
  COUNTER_S5_QUESTS,
  COUNTER_SESSION,
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              ...
              <View style={styles.exampleChip}>
                <Text style={styles.exampleText}>directions · memory · words · round</Text>
              </View>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Cross to the star with arrows, match the memory deck, spell SUN, sort kitchen and bedroom items, then hunt for something round!
                  </Text>
                </View>
              </View>
            </View>

            {COUNTER_S5_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${sessionTitle}\nCompleted ${doneCount}/${PLAY_STEPS} quests${
            taskCorrect === false ? '\nRound Hunt: try again next time!' : ''
          }`}
          badgeEmoji="⭐"
          variant="ocean"
        />
