/**
 * Counter (Section 5) — Session 3: Shapes & Sounds
 * Hub → 4 games + triangle hunt task → completion
 */
import { ConfettiEffect } from '@/components/games/Level1/ConfettiEffect';
import { SuccessCelebration } from '@/components/ui/SuccessCelebration';
import { markSessionGameComplete } from '@/components/special-education/shared/useSessionIntroProgress';
import { ShapeRotationGame } from './session3/ShapeRotationGame';
import { SoundRecognitionGame } from './session3/SoundRecognitionGame';
import { Memory8CardsGame } from './session3/Memory8CardsGame';
import { DragPartsHouseGame } from './session3/DragPartsHouseGame';
import { TriangleSnapshotUpload } from './session3/TriangleSnapshotUpload';
import {
  COUNTER_S3_HUB_THEME as H,
  COUNTER_S3_QUESTS,
  COUNTER_SESSION,
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              ...
              <View style={styles.exampleChip}>
                <Text style={styles.exampleText}>shapes · sounds · memory · build</Text>
              </View>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Spin triangles, match animal sounds, clear the memory grid, build a cloud house, then hunt for a real triangle!
                  </Text>
                </View>
              </View>
            </View>

            {COUNTER_S3_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${sessionTitle}\nCompleted ${doneCount}/${PLAY_STEPS} quests${
            taskCorrect === false ? '\nTriangle Hunt: try again next time!' : ''
          }`}
          badgeEmoji="⭐"
          variant="ocean"
        />
