 ...
 * Counter (Section 5) — Session 9: Logic, Memory & Shapes

 * Hub → 4 games + triangle snapshot task → completion
...
import { NumberLogicGame } from './session9/NumberLogicGame';

import { MemoryGridGame } from './session9/MemoryGridGame';

import { SizeSortGame } from './session9/SizeSortGame';

import { IdentifyShapeGame } from './session9/IdentifyShapeGame';

import { TriangleSnapshotUpload } from './session9/TriangleSnapshotUpload';

import {

  COUNTER_S9_HUB_THEME as H,
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.hubHeader}>
              ...
              <View style={styles.exampleChip}>
                ...
                <Text style={styles.exampleText}>numbers · memory · sorting · shapes</Text>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    ...
                    Find the next number, match tile pairs, sort by size, tap the pentagon, then arrange three objects in a triangle!
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${sessionTitle}\nCompleted ${doneCount}/${PLAY_STEPS} quests${
            ...
            taskCorrect === false ? '\nTriangle Snapshot: try again next time!' : ''
