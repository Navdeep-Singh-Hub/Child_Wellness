/**
 * Clap Challenge — elephant (3), butterfly (3), tiger (2). Game 3 for Grouper Session 10.
 */
...
export function ClapChallengeMaster({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) {
    return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="Syllables mastered!" />;
  }
...
const styles = StyleSheet.create({
  ...
  pressed: { opacity: 0.9 },
  speaker: { fontSize: 40 },
  wordText: { fontSize: 32, fontWeight: '800', color: '#3730A3' },
