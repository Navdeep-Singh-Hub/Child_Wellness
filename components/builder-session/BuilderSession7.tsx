 ...
 * Hub → 4 games + square scout task → completion
 */
...
const PLAY_STEPS = 5;
const SESSION_TITLE = 'Session 7 · Size, Numbers & Patterns';
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              <Text style={styles.hubEyebrow}>Builder · Session 7 · Number Notch</Text>
              <Text style={styles.hubTitle}>{H.name}</Text>
              <Text style={styles.hubSession}>Size, Numbers & Patterns</Text>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Sort sizes, spot numbers, finish patterns, build a square — then scout a real square object!
                  </Text>
                </View>
              </View>
            </View>

            {BUILDER_S7_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${SESSION_TITLE}\nCompleted ${doneCount}/${PLAY_STEPS} builds${
            taskCorrect === false ? '\nSquare Scout: try again next time!' : ''
          }`}
          badgeEmoji="📏"
          variant="indigo"
        />
