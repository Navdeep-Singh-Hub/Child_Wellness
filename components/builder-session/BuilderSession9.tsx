/**
 * Level 3 Builder — Session 9: Spot the Difference & Shapes
 * Hub → 4 games + rectangle scout task → completion
 */
...
const PLAY_STEPS = 5;
const SESSION_TITLE = 'Session 9 · Spot the Difference & Shapes';
...
export function BuilderSession9({ onExit }: BuilderSession9Props = {}) {
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              <Text style={styles.hubEyebrow}>Builder · Session 9 · Detail Den</Text>
              <Text style={styles.hubTitle}>{H.name}</Text>
              <Text style={styles.hubSession}>Spot the Difference & Shapes</Text>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Spot details, count stars, build a house, find rectangles — then scout a real rectangle object!
                  </Text>
                </View>
              </View>
            </View>

            {BUILDER_S9_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${SESSION_TITLE}\nCompleted ${doneCount}/${PLAY_STEPS} builds${
            taskCorrect === false ? '\nRectangle Scout: try again next time!' : ''
          }`}
          badgeEmoji="🔍"
          variant="indigo"
        />
  ...
  if (step === 5) {
    return (
      <BuilderNotebookUploadRectangle
        sessionTitle={SESSION_TITLE}
        currentStep={5}
        totalSteps={PLAY_STEPS}
        onBack={() => setStep(0)}
