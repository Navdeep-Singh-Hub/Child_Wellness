/**
 * Builder Section — mountain workshop session picker (sessions 1–10).
 */
...
import { BUILDER_CURRICULUM } from './builderCurriculum';
import { BUILDER_HUB_THEME as H, BUILDER_SESSION } from './builderSessionTheme';
import { MountainWorkshopBackground } from './MountainWorkshopBackground';

const SECTION = 3;

export function BuilderSessionSelector({
  onBack,
  onSelectSession,
  onShowMap,
}: {
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.topBar}>
          ...
          <View style={styles.topCenter}>
            <Text style={styles.topTitle}>Builder</Text>
            <Text style={styles.topSub}>Mountain Workshop · 10 sessions</Text>
          </View>
        ...
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          <View style={styles.hero}>
            ...
            <Text style={styles.heroDesc}>
              Each session has 5 builds — games plus a real-world maker mission.
            </Text>
            <View style={styles.heroProgress}>
              ...
              <Text style={styles.progressLabel}>{completedCount}/10 sessions built</Text>
            </View>
          </View>

          {BUILDER_CURRICULUM.map((session) => {
...
const styles = StyleSheet.create({
  ...
  sessionSub: { fontSize: 13, fontWeight: '600', color: H.inkMuted },
});
