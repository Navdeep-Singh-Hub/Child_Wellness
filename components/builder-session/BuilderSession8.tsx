/**
 * Level 3 Builder — Session 8: Emotions, Colors & More
 * Hub → 4 games + smile scout task → completion
 */
...
const PLAY_STEPS = 5;
const SESSION_TITLE = 'Session 8 · Emotions, Colors & More';
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              <Text style={styles.hubEyebrow}>Builder · Session 8 · Feeling Forge</Text>
              <Text style={styles.hubTitle}>{H.name}</Text>
              <Text style={styles.hubSession}>Emotions, Colors & More</Text>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Read moods, sort colors, spell SUN, match habitats — then share a big smile for the camera!
                  </Text>
                </View>
              </View>
            </View>

            {BUILDER_S8_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${SESSION_TITLE}\nCompleted ${doneCount}/${PLAY_STEPS} builds${
            taskCorrect === false ? '\nSmile Scout: try again next time!' : ''
          }`}
          badgeEmoji="😊"
          variant="indigo"
        />
