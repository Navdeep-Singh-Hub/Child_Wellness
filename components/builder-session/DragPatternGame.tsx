/**
 * Builder Session 10 — Game 4: Geometric Pattern Row
 * Complete the pattern: circle, square, circle → square
 */
...
import { BUILDER_SESSION, GEOMETRIC_ROW_THEME as T } from './builderSessionTheme';
...
export function DragPatternGame({
  onComplete,
  onBack,
  currentStep = 4,
  totalSteps = 5,
  sessionTitle,
}: DragPatternGameProps) {
    ...
    return (
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle="You finished the geometric row!"
          badgeEmoji="🔁"
          variant="indigo"
        />
      </View>
