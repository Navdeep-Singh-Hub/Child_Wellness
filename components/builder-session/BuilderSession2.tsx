 ...
 * Hub → 4 games + circle sketch task → completion
...
const SESSION_TITLE = 'Session 2 · Word Builder & More';
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.hubHeader}>
              ...
              <Text style={styles.hubEyebrow}>Builder · Session 2</Text>

              <Text style={styles.hubTitle}>{H.name}</Text>

              <Text style={styles.hubSession}>Word Builder & More</Text>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    ...
                    Spell, match, sort, puzzle — then finish with a real-world circle sketch!
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${SESSION_TITLE}\nCompleted ${doneCount}/${PLAY_STEPS} builds${
            ...
            taskCorrect === false ? '\nCircle sketch: try again next time!' : ''
