 ...
 * Hub → 4 games + azure scout task → completion
 */
...
const PLAY_STEPS = 5;
const SESSION_TITLE = 'Session 4 · Colors & Patterns';
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              <Text style={styles.hubEyebrow}>Builder · Session 4</Text>
              <Text style={styles.hubTitle}>{H.name}</Text>
              <Text style={styles.hubSession}>Colors & Patterns</Text>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Colors, sockets, rhythms, and animals — finish with an azure scout photo mission!
                  </Text>
                </View>
              </View>
            </View>

            {BUILDER_S4_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${SESSION_TITLE}\nCompleted ${doneCount}/${PLAY_STEPS} builds${
            taskCorrect === false ? '\nAzure scout: try again next time!' : ''
          }`}
          badgeEmoji="🌈"
          variant="indigo"
        />
