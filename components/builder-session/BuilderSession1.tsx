 ...
 * Hub → 4 games + real-world task → completion
 */
...
const PLAY_STEPS = 5;
const SESSION_TITLE = 'Session 1 · Object & Shape Fun';
        ...
        <SafeAreaView style={styles.hubSafe}>
          ...
          <ScrollView contentContainerStyle={styles.hubScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.hubHeader}>
              <Text style={styles.hubEyebrow}>Builder · Session 1</Text>
              <Text style={styles.hubTitle}>{H.name}</Text>
              <Text style={styles.hubSession}>Object & Shape Fun</Text>
              ...
              <View style={styles.speechBubble}>
                ...
                <View style={styles.bubbleBody}>
                  ...
                  <Text style={styles.hubPrompt}>
                    Pick a build below — finish all five, including the real-world scout mission!
                  </Text>
                </View>
              </View>
            </View>

            {BUILDER_S1_QUESTS.map((quest) => {
      ...
      <View style={styles.root}>
        ...
        <SuccessCelebration
          ...
          subtitle={`${SESSION_TITLE}\nCompleted ${doneCount}/${PLAY_STEPS} builds${
            taskCorrect === false ? '\nScout mission: try again next time!' : ''
          }`}
          badgeEmoji="🔨"
          variant="indigo"
        />
