/**
 * JungleRhymeGame — Game 2: I Spy Jungle Rhymes
 * Rounds: tree→bee, monkey→donkey, log→frog, snake→cake.
 */
...
const ROUNDS: Round[] = [
  {
    ...
    correctId: 'bee',
    items: [
      { id: 'bee', label: 'Bee', image: 'https://placehold.co/120x120/FEF08A/854D0E?text=Bee' },
      { id: 'lion', label: 'Lion', image: 'https://placehold.co/120x120/FDE68A/92400E?text=Lion' },
      { id: 'rock', label: 'Rock', image: 'https://placehold.co/120x120/E5E7EB/374151?text=Rock' },
      { id: 'leaf', label: 'Leaf', image: 'https://placehold.co/120x120/86EFAC/166534?text=Leaf' },
    ],
  },
  {
    promptWord: 'monkey',
    correctId: 'donkey',
    items: [
      { id: 'donkey', label: 'Donkey', image: 'https://placehold.co/120x120/A78BFA/5B21B6?text=Donkey' },
      { id: 'tiger', label: 'Tiger', image: 'https://placehold.co/120x120/FED7AA/9A3412?text=Tiger' },
      { id: 'leaf', label: 'Leaf', image: 'https://placehold.co/120x120/86EFAC/166534?text=Leaf' },
  ...
  },
  {
    ...
    correctId: 'frog',
    items: [
      { id: 'frog', label: 'Frog', image: 'https://placehold.co/120x120/86EFAC/166534?text=Frog' },
      { id: 'lion', label: 'Lion', image: 'https://placehold.co/120x120/FDE68A/92400E?text=Lion' },
      { id: 'bee', label: 'Bee', image: 'https://placehold.co/120x120/FEF08A/854D0E?text=Bee' },
      { id: 'log', label: 'Log', image: 'https://placehold.co/120x120/A78BFA/5B21B6?text=Log' },
    ],
  },
  {
    promptWord: 'snake',
    ...
    items: [
      ...
      { id: 'tree', label: 'Tree', image: 'https://placehold.co/120x120/86EFAC/166534?text=Tree' },
      { id: 'monkey', label: 'Monkey', image: 'https://placehold.co/120x120/FDE68A/92400E?text=Monkey' },
      { id: 'leaf', label: 'Leaf', image: 'https://placehold.co/120x120/BBF7D0/166534?text=Leaf' },
    ],
  },
].map((r) => ({ ...r, items: r.items.sort(() => Math.random() - 0.5) }));

export function JungleRhymeGame({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="mint" title="Great Job!" subtitle="Jungle rhymes complete!" />;

  return (
    <GameLayout title="I Spy Jungle Rhymes" instruction={instruction}>
...
const styles = StyleSheet.create({
  ...
  roundText: { fontSize: 16, fontWeight: '700', color: '#22C55E' },
