/**
 * Grouper Master Notebook — Write one word from four families (-at, -in, -un, -op). Grouper Session 10.
 * AI: at_word_present, in_word_present, un_word_present, op_word_present.
 */
...
const INSTRUCTIONS = 'Write one word from four families: -at, -in, -un, -op. Example: cat, pin, sun, top.';
...
export function GrouperMasterNotebookUpload({
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const opPresent = data.op_word_present ?? true;
      ...
      setResult({
        ...
        op_word_present: data.op_word_present,
      });
      if (correct) {
        speak('Great job!');
  ...
  return (
    <GameLayout
      ...
      instruction="Write one word from each family: -at, -in, -un, -op. Then upload or take a photo."
    >
      <View style={styles.content}>
        <Text style={styles.instructions}>{INSTRUCTIONS}</Text>
        <View style={styles.exampleRow}>
          <Text style={styles.exampleWords}>cat · pin · sun · top</Text>
        </View>
