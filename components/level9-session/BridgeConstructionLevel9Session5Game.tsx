/**
 * Level 9 (Clockwise) — Session 5, Game 4: Span Forge
...
const FORGE = { accent: '#EC4899', glow: '#FDA4AF', cyan: '#F472B6', deck: '#FBBF24' } as const;
...
export interface BridgeConstructionLevel9Session5GameProps {
  onComplete: () => void;
}

export function BridgeConstructionLevel9Session5Game({ onComplete }: BridgeConstructionLevel9Session5GameProps) {
...
const styles = StyleSheet.create({
  ...
  gapLine: { fontSize: 11, fontWeight: '700', color: CW.textMuted, letterSpacing: 1 },
