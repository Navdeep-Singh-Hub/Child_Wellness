...
export function MemoryGrid14Level9Session3Game({ onComplete }: MemoryGrid14Level9Session3GameProps) {
  ...
  const coachLine =
    pairsFound === 0
      ? 'Flip two cards. Remember where each picture hides in the constellation grid!'
  ...
  return (
    ...
    >
      ...
      <View style={styles.gridFrame}>
        ...
        />
        <Text style={styles.gridLabel}>CONSTELLATION GRID · 14 CARDS</Text>
...
const styles = StyleSheet.create({
  ...
  backGlyph: { fontSize: 20, color: PALETTE.glow, opacity: 0.9 },
  backNum: {
    position: 'absolute',
    bottom: 2,
    right: 4,
