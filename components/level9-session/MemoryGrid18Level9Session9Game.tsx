/**
 * Level 9 (Clockwise) — Session 9, Game 2: Deep Matrix
...
const VOICE = 'Match 9 pairs. Flip two cards at a time. 18 cards.';
...
export function MemoryGrid18Level9Session9Game({ onComplete }: MemoryGrid18Level9Session9GameProps) {
  ...
  return (
    <ClockwiseGameShell
      ...
      instruction="Tap two cards to find matching pictures. 18 cards, 9 pairs."
      mascot="🎴"
      coachLine={coachLine}
    ...
    >
      ...
      <View style={styles.gridFrame}>
        ...
        />
        <Text style={styles.gridLabel}>DEEP MATRIX · 18 CARDS</Text>
      ...
      <View style={styles.legend}>
        <Text style={styles.legendTxt}>
          {attempts === 0 ? 'Tap any two cards to begin' : `Scans: ${attempts} · Match all 9 pairs`}
        </Text>
      </View>
    </ClockwiseGameShell>
  );
...
const styles = StyleSheet.create({
  ...
  backGlyph: { fontSize: 16, color: PALETTE.glow, opacity: 0.9 },
  backNum: {
    position: 'absolute',
    bottom: 2,
    right: 4,
