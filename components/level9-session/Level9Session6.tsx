/**
 * Level 9 (Clockwise) — Session 6: Visual Puzzle, Category Recognition, Pattern Logic, Count 20
 * 4 games + 1 real-world task (three in triangle, one in center). Galaxy/indigo theme.
 */
...
export function Level9Session6({ onExit }: Level9Session6Props = {}) {
  ...
  if (step === 0) {
    const cards = [
      { icon: '🧩', title: 'Visual Puzzle', desc: 'Complete missing part of a complex image' },
      { icon: '🚗', title: 'Category Recognition', desc: 'Select all vehicles' },
      { icon: '🔺', title: 'Pattern Logic', desc: 'Circle, circle, triangle, square...' },
      { icon: '🔵', title: 'Counting Challenge', desc: 'Count 20 objects' },
    ];
    return (
      <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
        ...
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.mascotRow}>
            ...
            <Text style={styles.mascotHint}>Complete the visual puzzle, select all vehicles, finish the pattern, count 20 objects, then place three in a triangle and one in the center!</Text>
          </View>
          <View style={styles.introHeader}>
            <Text style={[styles.introTitle, { color: DESIGN.primary }]}>Level 9 · Session 6</Text>
            <Text style={styles.introSub}>Clockwise · Galaxy · Session 6</Text>
            <Text style={styles.introDesc}>
              Visual puzzle, category recognition, pattern logic, counting, then a real-world photo task!
            </Text>
          </View>
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
      <View style={[styles.header, { borderBottomColor: DESIGN.primary }]}>
        ...
        <View style={styles.titleRow}>
          ...
          <Text style={[styles.title, { color: DESIGN.primary }]}>Level 9 · Session 6</Text>
        </View>
        <Text style={styles.subtitle}>Clockwise · Galaxy · Session 6</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {step === 5 && <Level9NotebookUploadTriangleCenter onComplete={handleTaskComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
