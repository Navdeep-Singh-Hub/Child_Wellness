 ...
 * 4 games + 1 real-world task (round and rectangular together). Galaxy/indigo theme.
 */
...
export function Level9Session4({ onExit }: Level9Session4Props = {}) {
  ...
  if (step === 0) {
    const cards = [
      ...
      { icon: '✂️', title: 'Function Matching', desc: 'Match tools with their use' },
      ...
      <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
        ...
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.mascotRow}>
            ...
            <Text style={styles.mascotHint}>Count 18 stars, find the hexagon, match tools to their use, sort Kitchen/Garden/Bedroom, then show something round and rectangular!</Text>
          </View>
          <View style={styles.introHeader}>
            <Text style={[styles.introTitle, { color: DESIGN.primary }]}>Level 9 · Session 4</Text>
            <Text style={styles.introSub}>Clockwise · Galaxy · Session 4</Text>
            <Text style={styles.introDesc}>
              Counting challenge, shape recognition, function matching, sorting, then a real-world photo task!
            </Text>
          </View>
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
      <View style={[styles.header, { borderBottomColor: DESIGN.primary }]}>
        ...
        <View style={styles.titleRow}>
          ...
          <Text style={[styles.title, { color: DESIGN.primary }]}>Level 9 · Session 4</Text>
        </View>
        <Text style={styles.subtitle}>Clockwise · Galaxy · Session 4</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {step === 5 && <Level9NotebookUploadRoundRectangular onComplete={handleTaskComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
