 ...
 * 4 games + 1 real-world task (four objects in square layout). Galaxy/indigo theme.
 */
...
export function Level9Session3({ onExit }: Level9Session3Props = {}) {
  ...
  if (step === 0) {
    const cards = [
      { icon: '🧠', title: 'Logical Selection', desc: 'Which does not belong? car, bus, train, banana' },
      ...
      <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
        ...
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.mascotRow}>
            ...
            <Text style={styles.mascotHint}>Find what doesn't belong, match 14 cards, build ORANGE, and complete the pattern! Then arrange four objects in a square layout.</Text>
          </View>
          <View style={styles.introHeader}>
            <Text style={[styles.introTitle, { color: DESIGN.primary }]}>Level 9 · Session 3</Text>
            <Text style={styles.introSub}>Clockwise · Galaxy · Session 3</Text>
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
      <View style={[styles.header, { borderBottomColor: DESIGN.primary }]}>
        ...
        <View style={styles.titleRow}>
          ...
          <Text style={[styles.title, { color: DESIGN.primary }]}>Level 9 · Session 3</Text>
        </View>
        <Text style={styles.subtitle}>Clockwise · Galaxy · Session 3</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {step === 5 && <Level9NotebookUploadSquareLayout onComplete={handleTaskComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
