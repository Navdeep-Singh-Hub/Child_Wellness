 ...
 * Upload photo → AI verifies square arrangement. Return SUCCESS or TRY AGAIN.
 */
...
const INSTRUCTIONS =
  'Arrange FOUR objects in a square layout.\n\nTake a photo (or upload a picture) showing four objects placed in a square shape (e.g. one at each corner).';
...
export function Level9NotebookUploadSquareLayout({
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const feedback =
        data.feedback ||
        (correct ? 'SUCCESS! We see four objects in a square layout!' : 'TRY AGAIN.');
  ...
  return (
    ...
    >
      <View style={styles.content}>
        {!result ? (
          <>
            <Text style={styles.taskLabel}>Arrange FOUR objects in a square layout. Then:</Text>
            <Pressable
              onPress={pickImage}
              disabled={uploading}
