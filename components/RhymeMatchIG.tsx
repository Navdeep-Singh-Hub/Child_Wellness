/**
 * Rhyme Match — Find the rhyme (pig → wig). Game 2 for Grouper Session 8.
 */
...
const PROMPT_WORD = 'pig';
const CHOICES = [
  { id: 'wig', label: 'wig', correct: true, image: 'https://placehold.co/120x120/DDD6FE/5B21B6?text=wig' },
...
export function RhymeMatchIG({ onComplete }: { onComplete: () => void }) {
