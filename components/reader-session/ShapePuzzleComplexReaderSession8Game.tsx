/**
 * Level 7 Reader — Session 8, Game 3: Shape Forge
 * Fit shapes into the board. Circle, square, triangle → matching holes.
 */
  ...
  return (
    ...
    >
      ...
      <View style={styles.boardFrame}>
        ...
        <Text style={styles.boardHint}>⭕ round · ⬜ square · 🔺 triangle</Text>
      </View>
    </ReaderGameShell>
  );
}
...
const styles = StyleSheet.create({
  ...
  chipSymbol: { fontSize: 30, marginBottom: 2 },
  ...
  holeSymbol: { fontSize: 30 },
  holeHint: { fontSize: 9, fontWeight: '800', color: RD.textMuted, marginTop: 2 },
  boardHint: {
    marginTop: 12,
    fontSize: 12,
    fontWeight: '700',
