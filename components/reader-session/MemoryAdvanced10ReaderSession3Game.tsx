/**
 * Level 7 Reader — Session 3, Game 2: Memory Advanced
...
export function MemoryAdvanced10ReaderSession3Game({ onComplete }: MemoryAdvanced10ReaderSession3GameProps) {
  ...
  useEffect(() => {
    speak('Match 5 pairs. Flip two cards at a time to find matching pictures.', 0.75);
  }, []);
  ...
  return (
    <GameLayout
      ...
      instruction="Tap two cards to find matching pairs. 10 cards, 5 pairs."
      icon="🎴"
