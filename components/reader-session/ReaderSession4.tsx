/**
 * Level 7 Reader — Session 4: Counting 12, Shape Rotation (rectangle), Object Function, Indoor/Outdoor Sort
 * 4 games + 1 real-world task (round and square together). Indigo theme.
 */
...
export function ReaderSession4({ onExit }: ReaderSession4Props = {}) {
  ...
  if (step === 0) {
    const cards = [
      { icon: '⭐', title: 'Counting Challenge', desc: 'Count 12 stars' },
      { icon: '▭', title: 'Shape Rotation', desc: 'Find the rotated rectangle' },
      { icon: '✏️', title: 'Object Function', desc: 'Match object to its use' },
      { icon: '📂', title: 'Sorting Game', desc: 'Indoor / Outdoor' },
    ];
    return (
      <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
        ...
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.mascotRow}>
            ...
            <Text style={styles.mascotHint}>Count stars, find the rotated rectangle, match objects to their use, and sort Indoor vs Outdoor! Then show something round and square.</Text>
          </View>
          <View style={styles.introHeader}>
            <Text style={[styles.introTitle, { color: DESIGN.primary }]}>Reader Session 4</Text>
            <Text style={styles.introSub}>Level 7 · Reader · Session 4</Text>
            <Text style={styles.introDesc}>
              Counting, shape rotation, object function, indoor/outdoor sort, then a real-world photo task!
            </Text>
          </View>
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
      <View style={[styles.header, { borderBottomColor: DESIGN.primary }]}>
        ...
        <View style={styles.titleRow}>
          ...
          <Text style={[styles.title, { color: DESIGN.primary }]}>Reader Session 4</Text>
        </View>
        <Text style={styles.subtitle}>Level 7 · Reader · Session 4</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {step === 5 && <ReaderNotebookUploadRoundSquare onComplete={handleTaskComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
