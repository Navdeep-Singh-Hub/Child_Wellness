/**
 * Level 7 Reader — Session 5, Real World Task: Stack THREE objects vertically.
 * Upload photo → AI verifies vertical stacking. Return SUCCESS or TRY AGAIN.
 */
...
const INSTRUCTIONS =
  'Stack THREE objects vertically.\n\nTake a photo (or upload a picture) showing three objects stacked on top of each other.';
...
export function ReaderNotebookUploadStackThreeVertical({
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const feedback =
        data.feedback ||
        (correct ? 'SUCCESS! We see three objects stacked vertically!' : 'TRY AGAIN.');
  ...
  return (
    ...
    >
      <View style={styles.content}>
        {!result ? (
          <>
            <Text style={styles.taskLabel}>Stack THREE objects vertically. Then:</Text>
            <Pressable
              onPress={pickImage}
              disabled={uploading}
