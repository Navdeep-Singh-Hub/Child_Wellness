/**
 * Level 7 Reader — Session 10, Game 3: Word Builder
...
const TARGET = ['S', 'C', 'H', 'O', 'O', 'L'];
const LETTERS = ['O', 'L', 'S', 'C', 'H', 'O'];
...
export function WordBuilderSchoolReaderSession10Game({ onComplete }: WordBuilderSchoolReaderSession10GameProps) {
  ...
  useEffect(() => {
    speak('Build the word SCHOOL. Tap the letters in order: S, C, H, O, O, L.', 0.75);
  }, []);
  ...
  return (
    <GameLayout
      title="Word Builder"
      instruction="Tap the letters in order to spell SCHOOL."
      icon="🏫"
      backgroundVariant="indigo"
    >
      <View style={styles.container}>
        <Text style={styles.wordLabel}>Build: SCHOOL</Text>
