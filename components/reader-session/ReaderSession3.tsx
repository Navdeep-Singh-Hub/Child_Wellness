 ...
 * 4 games + 1 real-world task (four objects in square shape). Indigo theme.
 */
...
export function ReaderSession3({ onExit }: ReaderSession3Props = {}) {
  ...
  if (step === 0) {
    const cards = [
      { icon: '🧠', title: 'Logical Selection', desc: 'Find the one that does NOT belong' },
      { icon: '🎴', title: 'Memory Advanced', desc: 'Match 10 cards (5 pairs)' },
      { icon: '🍎', title: 'Word Builder', desc: 'Build APPLE' },
      { icon: '🧩', title: 'Pattern Builder', desc: 'Triangle, square, triangle, square, ?' },
    ];
    return (
      <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
        ...
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.mascotRow}>
            ...
            <Text style={styles.mascotHint}>Logic, memory, word building, and patterns! Then arrange four objects in a square.</Text>
          </View>
          <View style={styles.introHeader}>
            <Text style={[styles.introTitle, { color: DESIGN.primary }]}>Reader Session 3</Text>
            <Text style={styles.introSub}>Level 7 · Reader · Session 3</Text>
            <Text style={styles.introDesc}>
              Logical selection, memory 10 cards, build APPLE, complete the pattern, then a real-world photo task!
            </Text>
          </View>
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: DESIGN.background }]}>
      <View style={[styles.header, { borderBottomColor: DESIGN.primary }]}>
        ...
        <View style={styles.titleRow}>
          ...
          <Text style={[styles.title, { color: DESIGN.primary }]}>Reader Session 3</Text>
        </View>
        <Text style={styles.subtitle}>Level 7 · Reader · Session 3</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {step === 5 && <ReaderNotebookUploadSquareLayout onComplete={handleTaskComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
