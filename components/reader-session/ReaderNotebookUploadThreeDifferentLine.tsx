/**
 * Level 7 Reader — Session 1, Real World Task: Place THREE different objects in a straight line.
 * Upload photo → AI verifies: object count + straight alignment. Return SUCCESS or TRY AGAIN.
 */
...
const INSTRUCTIONS =
  'Place THREE different objects in a straight line.\n\nTake a photo (or upload a picture) showing three different objects lined up in a straight line.';
  ...
  return (
    ...
    >
      <View style={styles.content}>
        {!result ? (
          <>
            <Text style={styles.taskLabel}>Place THREE different objects in a straight line. Then:</Text>
            <Pressable
              onPress={pickImage}
              disabled={uploading}
