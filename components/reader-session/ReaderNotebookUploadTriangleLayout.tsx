/**
 * Level 7 Reader — Session 8, Real World Task: Arrange THREE objects forming a triangle.
...
const INSTRUCTIONS =
  'Arrange THREE objects forming a triangle.\n\nTake a photo (or upload a picture) showing three objects placed in a triangle shape (e.g. one at each corner).';
...
export function ReaderNotebookUploadTriangleLayout({
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      const feedback =
        data.feedback ||
        (correct ? 'SUCCESS! We see three objects forming a triangle!' : 'TRY AGAIN.');
  ...
  return (
    ...
    >
      <View style={styles.content}>
        {!result ? (
          <>
            <Text style={styles.taskLabel}>Arrange THREE objects forming a triangle. Then:</Text>
            <Pressable
              onPress={pickImage}
              disabled={uploading}
