/**
 * GroceryCleanUp — Game 1: Clean It Up (Initial Sound /m/)
 * Store: tap milk, mango, mouse (correct); bread, apple, banana (wrong).
 */
...
const CORRECT_ITEMS = [
  { id: 'milk', label: 'Milk', image: 'https://placehold.co/140x140/DBEAFE/1E40AF?text=Milk' },
  { id: 'mango', label: 'Mango', image: 'https://placehold.co/140x140/FEF08A/854D0E?text=Mango' },
  { id: 'mouse', label: 'Mouse', image: 'https://placehold.co/140x140/E5E7EB/374151?text=Mouse' },
];
const WRONG_ITEMS = [
  { id: 'bread', label: 'Bread', image: 'https://placehold.co/140x140/FDE68A/92400E?text=Bread' },
  { id: 'apple', label: 'Apple', image: 'https://placehold.co/140x140/FECACA/991B1B?text=Apple' },
...
const VOICE_INSTRUCTION = 'The store shelves are messy! Find objects that start with the m sound.';

export function GroceryCleanUp({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="sunset" title="Great Job!" subtitle="Grocery sounds complete!" />;

  return (
    <GameLayout
      title="Find the Grocery Sounds"
      instruction="Find objects that start with the /m/ sound."
    >
