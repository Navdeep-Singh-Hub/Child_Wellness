/**
 * GrocerySyllableGame — Game 3: Clap Grocery Words
 * potato (3), cereal (3), banana (3), tomato (3). Bouncing grocery icons, star on correct.
 */
...
export function GrocerySyllableGame({ onComplete }: { onComplete: () => void }) {
