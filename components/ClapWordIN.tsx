/**
 * Clap the Word — One syllable (pin, tin, bin). Game 3 for Grouper Session 2.
 */
...
const WORDS = [{ word: 'pin' }, { word: 'tin' }, { word: 'bin' }];

export function ClapWordIN({ onComplete }: { onComplete: () => void }) {
