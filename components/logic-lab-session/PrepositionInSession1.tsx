 ...
 * Flow: Intro → Game 1 (Position) → Game 2 (Drag IN) → Game 3 (Pattern) → Game 4 (Sequence) → Notebook → Result
 * AAC-friendly: minimal, predictable, sensory-friendly. Primary #4F46E5, Success #22C55E, Background #F3F4F6.
 */
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.introHeader}>
            <Text style={styles.introTitle}>Position: IN</Text>
            <Text style={styles.introSub}>Let's learn what IN means.</Text>
          </View>
          <View style={styles.exampleBox}>
            <Text style={styles.exampleTitle}>Example:</Text>
            <View style={styles.exampleVisual}>
              <View style={styles.exampleBoxDraw} />
              <View style={styles.exampleBallDraw} />
            </View>
            <Text style={styles.exampleLabel}>ball IN a box</Text>
          </View>
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.resultScroll} showsVerticalScrollIndicator={false}>
          <Text style={styles.resultTitle}>Great job learning the word IN!</Text>
          <View style={styles.resultBadge}>
            <Text style={styles.resultBadgeEmoji}>⭐</Text>
            <Text style={styles.resultBadgeText}>Logic Lab Beginner</Text>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Position: IN</Text>
        <Text style={styles.subtitle}>Logic Lab · Session 1</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {step === 1 && <PositionChoice onComplete={advance} />}
        {step === 2 && <DragIntoContainer onComplete={advance} />}
        {step === 3 && <PatternBuilder onComplete={advance} />}
        {step === 4 && <SequenceOrder onComplete={advance} />}
        {step === 5 && <PrepositionInNotebookUpload onComplete={handleNotebookComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  backButtonText: { fontSize: 17, fontWeight: '700', color: '#4F46E5' },
  header: {
