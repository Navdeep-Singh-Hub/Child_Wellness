/**
 * Notebook Task — Draw three objects using different positions. Upload photo, AI check: three_objects_detected, different_positions_detected.
 */
...
const INSTRUCTIONS = 'Draw three objects using different positions. Then upload or take a photo of your drawing.';
...
export function PrepositionReviewNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw three objects using different positions. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleText}>ball IN box · cat UNDER table · cup ON table</Text>
        </View>
