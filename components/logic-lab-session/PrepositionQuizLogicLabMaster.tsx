/**
 * Game 2 — Preposition Quiz. Two questions: ball IN box, cat UNDER table. Session 10: Logic Lab Master.
 */
...
const styles = StyleSheet.create({
  ...
  sentence: { fontSize: 22, fontWeight: '800', color: '#3730A3', marginBottom: 20, textAlign: 'center' },
