/**
 * Game 4 — Put the actions in order: turn on water, use soap, rinse hands, dry hands. Session 8: Pattern Builder.
 */
...
export function SequencePuzzlePatternBuilder({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="Actions in order!" />;
