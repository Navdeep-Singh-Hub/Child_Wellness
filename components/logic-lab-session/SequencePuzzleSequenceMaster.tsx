/**
 * Game 4 — Arrange the daily routine: wake up, brush teeth, eat, go to school. Session 9: Sequence Master.
 */
...
const STEPS = [
  ...
  { id: 'eat', label: 'Eat', emoji: '🍳', correctOrder: 3 },
...
export function SequencePuzzleSequenceMaster({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="Daily routine in order!" />;
  ...
  return (
    <GameLayout
      ...
      instruction="Tap the actions in the correct order."
      icon="🎒"
