/**
 * Notebook Task — Draw 3 objects using different prepositions (ball in box, cat under chair, cup on table). Session 10: Logic Lab Master.
 * API: objects_detected, correct_spatial_relation, pattern_or_sequence_detected.
 */
...
const INSTRUCTIONS = 'Draw 3 objects using different prepositions. Then upload or take a photo.';
...
export function LogicLabMasterNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw 3 objects using different prepositions. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleText}>ball IN box · cat UNDER chair · cup ON table</Text>
        </View>
