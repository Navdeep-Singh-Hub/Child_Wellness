/**
 * Game 4 — Make a sandwich: 1 bread, 2 cheese, 3 bread. Session 2: Preposition ON.
 */
...
const STEPS = [
  { id: 'bread1', label: 'Bread', emoji: '🍞', correctOrder: 1 },
  { id: 'cheese', label: 'Cheese', emoji: '🧀', correctOrder: 2 },
  { id: 'bread2', label: 'Bread', emoji: '🍞', correctOrder: 3 },
];
const VOICE = 'Arrange the steps to make a sandwich. First bread, then cheese, then bread.';
...
export function SequencePuzzleOn({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="Sandwich steps in order!" />;
