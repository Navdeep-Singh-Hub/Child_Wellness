 ...
 * Flow: Intro → Game 1 (Position) → Game 2 (Drag BEHIND) → Game 3 (Pattern) → Game 4 (Sequence) → Notebook → Result
      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.introHeader}>
            <Text style={styles.introTitle}>Position: BEHIND</Text>
            <Text style={styles.introSub}>Let's learn what BEHIND means.</Text>
          </View>
          <View style={styles.exampleBox}>
            <Text style={styles.exampleTitle}>Example:</Text>
            <View style={styles.exampleVisual}>
              <Text style={styles.exampleTree}>🌳</Text>
              <Text style={styles.exampleBoy}>👦</Text>
            </View>
            <Text style={styles.exampleLabel}>boy BEHIND a tree</Text>
          </View>
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.resultScroll} showsVerticalScrollIndicator={false}>
          <Text style={styles.resultTitle}>Great job learning the word BEHIND!</Text>
          <View style={styles.resultBadge}>
            <Text style={styles.resultBadgeEmoji}>⭐</Text>
            <Text style={styles.resultBadgeText}>BEHIND Position Star</Text>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        <Text style={styles.title}>Position: BEHIND</Text>
        <Text style={styles.subtitle}>Logic Lab · Session 5</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {step === 1 && <PositionChoiceBehind onComplete={advance} />}
        {step === 2 && <DragBehindObject onComplete={advance} />}
        {step === 3 && <PatternRecognitionBehind onComplete={advance} />}
        {step === 4 && <SequencePuzzleBehind onComplete={advance} />}
        {step === 5 && <PrepositionBehindNotebookUpload onComplete={handleNotebookComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
