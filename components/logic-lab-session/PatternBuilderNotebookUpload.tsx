/**
 * Notebook Task — Draw a pattern of shapes. Upload photo, AI check: pattern_detected, multiple_shapes_detected.
 */
...
const INSTRUCTIONS = 'Draw a pattern of shapes in your notebook. Then upload or take a photo.';
...
export function PatternBuilderNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw a pattern of shapes. Then upload or take a photo."
      icon="📓"
...
const styles = StyleSheet.create({
  ...
  exampleVisual: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  exampleDot: { fontSize: 32 },
