/**
 * Notebook Task — Draw an object between two objects. Upload photo, AI check: two_outer_objects_detected, object_between_detected.
 */
...
const INSTRUCTIONS = 'Draw an object between two objects. Then upload or take a photo of your drawing.';
...
export function PrepositionBetweenNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw an object between two objects. Then upload or take a photo."
      icon="📓"
      ...
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <View style={styles.exampleVisual}>
            <Text style={styles.exampleBox}>📦</Text>
            <Text style={styles.exampleBall}>⚽</Text>
            <Text style={styles.exampleBox}>📦</Text>
          </View>
          <Text style={styles.exampleText}>ball between two boxes</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleBox: { fontSize: 40 },
  exampleBall: { fontSize: 40 },
