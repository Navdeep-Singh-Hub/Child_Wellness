/**
 * Game 3 — Complete the pattern: 🔺 🔵 🔺 🔵 __ → 🔺. Session 6: Preposition BETWEEN.
 */
...
const CHOICES: { id: Shape; emoji: string; label: string }[] = [
    ...
    >
      <View style={styles.content}>
        <View style={styles.patternRow}>
          {PATTERN.map((c, i) => (
            <Text key={i} style={styles.patternDot}>{c === 'triangle' ? '🔺' : '🔵'}</Text>
          ))}
