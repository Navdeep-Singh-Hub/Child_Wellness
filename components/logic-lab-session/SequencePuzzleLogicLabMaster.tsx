/**
 * Game 4 — Big Sequence: plant a seed, water the plant, plant grows, pick fruit. Session 10: Logic Lab Master.
 */
...
const STEPS = [
  { id: 'seed', label: 'Plant a seed', emoji: '🌱', correctOrder: 1 },
  { id: 'water', label: 'Water the plant', emoji: '💧', correctOrder: 2 },
  { id: 'grows', label: 'Plant grows', emoji: '🌿', correctOrder: 3 },
  { id: 'fruit', label: 'Pick fruit', emoji: '🍎', correctOrder: 4 },
];
