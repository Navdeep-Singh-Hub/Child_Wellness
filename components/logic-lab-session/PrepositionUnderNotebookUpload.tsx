/**
 * Notebook Task — Draw a cat UNDER a table. Upload photo, AI check: table_detected, cat_detected, cat_under_table.
 */
...
const INSTRUCTIONS = 'Draw a cat UNDER a table. Then upload or take a photo of your drawing.';
...
export function PrepositionUnderNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw a cat UNDER a table. Then upload or take a photo."
      icon="📓"
      ...
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <View style={styles.exampleVisual}>
            ...
            <View style={styles.exampleCat} />
          </View>
          <Text style={styles.exampleText}>cat under table</Text>
        </View>
