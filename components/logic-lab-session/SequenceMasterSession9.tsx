 ...
 * Flow: Intro → Game 1 (Position) → Game 2 (Drag positions) → Game 3 (Pattern) → Game 4 (Sequence) → Notebook → Result
      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.introHeader}>
            <Text style={styles.introTitle}>Sequence Master</Text>
            <Text style={styles.introSub}>Let's practice positions, patterns, and sequences.</Text>
          </View>
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.resultScroll} showsVerticalScrollIndicator={false}>
          <Text style={styles.resultTitle}>Great job arranging the sequence!</Text>
          <View style={styles.resultBadge}>
            <Text style={styles.resultBadgeEmoji}>⭐</Text>
            <Text style={styles.resultBadgeText}>Sequence Master</Text>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Logic Lab · Session 9</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {step === 1 && <PrepositionChoiceSequenceMaster onComplete={advance} />}
        {step === 2 && <DragPositionSequenceMaster onComplete={advance} />}
        {step === 3 && <PatternRecognitionSequenceMaster onComplete={advance} />}
        {step === 4 && <SequencePuzzleSequenceMaster onComplete={advance} />}
        {step === 5 && <SequenceMasterNotebookUpload onComplete={handleNotebookComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
