 ...
 * Flow: Intro → Game 1 (Position) → Game 2 (Drag ON) → Game 3 (Pattern) → Game 4 (Sequence) → Notebook → Result
 * AAC-friendly: minimal, predictable, sensory-friendly.
 */
      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.introHeader}>
            <Text style={styles.introTitle}>Position: ON</Text>
            <Text style={styles.introSub}>Let's learn what ON means.</Text>
          </View>
          <View style={styles.exampleBox}>
            <Text style={styles.exampleTitle}>Example:</Text>
            <View style={styles.exampleVisual}>
              <View style={styles.exampleTableDraw} />
              <View style={styles.exampleBookDraw} />
            </View>
            <Text style={styles.exampleLabel}>book ON a table</Text>
          </View>
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.resultScroll} showsVerticalScrollIndicator={false}>
          <Text style={styles.resultTitle}>Great job learning the word ON!</Text>
          <View style={styles.resultBadge}>
            <Text style={styles.resultBadgeEmoji}>⭐</Text>
            <Text style={styles.resultBadgeText}>ON Position Star</Text>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        <Text style={styles.title}>Position: ON</Text>
        <Text style={styles.subtitle}>Logic Lab · Session 2</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {step === 1 && <PositionChoiceOn onComplete={advance} />}
        {step === 2 && <DragOnSurface onComplete={advance} />}
        {step === 3 && <PatternRecognitionOn onComplete={advance} />}
        {step === 4 && <SequencePuzzleOn onComplete={advance} />}
        {step === 5 && <PrepositionOnNotebookUpload onComplete={handleNotebookComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
