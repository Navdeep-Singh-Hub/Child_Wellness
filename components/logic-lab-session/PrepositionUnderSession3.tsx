 ...
 * Flow: Intro → Game 1 (Position) → Game 2 (Drag UNDER) → Game 3 (Pattern) → Game 4 (Sequence) → Notebook → Result
      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.introScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.introHeader}>
            <Text style={styles.introTitle}>Position: UNDER</Text>
            <Text style={styles.introSub}>Let's learn what UNDER means.</Text>
          </View>
          <View style={styles.exampleBox}>
            <Text style={styles.exampleTitle}>Example:</Text>
            <View style={styles.exampleVisual}>
              <View style={styles.exampleTableDraw} />
              <View style={styles.exampleCatDraw} />
            </View>
            <Text style={styles.exampleLabel}>cat UNDER a table</Text>
          </View>
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <ScrollView contentContainerStyle={styles.resultScroll} showsVerticalScrollIndicator={false}>
          <Text style={styles.resultTitle}>Great job learning the word UNDER!</Text>
          <View style={styles.resultBadge}>
            <Text style={styles.resultBadgeEmoji}>⭐</Text>
            <Text style={styles.resultBadgeText}>UNDER Position Star</Text>
          </View>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        <Text style={styles.title}>Position: UNDER</Text>
        <Text style={styles.subtitle}>Logic Lab · Session 3</Text>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {step === 1 && <PositionChoiceUnder onComplete={advance} />}
        {step === 2 && <DragUnderObject onComplete={advance} />}
        {step === 3 && <PatternRecognitionUnder onComplete={advance} />}
        {step === 4 && <SequencePuzzleUnder onComplete={advance} />}
        {step === 5 && <PrepositionUnderNotebookUpload onComplete={handleNotebookComplete} />}
      </ScrollView>
    </SafeAreaView>
  );
}
