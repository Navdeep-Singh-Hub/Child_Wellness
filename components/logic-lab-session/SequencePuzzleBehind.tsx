/**
 * Game 4 — Get ready to walk: 1 put shoes, 2 tie laces, 3 walk. Session 5: Preposition BEHIND.
 */
...
const STEPS = [
  { id: 'shoes', label: 'Put shoes', emoji: '👟', correctOrder: 1 },
  { id: 'laces', label: 'Tie laces', emoji: '👟', correctOrder: 2 },
  { id: 'walk', label: 'Walk', emoji: '🚶', correctOrder: 3 },
];
