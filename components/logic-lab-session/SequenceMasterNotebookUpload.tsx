/**
 * Notebook Task — Draw a sequence of 3 actions (e.g. wake up → brush teeth → eat). Upload photo, AI check: three_actions_detected, sequence_detected.
 */
...
const INSTRUCTIONS = 'Draw a sequence of 3 actions in your notebook. Then upload or take a photo.';
...
export function SequenceMasterNotebookUpload({
  ...
  return (
    <GameLayout
      ...
      instruction="Draw a sequence of 3 actions. Then upload or take a photo."
      icon="📓"
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.exampleRow}>
          ...
          <Text style={styles.exampleText}>wake up → brush teeth → eat</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  exampleText: { fontSize: 14, color: '#6B7280', textAlign: 'center' },
