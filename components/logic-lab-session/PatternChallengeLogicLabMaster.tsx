/**
 * Game 3 — Pattern Challenge. Two rounds: 🔴🔵🟢🔴🔵🟢__ → 🔴, then 🟦🟩🟦🟩__ → 🟦. Session 10: Logic Lab Master.
 */
...
const ROUNDS: {
...
}[] = [
  {
    pattern: ['🔴', '🔵', '🟢', '🔴', '🔵', '🟢'],
    correct: '🔴',
    choices: [{ emoji: '🔴', id: 'red' }, { emoji: '🔵', id: 'blue' }, { emoji: '🟢', id: 'green' }],
    voice: 'Complete the pattern. Choose the shape that comes next.',
  },
  {
    pattern: ['🟦', '🟩', '🟦', '🟩'],
    correct: '🟦',
    choices: [{ emoji: '🟦', id: 'blue' }, { emoji: '🟩', id: 'green' }, { emoji: '🟥', id: 'red' }],
    voice: 'Complete the pattern. Choose the shape that comes next.',
  },
];
...
const styles = StyleSheet.create({
  ...
  blankText: { fontSize: 20, fontWeight: '800', color: '#9CA3AF' },
