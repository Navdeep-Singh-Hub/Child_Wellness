/**
 * Game 4 — Morning routine: 1 wake up, 2 brush teeth, 3 eat breakfast. Session 3: Preposition UNDER.
 */
...
const STEPS = [
  ...
  { id: 'breakfast', label: 'Eat breakfast', emoji: '🥣', correctOrder: 3 },
];
const VOICE = 'Arrange the steps of the morning routine. First wake up, then brush teeth, then eat breakfast.';
...
export function SequencePuzzleUnder({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="indigo" title="Great Job!" subtitle="Morning routine in order!" />;
  ...
  return (
    <GameLayout
      ...
      instruction="Arrange the steps of the morning routine in order."
      icon="🌅"
