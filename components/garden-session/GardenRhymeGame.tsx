/**
 * GardenRhymeGame — Game 2: I Spy Garden Rhymes
 * flower→tower, bee→tree, seed→feed, bug→mug.
 */
...
const ROUNDS: Round[] = [
  {
    ...
    correctId: 'tower',
    items: [
      { id: 'tower', label: 'Tower', image: 'https://placehold.co/120x120/E5E7EB/374151?text=Tower' },
      ...
      { id: 'bug', label: 'Bug', image: 'https://placehold.co/120x120/BBF7D0/166534?text=Bug' },
    ],
  },
  {
    promptWord: 'bee',
    ...
    items: [
      ...
      { id: 'flower', label: 'Flower', image: 'https://placehold.co/120x120/F9A8D4/BE185D?text=Flower' },
      { id: 'bird', label: 'Bird', image: 'https://placehold.co/120x120/FDE68A/92400E?text=Bird' },
      { id: 'seed', label: 'Seed', image: 'https://placehold.co/120x120/FDE68A/854D0E?text=Seed' },
    ],
  },
  {
    promptWord: 'seed',
    correctId: 'feed',
    items: [
      { id: 'feed', label: 'Feed', image: 'https://placehold.co/120x120/FED7AA/9A3412?text=Feed' },
      { id: 'bee', label: 'Bee', image: 'https://placehold.co/120x120/FEF08A/854D0E?text=Bee' },
      { id: 'leaf', label: 'Leaf', image: 'https://placehold.co/120x120/86EFAC/166534?text=Leaf' },
      { id: 'bug', label: 'Bug', image: 'https://placehold.co/120x120/BBF7D0/166534?text=Bug' },
    ],
  },
  {
    ...
    correctId: 'mug',
    items: [
      { id: 'mug', label: 'Mug', image: 'https://placehold.co/120x120/FDE68A/92400E?text=Mug' },
      { id: 'flower', label: 'Flower', image: 'https://placehold.co/120x120/F9A8D4/BE185D?text=Flower' },
      { id: 'tree', label: 'Tree', image: 'https://placehold.co/120x120/86EFAC/166534?text=Tree' },
      { id: 'seed', label: 'Seed', image: 'https://placehold.co/120x120/FDE68A/854D0E?text=Seed' },
    ],
...
export function GardenRhymeGame({ onComplete }: { onComplete: () => void }) {
  ...
  if (showSuccess) return <SuccessCelebration variant="mint" title="Great Job!" subtitle="Garden rhymes complete!" />;

  return (
    <GameLayout title="I Spy Garden Rhymes" instruction={instruction}>
