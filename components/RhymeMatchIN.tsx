/**
 * Rhyme Match — Find the rhyme (pin → tin). Game 2 for Grouper Session 2.
 */
...
const PROMPT_WORD = 'pin';
const CHOICES = [
  { id: 'tin', label: 'tin', correct: true, image: 'https://placehold.co/120x120/E5E7EB/374151?text=tin' },
  { id: 'sun', label: 'sun', correct: false, image: 'https://placehold.co/120x120/FEF9C3/854D0E?text=sun' },
  { id: 'hat', label: 'hat', correct: false, image: 'https://placehold.co/120x120/DDD6FE/5B21B6?text=hat' },
].sort(() => Math.random() - 0.5);

export function RhymeMatchIN({ onComplete }: { onComplete: () => void }) {
