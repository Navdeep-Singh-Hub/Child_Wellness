/**
 * Word Family Finder — -OP words (Game 1 for Grouper Session 5). AAC-friendly.
 */
...
const CORRECT = [
  { id: 'top', label: 'top', image: 'https://placehold.co/140x140/DBEAFE/1E40AF?text=top' },
  { id: 'hop', label: 'hop', image: 'https://placehold.co/140x140/D1FAE5/065F46?text=hop' },
  { id: 'mop', label: 'mop', image: 'https://placehold.co/140x140/E0E7FF/4338CA?text=mop' },
  { id: 'pop', label: 'pop', image: 'https://placehold.co/140x140/FEE2E2/991B1B?text=pop' },
];
const WRONG = [
...
export function WordFamilyFinderOP({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    speak('Tap the words that belong to the -OP family.', 0.75);
  }, []);
  ...
  return (
    <GameLayout
      title="Find the -OP words"
      instruction="Tap the words that belong to the -OP family."
    >
