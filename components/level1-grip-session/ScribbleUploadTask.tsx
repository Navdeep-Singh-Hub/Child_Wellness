/**
 * AI Task: Do free scribbling on paper and upload photo. POST /api/verify-scribble
 */
...
const INSTRUCTION = 'Do free scribbling on paper and upload a photo.';
  ...
  const uploadImage = async (uri: string) => {
    ...
    try {
      ...
      setResult({
        ...
        feedback: data.feedback || (success ? 'Great scribbling!' : 'Try again.'),
      });
