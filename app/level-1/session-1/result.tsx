// Result Page for Scribbling & Gripping
...
import { playSoundEffect, speakFeedback, stopAllAudio } from '@/components/game/scribbling/utils/audio';
...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    speakFeedback("You're learning to draw!");
  }, []);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Animated.View style={[styles.content, animatedStyle]}>
          ...
          <Text style={styles.encouragement}>You're learning to draw!</Text>
