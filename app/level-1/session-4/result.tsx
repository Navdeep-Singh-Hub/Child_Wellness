// Result Page for Slanting Lines
...
import { playSoundEffect, speakFeedback, stopAllAudio } from '@/components/game/slanting-lines/utils/audio';
...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    speakFeedback('Your pencil control is improving!');
  }, []);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Animated.View style={[styles.content, animatedStyle]}>
          ...
          <Text style={styles.encouragement}>Your pencil control is improving!</Text>
