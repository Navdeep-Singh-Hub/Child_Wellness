...
import { playSoundEffect, speakFeedback, stopAllAudio } from '@/components/game/curved-lines/utils/audio';
...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    speakFeedback('You are learning to draw smooth curves!');
  }, []);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Animated.View style={[styles.content, animatedStyle]}>
          ...
          <Text style={styles.encouragement}>You are learning to draw smooth curves!</Text>
