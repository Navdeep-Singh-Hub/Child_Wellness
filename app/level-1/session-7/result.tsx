// Result Page for Curved Letters
...
import { playSoundEffect, speakFeedback, stopAllAudio } from '@/components/game/curved-letters/utils/audio';
...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    speakFeedback('You are learning to write curved letters!');
  }, []);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Animated.View style={[styles.content, animatedStyle]}>
          ...
          <Text style={styles.encouragement}>You are learning to write curved letters!</Text>
