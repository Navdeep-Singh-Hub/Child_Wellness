// Result Page for Standing Line Letters
...
import { playSoundEffect, speakFeedback, stopAllAudio } from '@/components/game/standing-line-letters/utils/audio';
...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    speakFeedback('You are learning to write letters!');
  }, []);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Animated.View style={[styles.content, animatedStyle]}>
          ...
          <Text style={styles.encouragement}>You are learning to write letters!</Text>
