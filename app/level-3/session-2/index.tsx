// Level 3 Session 2 - The Builder - Intro Screen
import GameCardComponent from '@/components/game/builder-session2/components/GameCard';
import FloatingParticles from '@/components/game/builder-session2/components/FloatingParticles';
import { GAMES } from '@/components/game/builder-session2/utils/gameData';
...
export default function Level3Session2IntroScreen() {
  const router = useRouter();

  const handleGamePress = (gameId: string) => {
    router.push(`/level-3/session-2/game/${gameId}`);
  };
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          <Text style={styles.title}>Level 3 — Session 2</Text>
          <Text style={styles.subtitle}>The Builder</Text>
          <Text style={styles.description}>
            Learn the word BAT and identify square shapes through interactive games.
          </Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Pressable style={styles.notebookCard} onPress={handleNotebookPress}>
          ...
          >
            ...
            <Text style={styles.notebookDescription}>Write BAT and draw shapes</Text>
